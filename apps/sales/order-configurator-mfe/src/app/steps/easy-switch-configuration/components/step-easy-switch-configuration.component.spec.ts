...
import { StepEasySwitchConfigurationComponent } from './step-easy-switch-configuration.component';

describe('StepDeliveryComponent', () => {
  let component: StepEasySwitchConfigurationComponent;
  let fixture: ComponentFixture<StepEasySwitchConfigurationComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      imports: [
        StepEasySwitchConfigurationComponent,
    ...
    fixture = TestBed.createComponent(StepEasySwitchConfigurationComponent);

...
import { StepInstallationTypeComponent } from './step-installation-type.component';
import { stepLoaded } from '../events/step-loaded.const';

describe('StepInstallationTypeComponent', () => {
  let component: StepInstallationTypeComponent;
  let fixture: ComponentFixture<StepInstallationTypeComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(StepInstallationTypeComponent);

...
import { StepThanksComponent } from './step-thanks.component';

describe('StepThanksComponent', () => {
  let component: StepThanksComponent;
  let fixture: ComponentFixture<StepThanksComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(StepThanksComponent);

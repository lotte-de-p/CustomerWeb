...
const mockEnhancedSuccessResponse = require('../../../../../../../../../fixtures/http/common/address/enhanced-address.json');
const defaultType = 'Geographical Address';
...
describe('AddressMapper', () => {
  ...
  describe('toModel', () => {
    ...
    it('should MAP the address data', () => {
      ...
      expect(address[0].type).toBe(defaultType);
      ...
      expect(address[1].type).toBe(defaultType);

...
export const handleCustomEvents = (StoryFn: () => unknown) => {
  ...
  useEffect(() => {
    ...
    const brandWinkIconsCss = `https://customer-web-foundation-wink-cdn.aem-modules-dev.awscloud.external.telenet.be/v1.2.0/assets/${brand}/icons/icons-font/${brand}-icons-font.css`;
    if (theme) {

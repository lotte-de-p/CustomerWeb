...
module.exports = withModuleFederationPlugin({
  ...
  exposes: {
    './AddressCheckerModule': './apps/activate/address-checker-mfe/src/app/address-checker.module.ts',
    './FiberAddressChecker':
      './libs/activate/address-checker/feat-fiber-address-checker/src/lib/fiber-address-checker.component.ts',
  },

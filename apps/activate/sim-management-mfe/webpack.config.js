...
module.exports = withModuleFederationPlugin({
  ...
  exposes: {
    './MobileLineDetails':
      './libs/activate/sim-management/mobile-line-details/feat-mobile-line-details/src/lib/mobile-line-details.component.ts',
    './ESimActivationComponent':
      './libs/activate/sim-management/activation/feat-e-sim-activation/src/lib/e-sim-activation.component.ts',
    './SimActivationComponent':
      './libs/activate/sim-management/activation/feat-sim-activation/src/lib/sim-activation.component.ts',
    './SmsVerification':
      './libs/activate/sim-management/verification/feat-sms-verification/src/lib/sms-verification/sms-verification.component.ts',
  },

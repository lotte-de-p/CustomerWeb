...
module.exports = withModuleFederationPlugin({
  ...
  exposes: {
    './SearchHeader': './/libs/foundation/general/search/feat-header/src/lib/search-header.component.ts',
    './SearchResults': './/libs/foundation/general/search/feat-results/src/lib/search-results.component.ts',
    './InpageSearch': './/libs/foundation/general/search/feat-inpage-search/src/lib/inpage-search.component.ts',
  },
  shared: share({

...
import entertainmentManagementActiveOptions from '../../mock/entertainment-management-active-options.json';
...
export default {
  ...
  parameters: {
    mockData: [userDetailsMock, entertainmentManagementActiveOptions],
  },

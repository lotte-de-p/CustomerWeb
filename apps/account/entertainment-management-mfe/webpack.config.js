...
module.exports = withModuleFederationPlugin({
  ...
  exposes: {
    './EntertainmentManagement':
      './/libs/account/entertainment-management/feat-entertainment-management/src/lib/entertainment-management.component.ts',
    './EntertainmentManagementOptionDetails':
      './/libs/account/entertainment-management/feat-entertainment-management-option-details/src/lib/entertainment-management-option-details.component.ts',
  },

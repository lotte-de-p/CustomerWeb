...
describe('when i have product specifications', () => {
  beforeEach(() => cy.visit('/iframe.html?id=products-specifications--primary'));
  it('i should be able to see all the specifications of a product', () => {

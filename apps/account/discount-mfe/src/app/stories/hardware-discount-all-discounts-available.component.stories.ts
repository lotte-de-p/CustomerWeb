...
import hardwareDiscountAllDiscountsAvailableMock from '../../mock/hardware-discount-all-discounts-available-mock.json';
...
export default {
  ...
  parameters: {
    mockData: [hardwareDiscountAllDiscountsAvailableMock, userDetailsMock],
  },
} as Meta<HardwareDiscountComponent>;

export const AllDiscountsAvailable = {

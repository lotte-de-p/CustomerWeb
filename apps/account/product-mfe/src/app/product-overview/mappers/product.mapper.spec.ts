...
import { ContractInterface, PriceInterface } from '../models/product.model';
import {
  RawColorInterface,
...
describe('ProductMapper', () => {
  ...
  describe('getBundleProductDetails', () => {
    ...
    it('should fill mobileIdentifiers array and unlimited lines', () => {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      jest.spyOn(productMapper as any, 'createProductInfo').mockReturnValue({});

...
import { EligibleProductsModel } from '../../../../shared/common/models/eligible-products.model';
import {
  RawEligibleOfferInterface,
  RawEligibleProductInterface,
  RawOptionInterfaceProduct,
  RawPriceInterface,
} from '../../../../shared/common/interfaces/products/raw-eligiblie-products.interface';
import { EligibleOfferInterface } from '../../../../shared/common/interfaces/eligible-offers.interface';
import { OptionProductsModel } from '../../../../shared/common/models/option-products.model';

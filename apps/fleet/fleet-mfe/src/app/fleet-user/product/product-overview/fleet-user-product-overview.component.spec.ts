...
import { FleetUserProductOverviewComponent } from './fleet-user-product-overview.component';
...
describe('FleetUserProductOverviewComponent', () => {
  let component: FleetUserProductOverviewComponent;
  let fixture: ComponentFixture<FleetUserProductOverviewComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(FleetUserProductOverviewComponent);

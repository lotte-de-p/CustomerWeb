...
import {
  ...
  RawProduct,
  RawProductPrice,
} from '../../../product/product-overview/interfaces/raw-product.interface';

@Injectable({
  providedIn: 'root',
})
export class SingleProductMapper implements MapperInterface<RawProduct, Product> {
  constructor(
    private readonly omapiMapper: OmapiProductMapper // private readonly omapiService: OmapiQueryProductService
  ) {}

  toModel(rawProduct: RawProduct): Product {

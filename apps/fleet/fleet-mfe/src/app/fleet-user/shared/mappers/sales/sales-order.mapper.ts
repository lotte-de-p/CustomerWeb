...
import {
  RawAvailabilitiesInterface,
  RawDeliveryItemInterface,
  RawInstallationInterface,
  RawLineItemInterface,
  RawOrderItemInterface,
  RawRegistrationInterface,
  RawSalesOrderInterface,
  RawTimeSlotAvailabilityInterface,
  RawValidationInterface,
} from '../../interfaces/raw/raw-sales-order.interface';
import { DeliveryItemMapper } from '../delivery-item.mapper';
...
import { RegistrationInterface } from '../../interfaces/registration.model';
import { OnTopPromosInterface } from '../../interfaces/raw/raw-on-top-promos.interface';
...
export class SalesOrderMapper implements MapperInterface<RawSalesOrderInterface, SalesOrder> {
  constructor(
  ...
  toModel(rawSalesOrder: RawSalesOrderInterface): SalesOrder {
    return this.createSuccesResponse(rawSalesOrder);
  }

  private createSuccesResponse(rawSalesOrder: RawSalesOrderInterface): SalesOrder {
  ...
  private createLineItems(rawLineItems: RawLineItemInterface[]): LineItem[] {
    return (
      rawLineItems &&
  ...
  private createDeliveryItems(rawDeliveryItems: RawDeliveryItemInterface[]): DeliveryItem[] {
    return (
      rawDeliveryItems &&
  ...
  private createValidations(rawSalesOrderValidations: RawValidationInterface[]): ValidationInterface[] {
    return (
  ...
  private createInstallation(rawInstallation: RawInstallationInterface): InstallationInterface {
  ...
  private createAppointmentAvailabilities(availabilities: RawAvailabilitiesInterface): NCTimeSlot {
  ...
  private createSlotsForAppointments(slot: RawTimeSlotAvailabilityInterface): NCTimeSlotAvailability {
  ...
  private createRegistration(rawRegistration: RawRegistrationInterface): RegistrationInterface {

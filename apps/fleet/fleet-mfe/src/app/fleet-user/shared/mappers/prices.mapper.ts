...
import { RawPricesInterface } from '../interfaces/raw/raw-sales-order.interface';
...
export class PricesMapper implements MapperInterface<RawPricesInterface, Prices> {
  toModel(rawPrices: RawPricesInterface): Prices {

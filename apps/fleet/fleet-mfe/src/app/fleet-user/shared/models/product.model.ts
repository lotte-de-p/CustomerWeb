...
import { DataLimitEnum, ProductOverviewConstants } from '../../../shared/common/constants/product-overview.constant';
import { SimTypeEnum } from '../../../shared/common/enums/sim-type.enum';
import { SplitBillProfileTypeEnum } from '../../product/shared/enums/split-bill-profile-type.enum';
...
export class Product {
  ...
  isAdded?: boolean;
  isAffected?: boolean;
  newTariffPlan?: Product;
  volume?: string;
  splitBillProfileType?: string;
  ...
  isSplitBill20(): boolean {
    return this.splitBillProfileType === SplitBillProfileTypeEnum.SB20;
  }
}

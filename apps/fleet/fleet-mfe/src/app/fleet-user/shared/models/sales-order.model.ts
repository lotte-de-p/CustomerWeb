...
import { ErrorDetailInterface } from '../interfaces/error-detail.interface';
import { InstallationInterface } from '../interfaces/installation-interface';
import { FeasibilityCheckResultInterface } from '../interfaces/feasibility-check-result.interface';
import { ServiceabilityCheckResultInterface } from '../interfaces/serviceability-check-result.interface';
...
export class SalesOrder implements ContextHubModelInterface<SalesOrder> {
  ...
  feasibilityCheckResult?: FeasibilityCheckResultInterface;

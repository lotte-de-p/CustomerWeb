...
import { RawEligibleProductInterface } from '../../interfaces/products/raw-eligiblie-products.interface';

const eligibleProductsMock = require('../../../../../../../../../fixtures/http/netcracker/products/eligible-products.json');

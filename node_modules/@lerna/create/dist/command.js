...
var require_child_process = __commonJS({
  "libs/child-process/index.js"(exports2) {
    ...
    function execSync2(command2, args, opts) {
      return execa3.sync(command2, args, opts).stdout;
    }
    ...
    function getExitCode(result) {
      ...
      if (typeof result.code === "string") {
        return os4.constants.errno[result.code];
      }
      return process.exitCode;
    }
    function spawnProcess(command2, args, opts) {
      const child = execa3(command2, args, opts);
...
function collectUncommitted({ cwd, log: log46 = import_npmlog.default }) {
  log46.silly("collect-uncommitted", "git status --porcelain (async)");
...
var import_npmlog9, import_write_file_atomic;
...
var import_clone_deep, import_dedent3, import_npmlog12, import_client, import_os, DEFAULT_CONCURRENCY;
...
var import_minimatch3, import_npmlog37, import_slash2, childProcess12;
...
var import_npmlog40, import_os2, import_path9, import_write_file_atomic2;
...
var import_clone_deep2, import_dedent5, import_execa2, import_npmlog43, import_os3, DEFAULT_CONCURRENCY2, Command2;
...
var import_multimatch2, import_npmlog45;
...
var require_src = __commonJS({
  "libs/commands/create/src/index.ts"(exports2, module2) {
    ...
    var childProcess14 = require_child_process();
    ...
    var CreateCommand = class extends Command2 {
      ...
      gitConfig(prop) {
        return childProcess14.execSync("git", ["config", "--get", prop], this.execOpts);
      }
      ...
      setRepository() {
        try {
          const url2 = childProcess14.execSync("git", ["remote", "get-url", "origin"], this.execOpts);

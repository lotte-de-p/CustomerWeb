...
var require_child_process = __commonJS({
  "libs/child-process/index.js"(exports2) {
    ...
    function execSync2(command, args, opts) {
      return execa3.sync(command, args, opts).stdout;
    }
    ...
    function getExitCode(result) {
      ...
      if (typeof result.code === "string") {
        return os6.constants.errno[result.code];
      }
      return process.exitCode;
    }
    function spawnProcess(command, args, opts) {
      const child = execa3(command, args, opts);
...
var init_describe_ref = __esm({
  "libs/core/src/lib/describe-ref.ts"() {
    ...
    childProcess2 = require_child_process();
  }
});
...
var init_has_tags = __esm({
  "libs/core/src/lib/collect-updates/has-tags.ts"() {
    ...
    childProcess3 = require_child_process();
  }
});
...
var init_make_diff_predicate = __esm({
  "libs/core/src/lib/collect-updates/make-diff-predicate.ts"() {
    ...
    ({ execSync } = require_child_process());
  }
});
...
var init_warn_if_hanging = __esm({
  "libs/core/src/lib/command/warn-if-hanging.ts"() {
    ...
    childProcess4 = require_child_process();
  }
});
...
var init_exec_package_manager = __esm({
  "libs/core/src/lib/corepack/exec-package-manager.ts"() {
    ...
    childProcess5 = require_child_process();
  }
});
...
var init_git_checkout = __esm({
  "libs/core/src/lib/git-checkout.ts"() {
    ...
    childProcess6 = require_child_process();
  }
});
...
var init_has_npm_version = __esm({
  "libs/core/src/lib/has-npm-version.ts"() {
    ...
    childProcess7 = require_child_process();
  }
});
...
var init_npm_install = __esm({
  "libs/core/src/lib/npm-install.ts"() {
    ...
    childProcess8 = require_child_process();
...
var init_npm_run_script = __esm({
  "libs/core/src/lib/npm-run-script.ts"() {
    ...
    init_get_npm_exec_opts();
    childProcess9 = require_child_process();
  }
});
...
var init_profiler = __esm({
  "libs/core/src/lib/profiler.ts"() {
    ...
    Profiler = class {
      constructor({ concurrency, log: log64 = import_npmlog29.default, outputDirectory }) {
        this.events = [];
        this.logger = log64;
...
var init_create_github_client = __esm({
  "libs/core/src/lib/scm-clients/github/create-github-client.ts"() {
    ...
    init_validation_error();
    childProcess10 = require_child_process();
  }
});
...
var require_command = __commonJS({
  "libs/commands/changed/src/command.ts"(exports2, module2) {
    ...
    var command = {
      ...
      async handler(argv) {
        return (await Promise.resolve().then(() => (init_src2(), src_exports))).factory(argv);
      }
    };
...
var init_has_tags2 = __esm({
  "libs/legacy-core/src/lib/collect-updates/has-tags.ts"() {
    ...
    childProcess11 = require_child_process();
  }
});
...
var import_minimatch3, import_npmlog37, import_path19, import_slash2, childProcess12;
var init_make_diff_predicate2 = __esm({
  "libs/legacy-core/src/lib/collect-updates/make-diff-predicate.ts"() {
    ...
    childProcess12 = require_child_process();
  }
});
...
var import_npmlog42, childProcess13;
var init_warn_if_hanging2 = __esm({
  "libs/legacy-core/src/lib/command/warn-if-hanging.ts"() {
    "use strict";
    import_npmlog42 = __toESM(require("npmlog"));
    childProcess13 = require_child_process();
  }
});
...
function getLastCommit(execOpts) {
  if (hasTags3(execOpts)) {
    ...
    return childProcess14.execSync("git", ["describe", "--tags", "--abbrev=0"], execOpts);
  }
  import_npmlog48.default.silly("getFirstCommit", "");
  return childProcess14.execSync("git", ["rev-list", "--max-parents=0", "HEAD"], execOpts);
}
function hasTags3(opts) {
  let result = false;
  try {
    result = !!childProcess14.execSync("git", ["tag"], opts);
  } catch (err) {
...
var import_npmlog48, childProcess14;
var init_get_last_commit = __esm({
  "libs/commands/diff/src/lib/get-last-commit.ts"() {
    "use strict";
    import_npmlog48 = __toESM(require("npmlog"));
    childProcess14 = require_child_process();
  }
});
...
function hasCommit(opts) {
  ...
  let retVal;
  try {
    childProcess15.execSync("git", ["log"], opts);
    retVal = true;
  } catch (e) {
    retVal = false;
  }
...
var import_npmlog49, childProcess15;
var init_has_commit = __esm({
  "libs/commands/diff/src/lib/has-commit.ts"() {
    "use strict";
    import_npmlog49 = __toESM(require("npmlog"));
    childProcess15 = require_child_process();
  }
});
...
var childProcess16, DiffCommand;
var init_src4 = __esm({
  "libs/commands/diff/src/index.ts"() {
    "use strict";
    init_src();
    ...
    init_has_commit();
    childProcess16 = require_child_process();
    DiffCommand = class extends Command {
      ...
      execute() {
        return childProcess16.spawn("git", this.args, this.execOpts).catch((err) => {
          if (err.exitCode) {
            throw err;
          }
        });
...
var require_command3 = __commonJS({
  "libs/commands/diff/src/command.ts"(exports2, module2) {
    ...
    var command = {
      ...
      async handler(argv) {
        return (await Promise.resolve().then(() => (init_src4(), src_exports2))).factory(argv);
      }
    };
    module2.exports = command;
  }
...
var import_p_map5, childProcess17, ExecCommand;
var init_src5 = __esm({
  "libs/commands/exec/src/index.ts"() {
    "use strict";
    init_src();
    import_p_map5 = __toESM(require("p-map"));
    childProcess17 = require_child_process();
    ExecCommand = class extends Command {
      ...
      runCommandInPackageStreaming(pkg2) {
        return childProcess17.spawnStreaming(this.command, this.args, this.getOpts(pkg2), this.prefix && pkg2.name);
      }
      runCommandInPackageCapturing(pkg2) {
        return childProcess17.spawn(this.command, this.args, this.getOpts(pkg2));
      }
    };
  }
});
...
var import_dedent6, import_fs_extra12, import_p_map_series2, import_path21, childProcess18, ImportCommand;
var init_src6 = __esm({
  "libs/commands/import/src/index.ts"() {
    "use strict";
    init_src();
    ...
    childProcess18 = require_child_process();
    ImportCommand = class extends Command {
      ...
      execSync(cmd, args) {
        return childProcess18.execSync(cmd, args, this.execOpts);
      }
      externalExecSync(cmd, args) {
        return childProcess18.execSync(cmd, args, this.externalExecOpts);
      }
...
${version}`;
      ...
      execute() {
        ...
        const mapper = (sha) => {
          ...
          const proc = childProcess18.exec("git", procArgs, this.execOpts);
          ...
          return pulseTillDone(proc).then(() => {
            ...
            if (diff === "") {
              tracker.completeWork(1);
              return childProcess18.exec("git", ["am", "--skip"], this.execOpts);
            }
            err.sha = sha;
            throw err;
          });
...
var require_command5 = __commonJS({
  "libs/commands/import/src/command.ts"(exports2, module2) {
    ...
    var command = {
      ...
      async handler(argv) {
        return (await Promise.resolve().then(() => (init_src6(), src_exports3))).factory(argv);
      }
    };
    module2.exports = command;
  }
...
var import_devkit5, import_fs6, import_fs_extra13, import_npmlog50, import_tree, LARGE_BUFFER, childProcess19, PACKAGE_GLOB, InitCommand;
var init_src8 = __esm({
  "libs/commands/init/src/index.ts"() {
    "use strict";
    init_src();
    ...
    childProcess19 = require_child_process();
    ...
    InitCommand = class {
      constructor(args) {
        ...
        import_npmlog50.default.heading = "lerna";
...
`);
        ...
        return async () => {
          if (isGitInitialized(this.cwd)) {
            ...
            await childProcess19.exec("git", ["init"], {
              cwd: this.cwd,
              maxBuffer: 1024
            });
          }
          if (this.args.skipInstall === void 0) {
            ...
            await childProcess19.exec(command, args, {
              cwd: this.cwd,
...
function getCurrentBranch(opts) {
  import_npmlog51.default.silly("getCurrentBranch");
  const branch = childProcess20.execSync("git", ["rev-parse", "--abbrev-ref", "HEAD"], opts);
  import_npmlog51.default.verbose("currentBranch", branch);
  return branch;
}
var import_npmlog51, childProcess20;
var init_get_current_branch = __esm({
  "libs/commands/version/src/lib/get-current-branch.ts"() {
    "use strict";
    import_npmlog51 = __toESM(require("npmlog"));
    childProcess20 = require_child_process();
  }
});
...
async function maybeFormatFile(filePath) {
  ...
  if (fileInfo.ignored) {
    import_npmlog52.default.silly("version", `Skipped applying prettier to ignored file: ${filePath}`);
    return;
  }
  try {
    ...
    import_npmlog52.default.silly("version", `Successfully applied prettier to updated file: ${filePath}`);
  } catch {
    import_npmlog52.default.silly("version", `Failed to apply prettier to updated file: ${filePath}`);
  }
}
async function gitAdd(changedFiles, gitOpts, execOpts) {
  ...
  import_npmlog52.default.silly("gitAdd", files);
  return childProcess21.exec("git", ["add", "--", ...files], execOpts);
}
var import_devkit6, import_fs7, import_npmlog52, import_path22, import_slash3, childProcess21, resolvedPrettier;
var init_git_add = __esm({
  "libs/commands/version/src/lib/git-add.ts"() {
    ...
    childProcess21 = require_child_process();
  }
});
...
function gitCommit(message, { amend, commitHooks, signGitCommit, signoffGitCommit }, opts) {
  import_npmlog53.default.silly("gitCommit", message);
  const args = ["commit"];
  ...
  import_npmlog53.default.verbose("git", args);
  return childProcess22.exec("git", args, opts);
}
var import_npmlog53, import_os6, childProcess22;
var init_git_commit = __esm({
  "libs/commands/version/src/lib/git-commit.ts"() {
    ...
    childProcess22 = require_child_process();
  }
});

// libs/commands/version/src/lib/git-push.ts
function gitPush(remote, branch, opts) {
  import_npmlog54.default.silly("gitPush", remote, branch);
  return childProcess23.exec("git", ["push", "--follow-tags", "--no-verify", "--atomic", remote, branch], opts).catch((error) => {
    if (/atomic/.test(error.stderr) || process.env.GIT_REDIRECT_STDERR === "2>&1" && /atomic/.test(error.stdout)) {
      import_npmlog54.default.warn("gitPush", error.stderr);
      import_npmlog54.default.info("gitPush", "--atomic failed, attempting non-atomic push");
      return childProcess23.exec("git", ["push", "--follow-tags", "--no-verify", remote, branch], opts);
    }
    throw error;
  });
}
var import_npmlog54, childProcess23;
var init_git_push = __esm({
  "libs/commands/version/src/lib/git-push.ts"() {
    "use strict";
    import_npmlog54 = __toESM(require("npmlog"));
    childProcess23 = require_child_process();
  }
});

// libs/commands/version/src/lib/git-tag.ts
function gitTag(tag, { forceGitTag, signGitTag }, opts, command = "git tag %s -m %s") {
  import_npmlog55.default.silly("gitTag", tag, command);
  ...
  import_npmlog55.default.verbose(cmd, interpolatedArgs);
  return childProcess24.exec(cmd, interpolatedArgs, opts);
}
var import_npmlog55, childProcess24;
var init_git_tag = __esm({
  "libs/commands/version/src/lib/git-tag.ts"() {
    "use strict";
    import_npmlog55 = __toESM(require("npmlog"));
    childProcess24 = require_child_process();
  }
});

// libs/commands/version/src/lib/is-anything-committed.ts
function isAnythingCommitted(opts) {
  import_npmlog56.default.silly("isAnythingCommitted", "");
  const anyCommits = childProcess25.execSync("git", ["rev-list", "--count", "--all", "--max-count=1"], opts);
  import_npmlog56.default.verbose("isAnythingCommitted", anyCommits);
  return Boolean(parseInt(anyCommits, 10));
}
var import_npmlog56, childProcess25;
var init_is_anything_committed = __esm({
  "libs/commands/version/src/lib/is-anything-committed.ts"() {
    "use strict";
    import_npmlog56 = __toESM(require("npmlog"));
    childProcess25 = require_child_process();
...
function updateRemote(opts) {
  childProcess26.execSync("git", ["remote", "update"], opts);
}
function countLeftRight(symmetricDifference, opts) {
  const stdout = childProcess26.execSync(
    "git",
...
function remoteBranchExists(gitRemote, branch, opts) {
  import_npmlog58.default.silly("remoteBranchExists", "");
  const remoteBranch = `${gitRemote}/${branch}`;
  try {
    childProcess27.execSync("git", ["show-ref", "--verify", `refs/remotes/${remoteBranch}`], opts);
    return true;
  } catch (e) {
    return false;
  }
}
var import_npmlog58, childProcess27;
var init_remote_branch_exists = __esm({
  "libs/commands/version/src/lib/remote-branch-exists.ts"() {
    "use strict";
    import_npmlog58 = __toESM(require("npmlog"));
    childProcess27 = require_child_process();
  }
});
...
async function updateLockfileVersion(pkg2) {
  ...
  const obj = await (0, import_load_json_file3.default)(lockfilePath).catch(() => {
    import_npmlog59.default.verbose("version", `${pkg2.name} has no lockfile. Skipping lockfile update.`);
  });
  if (!obj) {
    return;
  }
...
var import_devkit7, import_load_json_file3, import_npmlog59, import_path23;
...
var require_src2 = __commonJS({
  "libs/commands/version/src/index.ts"(exports2, module2) {
    ...
    var childProcess31 = require_child_process();
...
var require_command9 = __commonJS({
  "libs/commands/version/src/command.ts"(exports2, module2) {
    "use strict";
    var import_npmlog66 = __toESM(require("npmlog"));
    var import_semver9 = __toESM(require("semver"));
    ...
    var command = {
      ...
      builder(yargs2, composed) {
        ...
        return yargs2.option("ignore", {
          ...
          if (argv["--"]) {
            import_npmlog66.default.warn("EDOUBLEDASH", "Arguments after -- are no longer passed to subprocess executions.");
            import_npmlog66.default.warn("EDOUBLEDASH", "This will cause an error in a future major version.");
          }
          return argv;
        });
      },
...
function getCurrentSHA(opts) {
  import_npmlog60.default.silly("getCurrentSHA", "");
  const sha = childProcess28.execSync("git", ["rev-parse", "HEAD"], opts);
  import_npmlog60.default.verbose("getCurrentSHA", sha);
  return sha;
}
var import_npmlog60, childProcess28;
var init_get_current_sha = __esm({
  "libs/commands/publish/src/lib/get-current-sha.ts"() {
    "use strict";
    import_npmlog60 = __toESM(require("npmlog"));
    childProcess28 = require_child_process();
  }
});

// libs/commands/publish/src/lib/get-current-tags.ts
async function getCurrentTags(execOpts, matchingPattern) {
  import_npmlog61.default.silly("getCurrentTags", "matching %j", matchingPattern);
  const opts = Object.assign({}, execOpts, {
    // don't reject due to non-zero exit code when there are no results
    reject: false
  });
  const result = await childProcess29.exec(
    "git",
...
var import_npm_package_arg8, import_npmlog61, childProcess29;
var init_get_current_tags = __esm({
  "libs/commands/publish/src/lib/get-current-tags.ts"() {
    ...
    childProcess29 = require_child_process();
  }
});
...
async function getProjectsWithTaggedPackages(projectNodes, projectFileMap, execOpts) {
  import_npmlog63.default.silly("getTaggedPackages", "");
  const result = await childProcess30.exec(
    "git",
...
async function getProjectsWithUnpublishedPackages(projectNodes, opts) {
  import_npmlog64.default.silly("getProjectsWithUnpublishedPackages", "");
  const mapper = (node) => {
    const pkg2 = getPackage(node);
    ...
    return import_pacote.default.packument(pkg2.name, opts).then(
      ...
      () => {
        import_npmlog64.default.warn("", "Unable to determine published version, assuming %j unpublished.", pkg2.name);
        return node;
      }
    );
  };
...
var import_npmlog64, import_p_map7, import_pacote;
var init_get_projects_with_unpublished_packages = __esm({
  "libs/commands/publish/src/lib/get-projects-with-unpublished-packages.ts"() {
    "use strict";
    init_src();
    import_npmlog64 = __toESM(require("npmlog"));
      ...
      builder(yargs2) {
        ...
        return yargs2.option("npm-tag", {
          ...
          if (argv["npmTag"]) {
            ...
            delete argv["npmTag"];
            delete argv["npm-tag"];
            import_npmlog66.default.warn("deprecated", "--npm-tag has been renamed --dist-tag");
          }
          return argv;
        }).middleware((args) => {
...
`
        ...
        import_npmlog66.default.resume();
        process.stdout.write("\n");
...
var require_repair = __commonJS({
  "packages/lerna/src/commands/repair/index.ts"(exports2, module2) {
    ...
    var RepairCommand = class extends Command {
      ...
      async execute() {
        this.configureNxOutput();
        const verbose = this.options?.verbose ? true : import_npmlog66.default.level === "verbose";

...
function gitCommit(message, { amend, commitHooks, signGitCommit, signoffGitCommit }, opts) {
  import_npmlog36.default.silly("gitCommit", message);
  const args = ["commit"];
  ...
  } else if (message.indexOf(import_os2.EOL) > -1) {
    args.push("-F", temp_write_default.sync(message, "lerna-commit.txt"));
  } else {
    args.push("-m", message);
  }
  import_npmlog36.default.verbose("git", args);
  return childProcess11.exec("git", args, opts);
}
var import_npmlog36, import_os2, childProcess11;

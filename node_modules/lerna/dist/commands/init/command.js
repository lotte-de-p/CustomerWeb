...
function npmInstall(pkg, { registry, npmClient, npmClientArgs, npmGlobalStyle, mutex, stdio = "pipe", subCommand = "install" }) {
  ...
  import_npmlog22.default.silly("npmInstall", [cmd2, args]);
...
var import_devkit5, import_fs5, import_fs_extra8, import_npmlog36, import_tree, LARGE_BUFFER, childProcess11, PACKAGE_GLOB, InitCommand;
var init_src2 = __esm({
  "libs/commands/init/src/index.ts"() {
    "use strict";
    init_src();

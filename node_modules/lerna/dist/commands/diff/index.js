...
var import_npmlog37 = __toESM(require("npmlog"));
var childProcess12 = require_child_process();
function hasCommit(opts) {
  import_npmlog37.default.silly("hasCommit", "");
  let retVal;
  try {
    childProcess12.execSync("git", ["log"], opts);
    retVal = true;
  } catch (e) {
    retVal = false;
  }
...
var childProcess13 = require_child_process();
...
var DiffCommand = class extends Command {
  ...
  execute() {
    return childProcess13.spawn("git", this.args, this.execOpts).catch((err) => {
      if (err.exitCode) {
        throw err;
      }
    });

...
var withRoundTrip = function withRoundTrip(storyFn, context) {
  ...
  var globalMockData = mockAddonConfigs.globalMockData,
    ...
    ignoreQueryParams = mockAddonConfigs.ignoreQueryParams;
  ...
  if (INITIAL_MOUNT_STATE) {
    ...
    _faker["default"].setIgnoreQueryParams(ignoreQueryParams);
    channel.emit(_constants.EVENTS.SEND, {
      mockData: _faker["default"].getRequests(),

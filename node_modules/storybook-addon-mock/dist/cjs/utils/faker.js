...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /* eslint-disable no-restricted-globals */
var global =
// eslint-disable-next-line no-undef
typeof globalThis !== 'undefined' && globalThis || typeof self !== 'undefined' && self || typeof global !== 'undefined' && global || {};
var Faker = /*#__PURE__*/function () {
  function Faker() {
    var _this = this;
    ...
    _defineProperty(this, "add", function (request) {
      var _getNormalizedUrl = (0, _url.getNormalizedUrl)(request.url),
      ...
      var errors = (0, _validator.validate)(request, _validator.schema);
    ...
    _defineProperty(this, "update", function (item, fieldKey, value) {
      var url = item.url,
        method = item.method;
      var _getNormalizedUrl2 = (0, _url.getNormalizedUrl)(url),
    ...
    _defineProperty(this, "matchMock", function (url) {
      ...
      var _getNormalizedUrl3 = (0, _url.getNormalizedUrl)(url),
      ...
      for (var key in _this.requestMap) {
        ...
        var _getNormalizedUrl4 = (0, _url.getNormalizedUrl)(requestUrl),
          requestPath = _getNormalizedUrl4.path,
          requestSearchKeys = _getNormalizedUrl4.searchParamKeys;
        if ((0, _pathToRegexp.match)(requestPath)(path) && method == requestMethod && _this.matchQueryParams(searchParamKeys, requestSearchKeys) && !_this.requestMap[key].skip) {
    ...
    _defineProperty(this, "matchQueryParams", function (searchParams, requestSearchParams) {
      return _this.ignoreQueryParams || (0, _array.arrayEquals)(searchParams, requestSearchParams);
    });
      ...
      return new Promise(function (resolve, reject) {
        ...
        var timeoutId = setTimeout(function () {
          if (typeof response === 'function') {
            resolve((0, _response.CustomResponse)(url, status, response(request)));
          } else {
            resolve((0, _response.CustomResponse)(url, status, response));
          }
      ...
      if (matched) {
        ...
        setTimeout(function () {
          if (typeof response === 'function') {
            ...
            request.respond(+status, _headers.defaultResponseHeaders, JSON.stringify(data));
          } else {
            request.respond(+status, _headers.defaultResponseHeaders, JSON.stringify(response));
          }
        }, +delay);
      } else {
        ...
        (0, _headers.setRequestHeaders)(realXhr, new Map(Object.entries(request.requestHeaders.getHash())));
        realXhr.addEventListener('readystatechange', function () {
          if (realXhr.readyState === XMLHttpRequest.DONE) {
            request.respond(realXhr.status, (0, _headers.getResponseHeaderMap)(realXhr), realXhr.responseText, realXhr.statusText);
          }
        });

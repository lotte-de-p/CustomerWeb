...
export var Panel = function Panel(props) {
  ...
  var emit = useChannel(_defineProperty({}, EVENTS.SEND, function (newState) {
    setState(newState);
  }));
  ...
  if (!mockData || mockData.length === 0) {
    return /*#__PURE__*/React.createElement(AddonPanel, props, /*#__PURE__*/React.createElement(Placeholder, null, "No mock data found."));
  }
  return /*#__PURE__*/React.createElement(AddonPanel, props, /*#__PURE__*/React.createElement(ScrollArea, null, mockData.map(function (item, index) {
    ...
    return /*#__PURE__*/React.createElement(MockItem, _extends({
      id: index,
      key: index,

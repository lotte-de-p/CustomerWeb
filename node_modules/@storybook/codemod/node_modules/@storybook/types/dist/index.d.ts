...
type MakeAllParametersOptional<T> = T extends (...args: infer P) => infer R ? (...args: {
    [K in keyof P]?: Partial<P[K]>;
}) => R : never;
type ComposedStoryPlayFn<TRenderer extends Renderer = Renderer, TArgs = Args> = MakeAllParametersOptional<PlayFunction<TRenderer, Partial<TArgs>>>;
/**

...
export interface PortalsPlugin {
    publishNative<TMessage extends PortalMessage>(message: TMessage): Promise<void>;
    addListener<T = unknown>(eventName: string, listenerFunc: SubscriptionCallback<T>): Promise<PluginListenerHandle> & PluginListenerHandle;
}
/**

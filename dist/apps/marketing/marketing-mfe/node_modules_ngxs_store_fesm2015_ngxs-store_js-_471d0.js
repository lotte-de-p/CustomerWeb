(self["webpackChunkmarketing_mfe"] = self["webpackChunkmarketing_mfe"] || []).push([["node_modules_ngxs_store_fesm2015_ngxs-store_js-_471d0"],{
...
/* harmony import */ var _ngxs_store_operators__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ngxs/store/operators */ 1160);
/* harmony import */ var _ngxs_store_operators__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_ngxs_store_operators__WEBPACK_IMPORTED_MODULE_5__);
...
function mapActionResult() {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(({
    action,
    status,
    error
  }) => {
...
function mapAction() {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(ctx => ctx.action);
}
...
function leaveNgxs(ngxsExecutionStrategy) {
  return source => {
    return new rxjs__WEBPACK_IMPORTED_MODULE_3__.Observable(sink => {
 ...
 */
class OrderedBehaviorSubject extends rxjs__WEBPACK_IMPORTED_MODULE_3__.BehaviorSubject {
  constructor(value) {
    super(value);
    this._orderedNext = orderedQueueOperation(value => super.next(value));
...
class InternalDispatcher {
  ...
  dispatchByEvents(actionOrActions) {
    if (Array.isArray(actionOrActions)) {
      if (actionOrActions.length === 0) return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(this._stateStream.getValue());
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.forkJoin)(actionOrActions.map(action => this.dispatchSingle(action)));
    } else {
  ...
  dispatchSingle(action) {
    ...
    }])(prevState, action).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.shareReplay)());
  }
  getActionResultStream(action) {
    return this._actionResults.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(ctx => ctx.action === action && ctx.status !== "DISPATCHED" /* Dispatched */), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.shareReplay)());
  }
  createDispatchObservable(actionResult$) {
    return actionResult$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.exhaustMap)(ctx => {
      switch (ctx.status) {
        case "SUCCESSFUL" /* Successful */:
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(this._stateStream.getValue());
        case "ERRORED" /* Errored */:
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.throwError)(ctx.error);
        default:
...
class StateContextFactory {
  ...
  createStateContext(mappedStore) {
    ...
    return {
      ...
      setState(val) {
        const currentAppState = root.getState();
        return (0,_ngxs_store_operators__WEBPACK_IMPORTED_MODULE_5__.isStateOperator)(val) ? setStateFromOperator(root, currentAppState, val, mappedStore.path) : setStateValue(root, currentAppState, val, mappedStore.path);
      },
      dispatch(actions) {
        return root.dispatch(actions);
      }
...
class StateFactory {
  ...
  connectActionHandlers() {
    ...
    this._actionsSubscription = this._actions.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(ctx => ctx.status === "DISPATCHED" /* Dispatched */), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(ctx => {
      dispatched$.next(ctx);
      const action = ctx.action;
      return this.invokeActions(dispatched$, action).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(() => ({
        action,
        status: "SUCCESSFUL" /* Successful */
      })), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.defaultIfEmpty)({
        action,
        status: "CANCELED" /* Canceled */
      }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.catchError)(error => (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)({
        action,
  ...
  invokeActions(dispatched$, action) {
        ...
        for (const actionMeta of actionMetas) {
          ...
          try {
            ...
            if (result instanceof Promise) {
              result = (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.from)(result);
            }
            if ((0,rxjs__WEBPACK_IMPORTED_MODULE_3__.isObservable)(result)) {
              ...
              result = result.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(value => {
                if (value instanceof Promise) {
                  return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.from)(value);
                }
              ...
              if (actionMeta.options.cancelUncompleted) {
                ...
                result = result.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.takeUntil)(dispatched$.pipe(ofActionDispatched(action))));
              }
            } else {
              result = (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)({}).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.shareReplay)());
            }
            results.push(result);
          } catch (e) {
            results.push((0,rxjs__WEBPACK_IMPORTED_MODULE_3__.throwError)(e));
          }
    ...
    if (!results.length) {
      results.push((0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)({}));
    }
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.forkJoin)(results);
  }
...
class Store {
  constructor(_stateStream, _internalStateOperations, _config, _internalExecutionStrategy, _stateFactory, initialStateValue) {
     ...
     */
    this._selectableStateStream = this._stateStream.pipe(leaveNgxs(this._internalExecutionStrategy), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.shareReplay)({
      bufferSize: 1,
      refCount: true
    }));
  ...
  select(selector) {
    ...
    return this._selectableStateStream.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(selectorFn), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.catchError)(err => {
    ...
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.distinctUntilChanged)(), leaveNgxs(this._internalExecutionStrategy));
  }
  selectOnce(selector) {
    return this.select(selector).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.take)(1));
  }
...
class LifecycleStateManager {
  ...
  ngxsBootstrap(action, results) {
    this._internalStateOperations.getRootStateOperations().dispatch(action).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(() => !!results), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(() => this._invokeInitOnStates(results.states)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(() => this._bootstrapper.appBootstrapped$), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(appBootstrapped => !!appBootstrapped), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.catchError)(error => {
      ...
      return rxjs__WEBPACK_IMPORTED_MODULE_3__.EMPTY;
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.takeUntil)(this._destroy$)).subscribe(() => this._invokeBootstrapOnStates(results.states));
  }
  _invokeInitOnStates(mappedStores) {
    for (const mappedStore of mappedStores) {
      const instance = mappedStore.instance;
      if (instance.ngxsOnChanges) {
        this._store.select(state => getValue(state, mappedStore.path)).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.startWith)(undefined), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.pairwise)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.takeUntil)(this._destroy$)).subscribe(([previousValue, currentValue]) => {

                        ...
                        : (e.prevByte = (function (e, t, r) {
                            ...
                            do {
                              if (
                                ...
                                while (o < 256) o = (o << 1) | x(t, e.m_Decoders, o);
                                break;
                              }
                            } while (o < 256);
                            return (o << 24) >> 24;
              ...
              if (
                ...
                for (X = 2, G = 0; G < 4; ++G)
                  if (!((m = w(e._matchFinder, -1, e.reps[G], M)) < 2)) {
                    g = m;
                    do {
                      while (h < r + m) e._optimum[++h].Price = 268435455;
                ...
                do {
                  ...
                  for (
                    ...
                    if (
                      ...
                      while (++f != d && e._bufferBase[m + f] == e._bufferBase[n + f]);
                      if (f == d) {
              ...
              (e._numDistancePairs = (function (e, t) {
                ...
                for (
                  ...
                  if (
                    ...
                    while (++h != m && e._bufferBase[v + h] == e._bufferBase[n + h]);
        ...
        function d(e) {
          if (e) {
            ...
            if (!isNaN(e.length)) {
              var r = -1,
                n = function t() {
                  while (++r < e.length) if (g.call(e, r)) return (t.value = e[r]), (t.done = !1), t;
        ...
        var t = (function () {
          ...
          function s(e, t) {
            ...
            for (
              ...
              (e += We), (t -= We);
            while (e > 4294967295) (e -= We), (t += We);
            for (t %= 0x10000000000000000; t > 0x7fffffff00000000; ) t -= 0x10000000000000000;
            while (-0x8000000000000000 > t) t += 0x10000000000000000;
            return [e, t];
          }

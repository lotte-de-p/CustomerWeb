(self["webpackChunksales_mfe"] = self["webpackChunksales_mfe"] || []).push([["libs_shared_step-flow_src_index_ts-_85320"],{
...
class StepFactory {
  ...
  static #_ = this.ɵfac = function StepFactory_Factory(t) {
...
class TemplateFactory {
  ...
  static #_ = this.ɵfac = function TemplateFactory_Factory(t) {
...
let NavigationBarComponent = class NavigationBarComponent {
  constructor(store, formErrorService, loaderService, changeDetectorRef) {
    ...
    this.nextStepLabel = _navigation_bar_next_label_enum__WEBPACK_IMPORTED_MODULE_3__.NavigationBarNextLabelEnum.START;
    this.alternativeFirstStep = false;
  }
  ngOnInit() {
    this.store.select(_store__WEBPACK_IMPORTED_MODULE_4__.StepFlowState.currentStep).pipe((0,_ngneat_until_destroy__WEBPACK_IMPORTED_MODULE_9__.untilDestroyed)(this), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.tap)(currentStep => {
      if (currentStep) {
    ...
    this.loaderService.loadingStatus.pipe((0,_ngneat_until_destroy__WEBPACK_IMPORTED_MODULE_9__.untilDestroyed)(this)).subscribe(loaderData => {
  ...
  goToNextStep() {
    if (!this.isLoading) {
      ...
      if (this.currentStep.nextButtonCallback) {
        this.currentStep.nextButtonCallback().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.take)(1)).subscribe(response => {
          if (response) {
  ...
  goToPreviousStep() {
    if (this.currentStep.prevButtonCallback) {
      this.currentStep.prevButtonCallback().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.take)(1)).subscribe(response => {
        if (response) {
  ...
  static #_ = this.ɵfac = function NavigationBarComponent_Factory(t) {
    return new (t || NavigationBarComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ngxs_store__WEBPACK_IMPORTED_MODULE_2__.Store), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_telenet_ng_lib_form__WEBPACK_IMPORTED_MODULE_1__.FormErrorService), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_telenet_ng_lib_page__WEBPACK_IMPORTED_MODULE_6__.LoaderService), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__.ChangeDetectorRef));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
    ...
    dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_7__.NgClass, _angular_common__WEBPACK_IMPORTED_MODULE_7__.NgIf, _ngx_translate_core__WEBPACK_IMPORTED_MODULE_8__.TranslatePipe],
    encapsulation: 2
  });
};
NavigationBarComponent = __decorate([(0,_ngneat_until_destroy__WEBPACK_IMPORTED_MODULE_9__.UntilDestroy)(), __metadata("design:paramtypes", [_ngxs_store__WEBPACK_IMPORTED_MODULE_2__.Store, _telenet_ng_lib_form__WEBPACK_IMPORTED_MODULE_1__.FormErrorService, _telenet_ng_lib_page__WEBPACK_IMPORTED_MODULE_6__.LoaderService, _angular_core__WEBPACK_IMPORTED_MODULE_0__.ChangeDetectorRef])], NavigationBarComponent);
...
class StepHostDirective {
  ...
  static #_ = this.ɵfac = function StepHostDirective_Factory(t) {
...
let StepContainerComponent = class StepContainerComponent extends _telenet_ng_lib_page__WEBPACK_IMPORTED_MODULE_4__.AbstractBaseComponent {
  ...
  static #_ = this.ɵfac = function StepContainerComponent_Factory(t) {
...
class StepContainerDirective {
  ...
  static #_ = this.ɵfac = function StepContainerDirective_Factory(t) {
...
class StepFlowLibModule {
  static #_ = this.ɵfac = function StepFlowLibModule_Factory(t) {
...
class Step {
  constructor(key) {
    this.type = _step_enum__WEBPACK_IMPORTED_MODULE_0__.StepEnum.DEFAULT;
    this.nextButtonLabel = 'btn.steps.next';
    this.isEnabled = true;
...
class SetStepConfigurationAction {
  static #_ = this.type = '[StepFlow] set the step configuration';
  constructor(stepFlowConfig) {
    this.stepFlowConfig = stepFlowConfig;
  }
}
class ReportStepLoadTimingAction {
  static #_ = this.type = '[StepFlow] set whether to capture step load time or not';
  constructor(reportStepLoadTime) {
    this.reportStepLoadTime = reportStepLoadTime;
  }
}
class SetStepNavigationStartTimeAction {
  static #_ = this.type = '[StepFlow] set step navigation start time in milliseconds';
}
class SetStepsAction {
  static #_ = this.type = '[StepFlow] set the steps for the stepflow';
  constructor(steps) {
    this.steps = steps;
  }
}
class GoToNextStepAction {
  static #_ = this.type = '[StepFlow] Go to next step';
  constructor(isStepComplete) {
    this.isStepComplete = isStepComplete;
  }
}
class GoToFinalStepAction {
  static #_ = this.type = '[StepFlow] Go to final step';
}
class GoToPreviousStepAction {
  static #_ = this.type = '[StepFlow] Go to previous step';
}
class SetStepToEditAction {
  static #_ = this.type = '[StepFlow] set the stepflow to a certain step so it can be edited';
  constructor(stepKey) {
    this.stepKey = stepKey;
  }
}
class SetStepIncompleteAction {
  static #_ = this.type = '[StepFlow] set a certain step to the incomplete state';
  constructor(stepKey) {
    this.stepKey = stepKey;
  }
}
class SetStepCompleteAction {
  static #_ = this.type = '[StepFlow] set a certain step to the complete state';
  constructor(stepKey) {
    this.stepKey = stepKey;
  }
}
class InsertStepsBeforeAction {
  static #_ = this.type = '[StepFlow] Insert steps before a certain step with a certain key';
...
class InsertStepsAfterAction {
  static #_ = this.type = '[StepFlow] Insert steps behind a certain step with a certain key';
  constructor(steps, stepKey) {
    this.steps = steps;
    this.stepKey = stepKey;
  }
...
class RemoveStepsWithStepKeysAction {
  static #_ = this.type = '[StepFlow] Remove the steps with a key in the given list';
  constructor(stepKeys) {
    this.stepKeys = stepKeys;
  }
}
class SetStepsEnabledState {
  static #_ = this.type = '[StepFlow] Set the enabled states of multiple steps';
  constructor(steps) {
    this.steps = steps;
  }
}
class UpdateStepAction {
  static #_ = this.type = '[StepFlow] Change the properties of a certain step';
  constructor(step) {
    this.step = step;
  }
}
class UpdateCurrentStepImageAction {
  static #_ = this.type = '[StepFlow] Update the current step image';
  constructor(image) {
    this.image = image;
  }
}
class SetCurrentDecisionOnStepFlowConfig {
  static #_ = this.type = '[StepFlow] Set the current decision on a step flow config';
...
class ETFStepValidAction {
  static #_ = this.type = '[StepFlow] Set ETF step valid';
  constructor(payload) {
    this.payload = payload;
  }
}
class GoToStepAction {
  static #_ = this.type = '[StepFlow] Change current step with given step by key';
  constructor(stepKey) {
    this.stepKey = stepKey;
  }
}
class NotifyStepRendered {
  static #_ = this.type = '[StepFlow] Notify step rendered';
  constructor(stepKey) {
    this.stepKey = stepKey;
  }
}
...
/* harmony export */ });
/* harmony import */ var immer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! immer */ 75825);
/* harmony import */ var _ngxs_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ngxs/store */ 71943);
/* harmony import */ var _ngxs_store__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_ngxs_store__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./step-flow.actions */ 42035);
/* harmony import */ var _factories_step_factory__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../factories/step.factory */ 22972);
/* harmony import */ var _step_flow_util__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./step-flow.util */ 78282);
...
let StepFlowState = class StepFlowState {
  ...
  constructor(store, stepFactory) {
    ...
    this.log = _telenet_ng_lib_shared__WEBPACK_IMPORTED_MODULE_4__.LogFactory.createLogger(StepFlowState_1);
  }
  ...
  static containsStep(type) {
    return (0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.createSelector)([StepFlowState_1], state => {
      return !!state.steps.find(step => step.key === type);
    });
  }
  initialise(ctx, action) {
    ctx.setState((0,immer__WEBPACK_IMPORTED_MODULE_6__.produce)(ctx.getState(), draft => {
  ...
  goToFinalStepAction(ctx, _action) {
    ...
    steps.filter(step => step && Object.keys(step).length).forEach(step => {
      if (step.isFinal()) {
        ...
        if (step.isCompleted) {
          nextStep = _step_flow_util__WEBPACK_IMPORTED_MODULE_3__.StepFlowUtil.getNextIncompletedStep(steps);
        } else {
          step.setCompleted(true);
          nextStep = _step_flow_util__WEBPACK_IMPORTED_MODULE_3__.StepFlowUtil.getStepByRelativeIndexOffset(step, steps, '+', 1);
        }
      }
    });
    ctx.setState((0,immer__WEBPACK_IMPORTED_MODULE_6__.produce)(ctx.getState(), this.setCurrentStep(nextStep)));
  }
  goToNextStepAction(ctx, _action) {
    ...
    if (currentStep?.isCompleted) {
      ...
      nextStep = _step_flow_util__WEBPACK_IMPORTED_MODULE_3__.StepFlowUtil.getStepByRelativeIndexOffset(currentStep, steps, '+', 1);
    }
    ctx.setState((0,immer__WEBPACK_IMPORTED_MODULE_6__.produce)(ctx.getState(), this.setCurrentStep(nextStep)));
  }
  goToPreviousStepAction(ctx, _action) {
    ...
    const steps = ctx.getState().steps;
    if (currentStep?.isCompleted) {
      previousStep = _step_flow_util__WEBPACK_IMPORTED_MODULE_3__.StepFlowUtil.getNextIncompletedStep(steps);
    } else {
      previousStep = _step_flow_util__WEBPACK_IMPORTED_MODULE_3__.StepFlowUtil.getStepByRelativeIndexOffset(currentStep, steps, '-', 1);
  ...
  goToStepAction(ctx, action) {
    this.decideSteps(ctx, ctx.getState().stepConfiguration);
    const steps = ctx.getState().steps;
    const nextStep = _step_flow_util__WEBPACK_IMPORTED_MODULE_3__.StepFlowUtil.getActiveStep(steps, action.stepKey);
    ctx.setState((0,immer__WEBPACK_IMPORTED_MODULE_6__.produce)(ctx.getState(), this.setCurrentStep(nextStep)));
  }
  ...
  static #_2 = this.ɵfac = function StepFlowState_Factory(t) {
    return new (t || StepFlowState)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Store), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_factories_step_factory__WEBPACK_IMPORTED_MODULE_2__.StepFactory));
  };
...
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Action)(_step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.SetStepsAction), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.SetStepsAction]), __metadata("design:returntype", void 0)], StepFlowState.prototype, "initialise", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Action)(_step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.SetStepConfigurationAction), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.SetStepConfigurationAction]), __metadata("design:returntype", void 0)], StepFlowState.prototype, "setStepConfigurationAction", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Action)(_step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.ReportStepLoadTimingAction), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.ReportStepLoadTimingAction]), __metadata("design:returntype", void 0)], StepFlowState.prototype, "ReportStepLoadTimingAction", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Action)(_step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.SetStepNavigationStartTimeAction), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.SetStepNavigationStartTimeAction]), __metadata("design:returntype", void 0)], StepFlowState.prototype, "SetStepNavigationStartTimeAction", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Action)(_step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.GoToFinalStepAction), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.GoToFinalStepAction]), __metadata("design:returntype", void 0)], StepFlowState.prototype, "goToFinalStepAction", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Action)(_step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.GoToNextStepAction), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.GoToNextStepAction]), __metadata("design:returntype", void 0)], StepFlowState.prototype, "goToNextStepAction", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Action)(_step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.GoToPreviousStepAction), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.GoToPreviousStepAction]), __metadata("design:returntype", void 0)], StepFlowState.prototype, "goToPreviousStepAction", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Action)(_step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.SetStepToEditAction), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.SetStepToEditAction]), __metadata("design:returntype", void 0)], StepFlowState.prototype, "setStepToEdit", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Action)(_step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.SetStepIncompleteAction), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.SetStepIncompleteAction]), __metadata("design:returntype", void 0)], StepFlowState.prototype, "setStepIncomplete", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Action)(_step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.SetStepCompleteAction), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.SetStepCompleteAction]), __metadata("design:returntype", void 0)], StepFlowState.prototype, "setStepCompleteAction", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Action)(_step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.InsertStepsBeforeAction), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.InsertStepsBeforeAction]), __metadata("design:returntype", void 0)], StepFlowState.prototype, "InsertStepsBeforeAction", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Action)(_step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.InsertStepsAfterAction), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.InsertStepsAfterAction]), __metadata("design:returntype", void 0)], StepFlowState.prototype, "InsertStepsAfterAction", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Action)(_step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.RemoveStepsWithStepKeysAction), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.RemoveStepsWithStepKeysAction]), __metadata("design:returntype", void 0)], StepFlowState.prototype, "RemoveStepsWithStepKeysAction", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Action)(_step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.SetStepsEnabledState), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.SetStepsEnabledState]), __metadata("design:returntype", void 0)], StepFlowState.prototype, "setStepsEnabledState", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Action)(_step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.UpdateStepAction), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.UpdateStepAction]), __metadata("design:returntype", void 0)], StepFlowState.prototype, "updateStepAction", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Action)(_step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.UpdateCurrentStepImageAction), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.UpdateCurrentStepImageAction]), __metadata("design:returntype", void 0)], StepFlowState.prototype, "updateCurrentStepImageAction", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Action)(_step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.SetCurrentDecisionOnStepFlowConfig), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.SetCurrentDecisionOnStepFlowConfig]), __metadata("design:returntype", void 0)], StepFlowState.prototype, "setCurrentDecisionOnStepFlowConfig", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Action)(_step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.ETFStepValidAction), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.ETFStepValidAction]), __metadata("design:returntype", void 0)], StepFlowState.prototype, "isETFStepValid", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Action)(_step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.GoToStepAction), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, _step_flow_actions__WEBPACK_IMPORTED_MODULE_1__.GoToStepAction]), __metadata("design:returntype", void 0)], StepFlowState.prototype, "goToStepAction", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Selector)(), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Object)], StepFlowState, "currentStep", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Selector)(), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", String)], StepFlowState, "currentStepImage", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Selector)(), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Number)], StepFlowState, "stepNumber", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Selector)(), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", String)], StepFlowState, "key", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Selector)(), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Array)], StepFlowState, "steps", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Selector)(), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Number)], StepFlowState, "stepNavigationStartTime", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Selector)(), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Boolean)], StepFlowState, "reportStepLoadTiming", null);
__decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Selector)(), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Boolean)], StepFlowState, "isETFStepValid", null);
StepFlowState = StepFlowState_1 = __decorate([(0,_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.State)({
  name: 'stepFlow',
  defaults: {
    initialized: false,
...
}), __metadata("design:paramtypes", [_ngxs_store__WEBPACK_IMPORTED_MODULE_0__.Store, _factories_step_factory__WEBPACK_IMPORTED_MODULE_2__.StepFactory])], StepFlowState);
...
//# sourceMappingURL=libs_shared_step-flow_src_index_ts-_85320.js.map
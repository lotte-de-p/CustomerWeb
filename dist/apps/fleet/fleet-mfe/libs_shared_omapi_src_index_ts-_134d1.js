(self["webpackChunkfleet_mfe"] = self["webpackChunkfleet_mfe"] || []).push([["libs_shared_omapi_src_index_ts-_134d1"],{
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs */ 74300);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! rxjs */ 84980);
/* harmony import */ var lodash_es__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lodash-es */ 48717);
/* harmony import */ var lodash_es__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! lodash-es */ 41855);
/* harmony import */ var _omapi_product_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./omapi-product.service */ 99721);
/* harmony import */ var _mappers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../mappers */ 29170);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils */ 28253);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 33829);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_angular_core__WEBPACK_IMPORTED_MODULE_3__);
...
class OmapiEnrichService {
  ...
  enrichResponseWithOmapiData(messageGroup, response) {
    const copy = (0,lodash_es__WEBPACK_IMPORTED_MODULE_4__["default"])(response);
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-ignore
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.forkJoin)(this.getOmapiObservables(messageGroup, copy)).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.map)(() => copy));
  }
  getOmapiObservables(messageGroup, data, specUrls = []) {
    ...
    Object.entries(data).forEach(([key, value]) => {
      if (key === 'specurl') {
        const sofyComboProduct = _utils__WEBPACK_IMPORTED_MODULE_2__.OmapiUtils.getComboProducts(data.omapiid);
        if ((0,lodash_es__WEBPACK_IMPORTED_MODULE_7__["default"])(sofyComboProduct)) {
          const omapiProduct$ = this.omapiProductService
          // eslint-disable-next-line @typescript-eslint/ban-types
          .getProductByEndpoint(messageGroup, value.toString()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.tap)(omapiProduct => {
          ...
          }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.switchMap)(omapiProduct => this.enrichConstituents(messageGroup, omapiProduct)));
  ...
  enrichConstituents(messageGroup, product) {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.forkJoin)(product.getConstituents().map(constituentInterface => {
      return this.omapiProductService.getProductByEndpoint(messageGroup, constituentInterface.specurl).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.tap)(omapiProduct => {
        constituentInterface.productInfo = omapiProduct;
      }));
    }));
  }
  static ɵfac = function OmapiEnrichService_Factory(t) {
    return new (t || OmapiEnrichService)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"](_omapi_product_service__WEBPACK_IMPORTED_MODULE_0__.OmapiProductService), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"](_mappers__WEBPACK_IMPORTED_MODULE_1__.OmapiProductMapper));
  };
  static ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjectable"]({
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! rxjs */ 33252);
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! rxjs/operators */ 72607);
...
/* harmony import */ var lodash_es__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! lodash-es */ 30144);
...
/* harmony import */ var _omapi_product_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./omapi-product.service */ 99721);
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../constants */ 44610);
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils */ 28253);
/* harmony import */ var rxjs_internal_firstValueFrom__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! rxjs/internal/firstValueFrom */ 60331);
...
class OmapiFamilyService {
  ...
  getOmapiFamilyUrl(family) {
    return this.configService.getConfig(_telenet_ng_lib_config__WEBPACK_IMPORTED_MODULE_4__.ConfigConstants.OMAPI_URL) + '/public/family/' + family;
  }
  getFamilyByEndpoint(messageGroup, endpoint) {
    ...
    return this.cacheService.get(endpoint).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.map)(rawOmapiFamily => {
      return this.parseFamily(messageGroup, rawOmapiFamily, productInfoPromises);
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.mergeMap)( /*#__PURE__*/function () {
    ...
    }()), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.catchError)(error => this.handleError(error, messageGroup)));
  }
  ...
  parseProductsByType(messageGroup, rawOmapiFamily, omapiFamily, productInfoPromises) {
    _constants__WEBPACK_IMPORTED_MODULE_6__.OmapiFamilyConstants.FAMILY_PRODUCT_TYPES.forEach(productType => {
  ...
  parseOptins(messageGroup, rawOmapiFamily, omapiFamily, productInfoPromises) {
    omapiFamily.tiers.forEach(omapiFamilyTier => {
      if (omapiFamilyTier) {
        omapiFamilyTier.optins = (0,lodash_es__WEBPACK_IMPORTED_MODULE_14__["default"])(rawOmapiFamily.optins.map(rawOptin => {
          ...
          return currentTier?.pax?.map(pax => {
            ...
            const promise = (0,rxjs_internal_firstValueFrom__WEBPACK_IMPORTED_MODULE_15__.firstValueFrom)(this.omapiProductService.getProductById(messageGroup, pax.optinId));
  ...
  parseOptions(messageGroup, rawOmapiFamily, omapiFamily, productInfoPromises) {
    omapiFamily.tiers.forEach(omapiFamilyTier => {
      omapiFamilyTier.options = (0,lodash_es__WEBPACK_IMPORTED_MODULE_14__["default"])(rawOmapiFamily.options.map(rawOption => {
        const option = {};
        option.key = rawOption.key;
        option.type = rawOption.type;
        option.omapiId = rawOption.omapiId;
        option.parents = rawOption.parents;
        const promise = (0,rxjs_internal_firstValueFrom__WEBPACK_IMPORTED_MODULE_15__.firstValueFrom)(this.omapiProductService.getProductById(messageGroup, rawOption.omapiId));
        productInfoPromises.push(promise);
        promise.then(omapiProduct => {
    ...
    rawOmapiProductTier.products.forEach(rawOmapiProduct => {
      ...
      if (rawOmapiProduct.mobileData) {
        rawOmapiProduct.mobileData.forEach(rawMobileData => {
          ...
          const omapiMobileDataPromises = (0,rxjs_internal_firstValueFrom__WEBPACK_IMPORTED_MODULE_15__.firstValueFrom)(this.omapiProductService.getProductById(messageGroup, omapiMobileData.omapiId));
      ...
      if ((0,lodash_es__WEBPACK_IMPORTED_MODULE_16__["default"])(_utils__WEBPACK_IMPORTED_MODULE_8__.OmapiUtils.getComboProducts(rawOmapiProduct.omapiId))) {
        const promise = (0,rxjs_internal_firstValueFrom__WEBPACK_IMPORTED_MODULE_15__.firstValueFrom)(this.omapiProductService.getProductById(messageGroup, rawOmapiProduct.omapiId));
        productInfoPromises.push(promise);
        promise.then(omapiProduct => {
  ...
  createTier(messageGroup, rawOmapiTier, productInfoPromises) {
    ...
    const promise = (0,rxjs_internal_firstValueFrom__WEBPACK_IMPORTED_MODULE_15__.firstValueFrom)(this.omapiProductService.getProductById(messageGroup, rawOmapiTier.omapiId));
    productInfoPromises.push(promise);
    promise.then(omapiProduct => {
  ...
  handleError(error, messageGroup) {
    if (error.status !== 410) {
      this.messageService.addMessage(new _telenet_ng_lib_message__WEBPACK_IMPORTED_MODULE_2__.ErrorMessage(messageGroup, 'omapi-' + error.status));
    }
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_17__.throwError)(() => 'An error occurred while trying to fetch ' + messageGroup);
  }
  getKlikFamilyByEndpoint(messageGroup, endpoint) {
    ...
    const productInfoPromises = [];
    return this.cacheService.get(endpoint).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.catchError)(error => this.handleError(error, messageGroup)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.map)(rawOmapiFamily => {
  ...
  createKlikTier(rawOmapiFamilyTier, messageGroup, productInfoPromises) {
    return rawOmapiFamilyTier.map(rawFamilyTier => {
      ...
      const promise = (0,rxjs_internal_firstValueFrom__WEBPACK_IMPORTED_MODULE_15__.firstValueFrom)(this.omapiProductService.getProductById(messageGroup, rawFamilyTier.omapiId));
      productInfoPromises.push(promise);
      promise.then(omapiProduct => {
        tier.productInfo = omapiProduct;
      });
    ...
    return rawOmapiFamilyOptIn.map(rawOptins => {
      ...
      optin.tiers = rawOptins.tiers?.map(rawTier => {
        ...
        optinTier.pax = rawTier.pax?.map(rawPax => {
          ...
          const promise = (0,rxjs_internal_firstValueFrom__WEBPACK_IMPORTED_MODULE_15__.firstValueFrom)(this.omapiProductService.getProductById(messageGroup, rawPax.optinId));
          productInfoPromises.push(promise);
          promise.then(omapiProduct => {
  ...
  getProductDetails(rawTier, messageGroup, productInfoPromises) {
    return rawTier.products?.map(rawTierProduct => {
      ...
      const promise = (0,rxjs_internal_firstValueFrom__WEBPACK_IMPORTED_MODULE_15__.firstValueFrom)(this.omapiProductService.getProductById(messageGroup, rawTierProduct.omapiId));
      productInfoPromises.push(promise);
      promise.then(omapiProduct => {
  ...
  getMobileData(rawTierProduct, messageGroup, productInfoPromises) {
    return rawTierProduct.mobileData?.map(rawTierProductMobile => {
      ...
      const mobileDataPromise = (0,rxjs_internal_firstValueFrom__WEBPACK_IMPORTED_MODULE_15__.firstValueFrom)(this.omapiProductService.getProductById(messageGroup, rawTierProductMobile.omapiId));
  ...
  static ɵfac = function OmapiFamilyService_Factory(t) {
    return new (t || OmapiFamilyService)(_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient), _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵinject"](_telenet_ng_lib_page__WEBPACK_IMPORTED_MODULE_3__.UrlService), _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵinject"](_telenet_ng_lib_message__WEBPACK_IMPORTED_MODULE_2__.MessageService), _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵinject"](_telenet_ng_lib_config__WEBPACK_IMPORTED_MODULE_4__.ConfigService), _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵinject"](_cache_omapi_cache_service__WEBPACK_IMPORTED_MODULE_7__.OmapiCacheService), _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵinject"](_omapi_product_service__WEBPACK_IMPORTED_MODULE_5__.OmapiProductService));
  };
...
/* harmony import */ var _mappers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../mappers */ 29170);
/* harmony import */ var _cache_omapi_cache_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./cache/omapi-cache.service */ 44852);
...
class OmapiPremiumService {
  ...
  messageService;
  gatewayUrl;
  log = _telenet_ng_lib_shared__WEBPACK_IMPORTED_MODULE_6__.LogFactory.createLogger(OmapiPremiumService);
  ...
  getOmapiPremium(messageGroup, epc, showCustomError, errorLabelKey) {
    ...
    return this.cacheService.get(epc).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.catchError)(error => this.handleError(error, messageGroup, showCustomError, errorLabelKey)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.map)(response => {
  ...
  handleError(error, messageGroup, showCustomError, errorLabelKey) {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.throwError)(() => 'An error occurred while trying to fetch ' + messageGroup);
  }
  ...
  static ɵfac = function OmapiPremiumService_Factory(t) {
    return new (t || OmapiPremiumService)(_angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpClient), _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵinject"](_mappers__WEBPACK_IMPORTED_MODULE_4__.OmapiPremiumMapper), _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵinject"](_telenet_ng_lib_page__WEBPACK_IMPORTED_MODULE_2__.UrlService), _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵinject"](_cache_omapi_cache_service__WEBPACK_IMPORTED_MODULE_5__.OmapiCacheService), _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵinject"](_telenet_ng_lib_config__WEBPACK_IMPORTED_MODULE_1__.ConfigService), _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵinject"](_telenet_ng_lib_message__WEBPACK_IMPORTED_MODULE_3__.MessageService));
  };
...
/* harmony export */ });
/* harmony import */ var lodash_es__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! lodash-es */ 3715);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! rxjs */ 74300);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! rxjs */ 84980);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! rxjs */ 33252);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! rxjs/operators */ 81527);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! rxjs/operators */ 2389);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! rxjs/operators */ 79736);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! rxjs/operators */ 72607);
/* harmony import */ var _mappers_omapi_product_mapper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../mappers/omapi-product.mapper */ 65865);
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common/http */ 1261);
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_angular_common_http__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _telenet_ng_lib_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @telenet/ng-lib-page */ 21784);
/* harmony import */ var _telenet_ng_lib_page__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_telenet_ng_lib_page__WEBPACK_IMPORTED_MODULE_2__);
...
class OmapiProductService {
  ...
  configService;
  gatewayUrl;
  log = _telenet_ng_lib_shared__WEBPACK_IMPORTED_MODULE_6__.LogFactory.createLogger(OmapiProductService);
  ...
  getProductByEPC(messageGroup, epc) {
    ...
    return this.http.get(endpoint, this.getHttpConfig()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.catchError)(error => this.handleError(error, messageGroup)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.map)(response => {
  ...
  getRawProductByEndpoint(messageGroup, endpoint, silentlyHandleError = false) {
    ...
    return this.cacheService.get(endpoint).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.catchError)(error => silentlyHandleError ? this.handleErrorSilent(error, messageGroup) : this.handleError(error, messageGroup)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.mergeMap)(response => {
  ...
  rawProductsFromEndpoints$(messageGroup, endpoints, silentlyHandleError = false) {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_12__.forkJoin)((0,lodash_es__WEBPACK_IMPORTED_MODULE_13__["default"])(endpoints, endpoint => this.getRawProductByEndpoint(messageGroup, endpoint, silentlyHandleError))).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.map)(omapiResponses => omapiResponses.filter(omapiResponse => omapiResponse !== undefined)));
  }
  ...
  addConstituentsToOmapiResponse(rawOmapiResponse, messageGroup) {
    if (rawOmapiResponse?.product && rawOmapiResponse.product.characteristics && rawOmapiResponse.product.characteristics.constituents) {
      return this.resolveConstituents(rawOmapiResponse.product.characteristics.constituents, messageGroup).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.map)(response => {
      ...
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_14__.of)(rawOmapiResponse);
    }
  }
  getOmapiProductUrl(omapiId) {
    return this.configService.getConfig(_telenet_ng_lib_config__WEBPACK_IMPORTED_MODULE_4__.ConfigConstants.OMAPI_URL) + '/public/product/' + omapiId;
  }
  doGet(messageGroup, endpoint) {
    ...
    return this.cacheService.get(endpoint).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.catchError)(error => this.handleError(error, messageGroup)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.map)(response => {
      return this.omapiProductMapper.toModel(response);
    }));
  }
  resolveConstituents(constituents, messageGroup) {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_12__.forkJoin)((0,lodash_es__WEBPACK_IMPORTED_MODULE_13__["default"])(constituents, constituent => this.resolveConstituent(constituent, messageGroup)));
  }
  resolveConstituent(constituent, messageGroup) {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_12__.forkJoin)({
      specurl: (0,rxjs__WEBPACK_IMPORTED_MODULE_14__.of)(constituent.specurl),
      type: (0,rxjs__WEBPACK_IMPORTED_MODULE_14__.of)(constituent.type),
  ...
  handleError(error, messageGroup) {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_15__.throwError)(() => this.FETCH_ERROR_PREFIX + messageGroup);
  }
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  handleErrorSilent(error, messageGroup) {
    ...
    this.log.logError(this.FETCH_ERROR_PREFIX + messageGroup, error);
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_14__.of)(undefined);
  }
  static ɵfac = function OmapiProductService_Factory(t) {
    return new (t || OmapiProductService)(_angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient), _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵinject"](_telenet_ng_lib_page__WEBPACK_IMPORTED_MODULE_2__.UrlService), _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵinject"](_telenet_ng_lib_message__WEBPACK_IMPORTED_MODULE_3__.MessageService), _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵinject"](_mappers_omapi_product_mapper__WEBPACK_IMPORTED_MODULE_0__.OmapiProductMapper), _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵinject"](_cache_omapi_cache_service__WEBPACK_IMPORTED_MODULE_5__.OmapiCacheService), _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵinject"](_telenet_ng_lib_config__WEBPACK_IMPORTED_MODULE_4__.ConfigService));
  };
  static ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineInjectable"]({

(self["webpackChunkfleet_mfe"] = self["webpackChunkfleet_mfe"] || []).push([["node_modules_ngrx_effects_fesm2022_ngrx-effects_mjs-_56480"],{
...
/* harmony export */   concatLatestFrom: () => (/* reexport safe */ _ngrx_operators__WEBPACK_IMPORTED_MODULE_2__.concatLatestFrom),
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ 19923);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs/operators */ 99593);
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! rxjs/operators */ 54899);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! rxjs/operators */ 72607);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! rxjs/operators */ 81355);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! rxjs/operators */ 63076);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! rxjs/operators */ 81527);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! rxjs/operators */ 39877);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! rxjs/operators */ 17474);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 33829);
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/store */ 48986);
/* harmony import */ var _ngrx_operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ngrx/operators */ 92666);
...
function mergeEffects(sourceInstance, globalErrorHandler, effectsErrorHandler) {
  ...
  const observables$ = getSourceMetadata(sourceInstance).map(({
    ...
    if (dispatch === false) {
      return effectAction$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.ignoreElements)());
    }
    const materialized$ = effectAction$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.materialize)());
    return materialized$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(notification => ({
  ...
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_6__.merge)(...observables$);
}
const MAX_NUMBER_OF_RETRY_ATTEMPTS = 10;
function defaultEffectsErrorHandler(observable$, errorHandler, retryAttemptLeft = MAX_NUMBER_OF_RETRY_ATTEMPTS) {
  return observable$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.catchError)(error => {
...
class Actions extends rxjs__WEBPACK_IMPORTED_MODULE_8__.Observable {
  constructor(source) {
    super();
    if (source) {
      this.source = source;
  ...
  static #_ = this.ɵfac = function Actions_Factory(t) {
    return new (t || Actions)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_1__.ScannedActionsSubject));
  };
  /** @nocollapse */
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](Actions, [{
    ...
    decorators: [{
      ...
      args: [_ngrx_store__WEBPACK_IMPORTED_MODULE_1__.ScannedActionsSubject]
    }]
  }], null);
})();
/**
...
function ofType(...allowedTypes) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.filter)(action => allowedTypes.some(typeOrActionCreator => {
...
const rootEffectsInit = (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_1__.createAction)(ROOT_EFFECTS_INIT);
...
class EffectSources extends rxjs__WEBPACK_IMPORTED_MODULE_10__.Subject {
   ...
   */
  toActions() {
    return this.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.groupBy)(effectsInstance => isClassInstance(effectsInstance) ? getSourceForInstance(effectsInstance) : effectsInstance), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.mergeMap)(source$ => {
      return source$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.groupBy)(effectsInstance));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.mergeMap)(source$ => {
      const effect$ = source$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.exhaustMap)(sourceInstance => {
        return resolveEffectSource(this.errorHandler, this.effectsErrorHandler)(sourceInstance);
      }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(output => {
        reportInvalidActions(output, this.errorHandler);
        return output.notification;
      }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.filter)(notification => notification.kind === 'N' && notification.value != null), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.dematerialize)());
      // start the stream with an INIT action
      // do this only for the first Effect instance
      const init$ = source$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_15__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.filter)(isOnInitEffects), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(instance => instance.ngrxOnInitEffects()));
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_6__.merge)(effect$, init$);
    }));
  }
  /** @nocollapse */
...
class EffectsRunner {
  ...
  static #_ = this.ɵfac = function EffectsRunner_Factory(t) {
    return new (t || EffectsRunner)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](EffectSources), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_1__.Store));
  };
  /** @nocollapse */
  static #_2 = this.ɵprov = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
    token: EffectsRunner,
...
class EffectsRootModule {
  ...
  static #_ = this.ɵfac = function EffectsRootModule_Factory(t) {
    return new (t || EffectsRootModule)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](EffectSources), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](EffectsRunner), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_1__.Store), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_ROOT_EFFECTS_INSTANCES), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_1__.StoreRootModule, 8), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_1__.StoreFeatureModule, 8), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_ROOT_EFFECTS_GUARD, 8));
  };
  /** @nocollapse */
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EffectsRootModule, [{
    ...
    type: _ngrx_store__WEBPACK_IMPORTED_MODULE_1__.StoreRootModule,
    decorators: [{
      type: _angular_core__WEBPACK_IMPORTED_MODULE_0__.Optional
    }]
  }, {
    type: _ngrx_store__WEBPACK_IMPORTED_MODULE_1__.StoreFeatureModule,
    decorators: [{
      type: _angular_core__WEBPACK_IMPORTED_MODULE_0__.Optional
    }]
  }, {
...
configOrProject, errorFn) {
  const {
    ...
    error: errorFn,
    operator: rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.concatMap,
    complete: undefined,
    unsubscribe: undefined
  } : {
    ...configOrProject,
    operator: configOrProject.operator || rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.concatMap
  };
  return source => (0,rxjs__WEBPACK_IMPORTED_MODULE_17__.defer)(() => {
    const subject = new rxjs__WEBPACK_IMPORTED_MODULE_10__.Subject();
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_6__.merge)(source.pipe(operator((input, index) => (0,rxjs__WEBPACK_IMPORTED_MODULE_17__.defer)(() => {
      let completed = false;
      let errored = false;
      let projectedCount = 0;
      return project(input, index).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.materialize)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(notification => {
      ...
      }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.filter)(n => n != null), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.dematerialize)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.finalize)(() => {
...
function provideEffects(...effects) {
  ...
  return (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.makeEnvironmentProviders)([effectsClasses, {
    ...
    multi: true,
    useValue: () => {
      (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__.ROOT_STORE_PROVIDER);
      (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__.FEATURE_STATE_PROVIDER, {
        optional: true
      });
      ...
      if (shouldInitEffects) {
        const store = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__.Store);
...
//# sourceMappingURL=node_modules_ngrx_effects_fesm2022_ngrx-effects_mjs-_56480.js.map
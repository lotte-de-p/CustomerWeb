(self["webpackChunkfleet_mfe"] = self["webpackChunkfleet_mfe"] || []).push([["libs_shared_page_src_index_ts-_25ef1"],{
...
/* harmony export */ });
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs */ 55400);
/* harmony import */ var _constants_contexthub_constant__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../constants/contexthub.constant */ 35515);
...
/* harmony import */ var udl__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! udl */ 95597);
...
let ContextHubGenericStoreService = class ContextHubGenericStoreService {
  ...
  contextHubSubject = new rxjs__WEBPACK_IMPORTED_MODULE_4__.ReplaySubject(1);
  ...
  getStoreData() {
    ...
    if (store) {
      ...
      store.eventing.once(_constants_contexthub_constant__WEBPACK_IMPORTED_MODULE_0__.ContexthubConstants.EVENT_STORE_READY, () => {
  ...
  onStoreDataLoaded(storeDataObj) {
    if (this.contextHubSubject) {
      ...
      this.contextHubSubject = new rxjs__WEBPACK_IMPORTED_MODULE_4__.ReplaySubject(1);
      this.isGetDataCallInvoked = false;
    }
  }
  registerAngularService() {
    if (!this.window[_constants_contexthub_constant__WEBPACK_IMPORTED_MODULE_0__.ContexthubConstants.ANGULAR_STORE_SERVICE_REF]) {
      this.window[_constants_contexthub_constant__WEBPACK_IMPORTED_MODULE_0__.ContexthubConstants.ANGULAR_STORE_SERVICE_REF] = {};
    }
    const angularStoreServiceRef = this.window[_constants_contexthub_constant__WEBPACK_IMPORTED_MODULE_0__.ContexthubConstants.ANGULAR_STORE_SERVICE_REF];
  ...
  getStore() {
    const contextHub = this.window[_constants_contexthub_constant__WEBPACK_IMPORTED_MODULE_0__.ContexthubConstants.CONTEXTHUB];
  ...
  registerStoreEventHook() {
    ...
    this.sendDataLayerEventOnStoreEvent(store, this.STORE_DATA_LOADED_CALL_LABEL, udl__WEBPACK_IMPORTED_MODULE_3__.DirectCallLabelEnum.STORE_DATA_LOADED);
  }
  ...
  sendDataLayerStoreEvent(eventName, directCallLabel, store) {
    const eventInfoData = this.dataLayerService.createEventInfo(eventName, _telenet_ng_lib_datalayer__WEBPACK_IMPORTED_MODULE_2__.EventTypeEnum.EVENT_TYPE_CH_STORE);
    const category = this.dataLayerService.createCategory(_telenet_ng_lib_datalayer__WEBPACK_IMPORTED_MODULE_2__.EventCategoryEnum.PRIMARY_CATEGORY_GENERAL);
    const attributes = {
...
ContextHubGenericStoreService = __decorate([__param(1, (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.Inject)('Window')), __metadata("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_1__.NgZone, Window, _telenet_ng_lib_datalayer__WEBPACK_IMPORTED_MODULE_2__.DataLayerService, Object])], ContextHubGenericStoreService);
...
/* harmony import */ var _page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../page */ 25406);
...
class TelenetTranslateLoader {
  window;
  pathCategorisationService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_page__WEBPACK_IMPORTED_MODULE_1__.PathCategorisationService);
...
class AbstractBaseComponent {
  unsubscribe$ = new rxjs__WEBPACK_IMPORTED_MODULE_1__.Subject();
  onDestroy() {
    // onDestroy
  }
  ngOnDestroy() {
  ...
  obs(obs) {
    return obs.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.takeUntil)(this.unsubscribe$));
  }
...
/* harmony export */ });
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ 56231);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 33829);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_angular_core__WEBPACK_IMPORTED_MODULE_0__);
...
class JsonUrlService {
  ...
  compress(object) {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(this.libng.compress(object));
  }
  decompress(compressedString) {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(this.libng.decompress(compressedString));
  }
  static ɵfac = function JsonUrlService_Factory(t) {
    return new (t || JsonUrlService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"]('Window'));
  };
  static ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
...
let LoaderComponent = class LoaderComponent {
  ...
  ngAfterViewInit() {
    if (this.loaderObj) {
      ...
      this.loaderService.loadingStatus.pipe((0,_ngneat_until_destroy__WEBPACK_IMPORTED_MODULE_4__.untilDestroyed)(this), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(loaderData => loaderData.isAPIExecutionInProgress)).subscribe(isAPIExecutionInProgress => {
  ...
  static ɵfac = function LoaderComponent_Factory(t) {
    return new (t || LoaderComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_services_loader_service__WEBPACK_IMPORTED_MODULE_0__.LoaderService), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_ngx_translate_core__WEBPACK_IMPORTED_MODULE_1__.TranslateService), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_path_categorisation_path_categorisation_service__WEBPACK_IMPORTED_MODULE_2__.PathCategorisationService), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"]('Window'));
  };
...
LoaderComponent = __decorate([(0,_ngneat_until_destroy__WEBPACK_IMPORTED_MODULE_4__.UntilDestroy)(), __metadata("design:paramtypes", [_services_loader_service__WEBPACK_IMPORTED_MODULE_0__.LoaderService, _ngx_translate_core__WEBPACK_IMPORTED_MODULE_1__.TranslateService, _path_categorisation_path_categorisation_service__WEBPACK_IMPORTED_MODULE_2__.PathCategorisationService, Window])], LoaderComponent);
...
/* harmony import */ var _loaderData_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../loaderData.model */ 86092);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ 33829);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_angular_core__WEBPACK_IMPORTED_MODULE_1__);
...
class LoaderService {
  ...
  loadingStatus = new rxjs__WEBPACK_IMPORTED_MODULE_2__.BehaviorSubject(new _loaderData_model__WEBPACK_IMPORTED_MODULE_0__.LoaderData(false));
  start() {
    const _loaderData = new _loaderData_model__WEBPACK_IMPORTED_MODULE_0__.LoaderData(true);
    this.loadingStatus.next(_loaderData);
  }
  stop() {
    const _loaderData = new _loaderData_model__WEBPACK_IMPORTED_MODULE_0__.LoaderData(false);
    this.loadingStatus.next(_loaderData);
  }
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rxjs/operators */ 13738);
...
class ModuleFederatedDebugInfoService {
  ...
  sharedLibraries$ = this.sharedLibrariesBs$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(value => !!value));
  ...
  load() {
    this.isDebug$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(isDebug => isDebug), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.mergeMap)(() => this.sharedLibraries$), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.tap)(sharedLibraries => console.debug('SHARED_LIBRARIES', sharedLibraries)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.take)(1)).subscribe();
  }
...
/* harmony import */ var lodash_es__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! lodash-es */ 87386);
/* harmony import */ var lodash_es__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! lodash-es */ 87248);
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rxjs */ 64148);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 33829);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_angular_core__WEBPACK_IMPORTED_MODULE_3__);
...
class UrlService {
  ...
  getUrlWithParams(url, params) {
    const keyValues = (0,lodash_es__WEBPACK_IMPORTED_MODULE_4__["default"])(params, param => {
  ...
  redirectTo(url) {
    ...
    if (promiseArray?.length === 0) {
      ...
      (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.forkJoin)(promiseArray).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_6__.timeout)(5000) // timeout after 5 seconds
      ).subscribe({
        next: () => {
          this.window.location.href = url;
        },
  ...
  getRequestParameterOrDefault(key, defaultValue) {
    return (0,lodash_es__WEBPACK_IMPORTED_MODULE_7__["default"])(this.getRequestParameters(), function (_paramValue, paramKey) {
  ...
  getHashParameters() {
    if (this.window && this.window.location && this.window.location.hash) {
      ...
      if (hash !== '') {
        ...
        return (0,lodash_es__WEBPACK_IMPORTED_MODULE_8__["default"])((0,lodash_es__WEBPACK_IMPORTED_MODULE_4__["default"])(pairs, pair => {
  ...
  static ɵfac = function UrlService_Factory(t) {
    return new (t || UrlService)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"]('Window'), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"](_telenet_ng_lib_datalayer__WEBPACK_IMPORTED_MODULE_2__.DataLayerService), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"](_client_browser_type_client_browser_type_service__WEBPACK_IMPORTED_MODULE_0__.ClientBrowserTypeService));
  };
...
//# sourceMappingURL=libs_shared_page_src_index_ts-_25ef1.js.map
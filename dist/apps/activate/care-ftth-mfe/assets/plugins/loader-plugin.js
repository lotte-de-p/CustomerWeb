            ...
            return (function (t) {
              ...
              (function () {
                var t,
                  ...
                  i = e.length;
                for (t = 0; t < i; t += 1) l[e[t]] = Math[e[t]];
              })(),
              ...
              function P(t, e) {
                var i = A(255 * t[0], 255 * t[1], 255 * t[2]);
                return (i[1] += e), i[1] > 1 ? (i[1] = 1) : i[1] <= 0 && (i[1] = 0), _(i[0], i[1], i[2]);
              }
              function D(t, e) {
                var i = A(255 * t[0], 255 * t[1], 255 * t[2]);
                return (i[2] += e), i[2] > 1 ? (i[2] = 1) : i[2] < 0 && (i[2] = 0), _(i[0], i[1], i[2]);
              }
              function E(t, e) {
                var i = A(255 * t[0], 255 * t[1], 255 * t[2]);
                return (i[0] += e / 360), i[0] > 1 ? (i[0] -= 1) : i[0] < 0 && (i[0] += 1), _(i[0], i[1], i[2]);
              }
              function S() {}
              !(function () {
                var t,
                ...
                (S.prototype = {
                  triggerEvent: function (t, e) {
                    if (this._cbs[t]) for (var i = this._cbs[t].length, s = 0; s < i; s += 1) this._cbs[t][s](e);
                  },
              ...
              var I,
                ...
                V = (function () {
                  ...
                  function f(t, e, i, s, a, r, n, o, h, l, p, m, d, f, c, u) {
                    return (
                      (this.props[0] = t),
                      (this.props[1] = e),
                      (this.props[2] = i),
                  ...
                  function u(t, e, i, s, a, r, n, o, h, l, p, m, d, f, c, u) {
                    var g = this.props;
                    if (
                      1 === t &&
                      0 === e &&
                    ...
                    return (
                      ...
                      (g[8] = D * t + E * a + S * h + C * d),
                      (g[9] = D * e + E * r + S * l + C * f),
                      (g[10] = D * i + E * n + S * p + C * c),
                      (g[11] = D * s + E * o + S * m + C * u),
                      (g[12] = F * t + w * a + T * h + M * d),
                      (g[13] = F * e + w * r + T * l + M * f),
                      (g[14] = F * i + w * n + T * p + M * c),
                      (g[15] = F * s + w * o + T * m + M * u),
                      (this._identityCalculated = !1),
                      this
                    );
                  }
 ...
 */ !(function (t, e) {
                ...
                function n(t) {
                  var e,
                    ...
                    r = (s.i = s.j = 0),
                    n = (s.S = []);
                  for (i || (t = [i++]); a < 256; ) n[a] = a++;
                  for (a = 0; a < 256; a++) (n[a] = n[(r = 255 & (r + t[a % i] + (e = n[a])))]), (n[r] = e);
                  s.g = function (t) {
                    for (var e, i = 0, a = s.i, r = s.j, n = s.S; t--; )
                      (e = n[(a = 255 & (a + 1))]),
                        (i = 256 * i + n[255 & ((n[a] = n[(r = 255 & (r + e))]) + (n[r] = e))]);
                    return (s.i = a), (s.j = r), i;
                  };
                }
                function o(t, e) {
                ...
                function h(t, e) {
                  for (var i, s = t + '', a = 0; a < s.length; )
                    e[255 & a] = 255 & ((i ^= 19 * e[255 & a]) + s.charCodeAt(a++));
                  return l(e);
                }
                function l(t) {
                  return String.fromCharCode.apply(0, t);
                }
                (e.seedrandom = function (p, m, d) {
                  var f = [],
                    c = h(
                      (function t(e, i) {
                        var s,
                          ...
                          : null === p
                            ? (function () {
                                try {
                                  ...
                                  var s = i.navigator,
                                    a = s && s.plugins;
                                  return [+new Date(), i, a, i.screen, l(t)];
                                }
                              })()
                            : p,
                        3
                    ...
                    u = new n(f),
                    g = function () {
                      for (var t = u.g(6), e = s, i = 0; t < a; ) (t = 256 * (t + i)), (e *= 256), (i = u.g(1));
                      for (; t >= r; ) (t /= 2), (e /= 2), (i >>>= 1);
                      return (t + i) / e;
                    };
                  return (
                    ...
                    )(g, c, 'global' in m ? m.global : this == e, m.state)
                  );
                }),
                  h(e.random(), t);
              })([], l);
                  ...
                  (h.prototype = {
                    get: function (t) {
                      ...
                      return (
                        ...
                        e === i && s === a ? t : 0 === t ? 0 : 1 === t ? 1 : n(this._getTForX(t), i, a)
                      );
                    },
                    ...
                    _getTForX: function (t) {
                      for (
                        var e = this._p[0], i = this._p[2], s = this._mSampleValues, a = 0, r = 1;
                        10 !== r && s[r] <= t;
                        ++r
                      )
                        a += 0.1;
                      var h = a + ((t - s[--r]) / (s[r + 1] - s[r])) * 0.1,
                        l = o(h, e, i);
                      return l >= 0.001
                        ? (function (t, e, i, s) {
                            for (var a = 0; a < 4; ++a) {
              ...
              !(function () {
                for (var e = 0, i = ['ms', 'moz', 'webkit', 'o'], s = 0; s < i.length && !t.requestAnimationFrame; ++s)
              ...
              var z = (function () {
                    ...
                    for (h = i.length, a = 0; a < f; a += 1) {
                      for (m = a / (f - 1), d = 0, o = 0; o < h; o += 1)
                        (l =
                          ...
                          r(m, 3) * e[o]),
                          (u[o] = l),
                          null !== g[o] && (d += r(u[o] - g[o], 2)),
                          (g[o] = u[o]);
                      d && (c += d = n(d)), (y.percents[a] = m), (y.lengths[a] = c);
                    }
                      ...
                      function (t, i, o, l) {
                        ...
                        if (!h[m]) {
                          ...
                          2 === t.length &&
                            ...
                            e(t[0], t[1], i[0], i[1], i[0] + l[0], i[1] + l[1]) &&
                            (x = 2);
                          var _ = new s(x);
                          for (c = o.length, d = 0; d < x; d += 1) {
                            for (v = F(c), g = d / (x - 1), y = 0, f = 0; f < c; f += 1)
                              (u =
                                r(1 - g, 3) * t[f] +
                                3 * r(1 - g, 2) * g * (t[f] + o[f]) +
                                3 * (1 - g) * r(g, 2) * (i[f] + l[f]) +
                                r(g, 3) * i[f]),
                                (v[f] = u),
                                null !== b && (y += r(v[f] - b[f], 2));
                            (k += y = n(y)), (_.points[d] = new a(y, v)), (b = v);
                          }
                          (_.segmentLength = k), (h[m] = _);
                        }
                        return h[m];
                      });
                  function m(t, e) {
                    ...
                    for (var l = s[r] > n ? -1 : 1, p = !0; p; )
                      if (
                        (s[r] <= n && s[r + 1] > n ? ((h = (n - s[r]) / (s[r + 1] - s[r])), (p = !1)) : (r += l),
                        r < 0 || r >= a - 1)
                      ) {
                        if (r === a - 1) return i[r];
                        p = !1;
                  ...
                  return {
                    getSegmentsLength: function (t) {
                      ...
                      return (
                        a && h && ((l[e] = i(r[e], r[0], n[e], o[0])), (p += l[e].addedLength)), (s.totalLength = p), s
                      );
                    },
                    getNewSegment: function (e, i, s, a, r, n, o) {
                      r < 0 ? (r = 0) : r > 1 && (r = 1);
                      var h,
                        l = m(r, o),
                        p = m((n = n > 1 ? 1 : n), o),
                        ...
                        T = p * p * p;
                      for (h = 0; h < f; h += 1)
                        (d[4 * h] = t.round(1e3 * (g * e[h] + y * s[h] + v * a[h] + x * i[h])) / 1e3),
                          (d[4 * h + 1] = t.round(1e3 * (k * e[h] + b * s[h] + _ * a[h] + A * i[h])) / 1e3),
                          (d[4 * h + 2] = t.round(1e3 * (P * e[h] + D * s[h] + E * a[h] + S * i[h])) / 1e3),
                          (d[4 * h + 3] = t.round(1e3 * (C * e[h] + F * s[h] + w * a[h] + T * i[h])) / 1e3);
                      return d;
                    },
                    ...
                    pointOnLine3D: function (i, s, a, r, n, o, h, l, p) {
                      ...
                      var m,
                        ...
                        f = t.sqrt(t.pow(h - i, 2) + t.pow(l - s, 2) + t.pow(p - a, 2)),
                        c = t.sqrt(t.pow(h - r, 2) + t.pow(l - n, 2) + t.pow(p - o, 2));
                      return (
                        (m = d > f ? (d > c ? d - f - c : c - f - d) : c > f ? c - f - d : f - d - c) > -1e-4 &&
                        m < 1e-4
                      );
                    },
                  };
                ...
                G = (function () {
                        ...
                        if (((o.completed = !0), o.tt && (a[h - 1].td = o.tt), o.hasMask)) {
                          ...
                          for (p = u.length, l = 0; l < p; l += 1)
                            if (u[l].pt.k.i) s(u[l].pt.k);
                              ...
                              for (d = u[l].pt.k.length, m = 0; m < d; m += 1)
                                u[l].pt.k[m].s && s(u[l].pt.k[m].s[0]), u[l].pt.k[m].e && s(u[l].pt.k[m].e[0]);
                        }
                        0 === o.ty
                          ? ((o.layers = e(o.refId, r)), t(o.layers, r, n))
                          : 4 === o.ty
                            ? i(o.shapes)
                            : 5 === o.ty && (0 !== (f = o).t.a.length || 'm' in f.t.p || (f.singleShape = !0));
                      }
                  }
                  function e(t, e) {
                      ...
                      if ('sh' === t[e].ty)
                        if (t[e].ks.k.i) s(t[e].ks.k);
                          ...
                          for (r = t[e].ks.k.length, a = 0; a < r; a += 1)
                            t[e].ks.k[a].s && s(t[e].ks.k[a].s[0]), t[e].ks.k[a].e && s(t[e].ks.k[a].e[0]);
                  ...
                  function a(t, e) {
                    ...
                    return (
                      t[0] > i[0] ||
                      (!(i[0] > t[0]) && (t[1] > i[1] || (!(i[1] > t[1]) && (t[2] > i[2] || (!(i[2] > t[2]) && null)))))
                    );
                  }
                  var r,
                    n = (function () {
                      ...
                      function e(t) {
                        var e,
                          ...
                          a = t.length;
                        for (e = 0; e < a; e += 1)
                          5 === t[e].ty && ((i = t[e]), (s = void 0), (s = i.t.d), (i.t.d = { k: [{ s: s, t: 0 }] }));
                      }
                      return function (i) {
                          ...
                          for (e = 0; e < l; e += 1)
                            if (t.chars[e].data && t.chars[e].data.shapes)
                              for (n = (h = t.chars[e].data.shapes[0].it).length, i = 0; i < n; i += 1)
                                (o = h[i].ks.k).__converted || (s(h[i].ks.k), (o.__converted = !0));
                        }
                      }),
                    h = (function () {
                      var t = [4, 1, 9];
              ...
              function N(t) {
                for (
                  var e = t.fStyle ? t.fStyle.split(' ') : [], i = 'normal', s = 'normal', a = e.length, r = 0;
                  r < a;
                  r += 1
                )
              ...
              var j = (function () {
                  ...
                  function s(t, e) {
                    ...
                    return (
                      ...
                      (i.textContent = '1'),
                      e.fClass
                        ? ((i.style.fontFamily = 'inherit'), i.setAttribute('class', e.fClass))
                        : (i.style.fontFamily = e.fFamily),
                      t.appendChild(i),
                      (T('canvas').getContext('2d').font = e.fWeight + ' ' + e.fStyle + ' 100px ' + e.fFamily),
                      i
                    );
                  }
                  e = e.concat([
                    ...
                    (a.prototype = {
                      ...
                      addFonts: function (t, e) {
                        if (t) {
                          ...
                          for (a = 0; a < n; a += 1) {
                            ...
                            if (
                              ((r[a].loaded = !1),
                              (r[a].monoCase = i(r[a].fFamily, 'monospace')),
                              (r[a].sansCase = i(r[a].fFamily, 'sans-serif')),
                              r[a].fPath)
                            ) {
                              if ('p' === r[a].fOrigin || 3 === r[a].origin) {
                                if (
                                  ...
                                  var m = T('style');
                                  m.setAttribute('f-forigin', r[a].fOrigin),
                                    m.setAttribute('f-origin', r[a].origin),
                                    m.setAttribute('f-family', r[a].fFamily),
                                    (m.type = 'text/css'),
                                    (m.innerText =
                                ...
                                for (
                                  ...
                                  -1 !== h[l].href.indexOf(r[a].fPath) && (p = !1);
                                if (p) {
                                  var d = T('link');
                                  d.setAttribute('f-forigin', r[a].fOrigin),
                                    d.setAttribute('f-origin', r[a].origin),
                                    (d.type = 'text/css'),
                                    (d.rel = 'stylesheet'),
                                    (d.href = r[a].fPath),
                                ...
                                for (
                                  ...
                                  r[a].fPath === h[l].src && (p = !1);
                                if (p) {
                                  var f = T('link');
                                  f.setAttribute('f-forigin', r[a].fOrigin),
                                    f.setAttribute('f-origin', r[a].origin),
                                    f.setAttribute('rel', 'stylesheet'),
                                    f.setAttribute('href', r[a].fPath),
                                    e.appendChild(f);
                                }
                              }
                            } else (r[a].loaded = !0), (o -= 1);
                            (r[a].helper = s(e, r[a])), (r[a].cache = {}), this.fonts.push(r[a]);
                          }
                      ...
                      getCharData: function (e, i, s) {
                        for (var a = 0, r = this.chars.length; a < r; ) {
                          if (this.chars[a].ch === e && this.chars[a].style === i && this.chars[a].fFamily === s)
                            return this.chars[a];
                          a += 1;
                        }
                        return (
                ...
                q = (function () {
                  ...
                  function e(t, e) {
                    var s,
                      a = this.offsetTime;
                    'multidimensional' === this.propType && (s = C('float32', this.pv.length));
                    for (
                      var r, n, o, h, l, p, d, f, c = e.lastIndex, u = c, g = this.keyframes.length - 1, y = !0;
                      y;
                    ...
                    var v,
                      ...
                      G = r.t - a;
                    if (r.to) {
                      r.bezierData || (r.bezierData = z.buildBezierData(r.s, n.s || r.e, r.to, r.ti));
                      var N = r.bezierData;
                      if (t >= O || t < G) {
                        var j = t >= O ? N.points.length - 1 : 0;
                        for (h = N.points[j].point.length, o = 0; o < h; o += 1) s[o] = N.points[j].point[o];
                      } else {
                        r.__fnct
                          ? (f = r.__fnct)
                          : ((f = B.getBezierEasing(r.o.x, r.o.y, r.i.x, r.i.y, r.n).get), (r.__fnct = f)),
                          (l = f((t - G) / (O - G)));
                        var q,
                          W = N.segmentLength * l,
                          H = e.lastFrame < t && e._lastKeyframeIndex === u ? e._lastAddedLength : 0;
                        for (
                          ...
                          if (((H += N.points[d].partialLength), 0 === W || 0 === l || d === N.points.length - 1)) {
                            for (h = N.points[d].point.length, o = 0; o < h; o += 1) s[o] = N.points[d].point[o];
                            break;
                          }
                          if (W >= H && W < H + N.points[d + 1].partialLength) {
                            for (
                              q = (W - H) / N.points[d + 1].partialLength, h = N.points[d].point.length, o = 0;
                              o < h;
                              o += 1
                            )
                              s[o] = N.points[d].point[o] + (N.points[d + 1].point[o] - N.points[d].point[o]) * q;
                            break;
                          }
                          d < p - 1 ? (d += 1) : (y = !1);
                        }
                        (e._lastPoint = d),
                          (e._lastAddedLength = H - N.points[d].partialLength),
                              ...
                              : t < G
                                ...
                                : (r.o.x.constructor === Array
                                    ? (r.__fnct || (r.__fnct = []),
                                      r.__fnct[u]
                                        ? (f = r.__fnct[u])
                                        : ((Y = void 0 === r.o.x[u] ? r.o.x[0] : r.o.x[u]),
                                          (J = void 0 === r.o.y[u] ? r.o.y[0] : r.o.y[u]),
                                          (X = void 0 === r.i.x[u] ? r.i.x[0] : r.i.x[u]),
                                          (K = void 0 === r.i.y[u] ? r.i.y[0] : r.i.y[u]),
                                          (f = B.getBezierEasing(Y, J, X, K).get),
                                          (r.__fnct[u] = f)))
                                    : r.__fnct
                                      ? (f = r.__fnct)
                                      : ((Y = r.o.x),
                                  ...
                                  (l = f((t - G) / (O - G))))),
                            (v = n.s || r.e),
                            (U = 1 === r.h ? r.s[u] : r.s[u] + (v[u] - r.s[u]) * l),
                            'multidimensional' === this.propType ? (s[u] = U) : (s = U);
                    }
                  ...
                  function a(e) {
                    ...
                    if ('unidimensional' === this.propType)
                      ...
                      for (var s = 0, a = this.v.length; s < a; )
                        (i = e[s] * this.mult),
                          t(this.v[s] - i) > 1e-5 && ((this.v[s] = i), (this._mdf = !0)),
                          (s += 1);
                  }
                  function r() {
                  ...
                  function h(t, e, i, s) {
                    ...
                    var h = e.k.length;
                    for (
                      this.v = C('float32', h), this.pv = C('float32', h), this.vel = C('float32', h), o = 0;
                      o < h;
                      o += 1
                    )
                  ...
                  function p(t, i, o, h) {
                    ...
                    for (l = 0; l < c - 1; l += 1)
                      i.k[l].to &&
                        ...
                        ((2 === p.length &&
                          (p[0] !== m[0] || p[1] !== m[1]) &&
                          z.pointOnLine2D(p[0], p[1], m[0], m[1], p[0] + d[0], p[1] + d[1]) &&
                          z.pointOnLine2D(p[0], p[1], m[0], m[1], m[0] + f[0], m[1] + f[1])) ||
                          (3 === p.length &&
                        ...
                        p[0] === m[0] &&
                          ...
                          0 === f[0] &&
                          0 === f[1] &&
                          (2 === p.length || (p[2] === m[2] && 0 === d[2] && 0 === f[2])) &&
                          ((i.k[l].to = null), (i.k[l].ti = null)));
                    (this.effectsSequence = [s.bind(this)]),
                      (this.data = i),
                      (this.keyframes = i.k),
                    ...
                    for (this.v = C('float32', u), this.pv = C('float32', u), l = 0; l < u; l += 1)
                      (this.v[l] = -999999), (this.pv[l] = -999999);
                    (this._caching = { lastFrame: -999999, lastIndex: 0, value: C('float32', u) }),
                      (this.addEffect = n);
                  }
                  return {
                    getProp: function (t, e, i, s, a) {
                      var r;
                      if (e.k.length)
                        if ('number' == typeof e.k[0]) r = new h(t, e, s, a);
                        else
                          switch (i) {
                            case 0:
                              r = new l(t, e, s, a);
                ...
                W = (function () {
                  ...
                  function e(t, e, i) {
                    if (
                      ...
                      e.p && e.p.s
                        ? ((this.px = q.getProp(t, e.p.x, 0, 0, this)),
                          (this.py = q.getProp(t, e.p.y, 0, 0, this)),
                          e.p.z && (this.pz = q.getProp(t, e.p.z, 0, 0, this)))
                        : (this.p = q.getProp(t, e.p || { k: [0, 0, 0] }, 1, 0, this)),
                      e.rx)
                    ) {
                      if (
                        ((this.rx = q.getProp(t, e.rx, 0, m, this)),
                        (this.ry = q.getProp(t, e.ry, 0, m, this)),
                        (this.rz = q.getProp(t, e.rz, 0, m, this)),
                        e.or.k[0].ti)
                      ) {
                        var s,
                          a = e.or.k.length;
                      ...
                      (this.or = q.getProp(t, e.or, 1, m, this)), (this.or.sh = !0);
                    } else this.r = q.getProp(t, e.r || { k: 0 }, 0, m, this);
                    e.sk && ((this.sk = q.getProp(t, e.sk, 0, m, this)), (this.sa = q.getProp(t, e.sa, 0, m, this))),
                      (this.a = q.getProp(t, e.a || { k: [0, 0, 0] }, 1, 0, this)),
                      (this.s = q.getProp(t, e.s || { k: [100, 100, 100] }, 1, 0.01, this)),
                      e.o ? (this.o = q.getProp(t, e.o, 0, 0.01, t)) : (this.o = { _mdf: !1, v: 1 }),
                      (this._isDirty = !0),
                  ...
                  return (
                              ...
                              if (
                                ...
                                r._caching.lastFrame + r.offsetTime <= r.keyframes[0].t
                                  ...
                                  : r._caching.lastFrame + r.offsetTime >= r.keyframes[r.keyframes.length - 1].t
                                    ? ((s[0] = r.getValueAtTime(r.keyframes[r.keyframes.length - 1].t / i, 0)),
                                      (s[1] = n.getValueAtTime(n.keyframes[n.keyframes.length - 1].t / i, 0)),
                                      (a[0] = r.getValueAtTime((r.keyframes[r.keyframes.length - 1].t - 0.01) / i, 0)),
                                      (a[1] = n.getValueAtTime((n.keyframes[n.keyframes.length - 1].t - 0.01) / i, 0)))
                                    : ((s = [r.pv, n.pv]),
                    ...
                    (e.prototype._addDynamicProperty = M.prototype.addDynamicProperty),
                    {
              ...
              function H() {
                (this.c = !1),
                  (this._length = 0),
                  (this._maxLength = 8),
                  (this.v = F(this._maxLength)),
                  (this.o = F(this._maxLength)),
                  (this.i = F(this._maxLength));
              }
              (H.prototype.setPathData = function (t, e) {
                (this.c = t), this.setLength(e);
                for (var i = 0; i < e; )
                  (this.v[i] = yt.newElement()), (this.o[i] = yt.newElement()), (this.i[i] = yt.newElement()), (i += 1);
              }),
                (H.prototype.setLength = function (t) {
                  for (; this._maxLength < t; ) this.doubleArrayLength();
                  this._length = t;
                }),
                (H.prototype.doubleArrayLength = function () {
                  (this.v = this.v.concat(F(this._maxLength))),
                    (this.i = this.i.concat(F(this._maxLength))),
                    (this.o = this.o.concat(F(this._maxLength))),
                    (this._maxLength *= 2);
                }),
                (H.prototype.setXYAt = function (t, e, i, s, a) {
                  var r;
                  switch (
                  ...
                  (!r[s] || (r[s] && !a)) && (r[s] = yt.newElement()), (r[s][0] = t), (r[s][1] = e);
                }),
                (H.prototype.setTripleAt = function (t, e, i, s, a, r, n, o) {
              ...
              var Y,
                ...
                X = (function () {
                  function t(t, e, i) {
                    var s,
                      ...
                      d = i.lastIndex,
                      f = this.keyframes;
                    if (t < f[0].t - this.offsetTime) (s = f[0].s[0]), (r = !0), (d = 0);
                    else if (t >= f[f.length - 1].t - this.offsetTime)
                      (s = f[f.length - 1].s ? f[f.length - 1].s[0] : f[f.length - 2].e[0]), (r = !0);
                    else {
                      for (
                        var c, u, g = d, y = f.length - 1, v = !0;
                        v && ((c = f[g]), !((u = f[g + 1]).t - this.offsetTime > t));
                      ...
                      if (((d = g), !(r = 1 === c.h))) {
                        if (t >= u.t - this.offsetTime) p = 1;
                          ...
                          c.__fnct
                            ? (x = c.__fnct)
                            : ((x = B.getBezierEasing(c.o.x, c.o.y, c.i.x, c.i.y).get), (c.__fnct = x)),
                            (p = x((t - (c.t - this.offsetTime)) / (u.t - this.offsetTime - (c.t - this.offsetTime))));
                        }
                        a = u.s ? u.s[0] : c.e[0];
                      }
                      s = c.s[0];
                    ...
                    for (h = e._length, l = s.i[0].length, i.lastIndex = d, n = 0; n < h; n += 1)
                      for (o = 0; o < l; o += 1)
                        (m = r ? s.i[n][o] : s.i[n][o] + (a.i[n][o] - s.i[n][o]) * p),
                          (e.i[n][o] = m),
                          (m = r ? s.o[n][o] : s.o[n][o] + (a.o[n][o] - s.o[n][o]) * p),
                          (e.o[n][o] = m),
                          (m = r ? s.v[n][o] : s.v[n][o] + (a.v[n][o] - s.v[n][o]) * p),
                          (e.v[n][o] = m);
                  }
                  function e() {
                    var t = this.comp.renderedFrame - this.offsetTime,
                    ...
                    return (
                      (-999999 !== s && ((s < e && t < e) || (s > i && t > i))) ||
                        ((this._caching.lastIndex = s < t ? this._caching.lastIndex : 0),
                  ...
                  var l = (function () {
                      function t(t, e) {
                        (this.v = vt.newElement()),
                          ...
                          (this.p = q.getProp(t, e.p, 1, 0, this)),
                          (this.s = q.getProp(t, e.s, 1, 0, this)),
                        ...
                        (t.prototype = {
                          ...
                          convertEllToPath: function () {
                            ...
                            (r.v[0][0] = t),
                              ...
                              (r.v[3][0] = a ? t - i : t + i),
                              (r.v[3][1] = e),
                              (r.i[0][0] = a ? t - 0.5519 * i : t + 0.5519 * i),
                              (r.i[0][1] = e - s),
                              (r.i[1][0] = a ? t + i : t - i),
                              (r.i[1][1] = e - 0.5519 * s),
                              (r.i[2][0] = a ? t + 0.5519 * i : t - 0.5519 * i),
                              (r.i[2][1] = e + s),
                              (r.i[3][0] = a ? t - i : t + i),
                              (r.i[3][1] = e + 0.5519 * s),
                              (r.o[0][0] = a ? t + 0.5519 * i : t - 0.5519 * i),
                              (r.o[0][1] = e - s),
                              (r.o[1][0] = a ? t + i : t - i),
                              (r.o[1][1] = e + 0.5519 * s),
                              (r.o[2][0] = a ? t - 0.5519 * i : t + 0.5519 * i),
                              (r.o[2][1] = e + s),
                              (r.o[3][0] = a ? t - i : t + i),
                              (r.o[3][1] = e - 0.5519 * s);
                          },
                    ...
                    p = (function () {
                      function t(t, e) {
                        (this.v = vt.newElement()),
                          ...
                          this.initDynamicPropertyContainer(t),
                          1 === e.sy
                            ? ((this.ir = q.getProp(t, e.ir, 0, 0, this)),
                              (this.is = q.getProp(t, e.is, 0, 0.01, this)),
                              (this.convertToPath = this.convertStarToPath))
                            : (this.convertToPath = this.convertPolygonToPath),
                          (this.pt = q.getProp(t, e.pt, 0, 0, this)),
                          (this.p = q.getProp(t, e.p, 1, 0, this)),
                          (this.r = q.getProp(t, e.r, 0, m, this)),
                          (this.or = q.getProp(t, e.or, 0, 0, this)),
                          (this.os = q.getProp(t, e.os, 0, 0.01, this)),
                          (this.localShapeCollection = xt.newShapeCollection()),
                          this.localShapeCollection.addShape(this.v),
                          (this.paths = this.localShapeCollection),
                    ...
                    d = (function () {
                      function t(t, e) {
                        (this.v = vt.newElement()),
                          ...
                          (this.p = q.getProp(t, e.p, 1, 0, this)),
                          (this.s = q.getProp(t, e.s, 1, 0, this)),
                          (this.r = q.getProp(t, e.r, 0, 0, this)),
                      ...
                      return (
                        (t.prototype = {
                          convertRectToPath: function () {
                            ...
                            (this.v._length = 0),
                              2 === this.d || 1 === this.d
                                ? (this.v.setTripleAt(t + i, e - s + a, t + i, e - s + a, t + i, e - s + r, 0, !0),
                                  this.v.setTripleAt(t + i, e + s - a, t + i, e + s - r, t + i, e + s - a, 1, !0),
                                  0 !== a
                                    ? (this.v.setTripleAt(t + i - a, e + s, t + i - a, e + s, t + i - r, e + s, 2, !0),
                                      ...
                                      this.v.setTripleAt(t + i - a, e - s, t + i - r, e - s, t + i - a, e - s, 7, !0))
                                    : (this.v.setTripleAt(t - i, e + s, t - i + r, e + s, t - i, e + s, 2),
                                      this.v.setTripleAt(t - i, e - s, t - i, e - s + r, t - i, e - s, 3)))
                                : (this.v.setTripleAt(t + i, e - s + a, t + i, e - s + r, t + i, e - s + a, 0, !0),
                                  0 !== a
                                    ? (this.v.setTripleAt(t + i - a, e - s, t + i - a, e - s, t + i - r, e - s, 1, !0),
                                      ...
                                      this.v.setTripleAt(t + i, e + s - a, t + i, e + s - a, t + i, e + s - r, 7, !0))
                                    : (this.v.setTripleAt(t - i, e - s, t - i + r, e - s, t - i, e - s, 1, !0),
                    ...
                    f = {
                      getShapeProp: function (t, e, i) {
                        ...
                        return (
                          3 === i || 4 === i
                            ? (s = (3 === i ? e.pt : e.ks).k.length ? new o(t, e, i) : new r(t, e, i))
                            : 5 === i
                              ? (s = new d(t, e))
                              : 6 === i
                                ? (s = new l(t, e))
                ...
                K =
                  ((J = {}),
                  ((Y = {}).registerModifier = function (t, e) {
                    J[t] || (J[t] = e);
                  }),
                  (Y.getModifier = function (t, e, i) {
                    return new J[t](e, i);
                  }),
                  Y);
              function U() {}
              ...
              function tt() {}
              function et() {
                (this._length = 0), (this._maxLength = 4), (this.shapes = F(this._maxLength));
              }
              function it(t, e, i, s) {
                var a;
                (this.elem = t),
                  (this.frameId = -1),
                  (this.dataProps = F(e.length)),
                  (this.renderer = i),
                  (this.k = !1),
                  (this.dashStr = ''),
                  (this.dashArray = C('float32', e.length ? e.length - 1 : 0)),
                  (this.dashoffset = C('float32', 1)),
                  this.initDynamicPropertyContainer(s);
                var r,
                  n = e.length || 0;
                for (a = 0; a < n; a += 1)
                  (r = q.getProp(t, e[a].v, 0, 0, this)),
                    (this.k = r.k || this.k),
              ...
              function st(t, e, i) {
                ...
                (this.o = C('float32', s)),
                  ...
                  (this.prop = q.getProp(t, e.k, 1, null, this)),
                  (this.k = this.prop.k),
                  this.getValue(!0);
              }
              (U.prototype.initModifierProperties = function () {}),
                ...
                (U.prototype.addShape = function (t) {
                  if (!this.closed) {
                    ...
                    var e = { shape: t.sh, data: t, localShapeCollection: xt.newShapeCollection() };
                ...
                (Z.prototype.initModifierProperties = function (t, e) {
                  (this.s = q.getProp(t, e.s, 0, 0.01, this)),
                    (this.e = q.getProp(t, e.e, 0, 0.01, this)),
                    (this.o = q.getProp(t, e.o, 0, 0, this)),
                    (this.sValue = 0),
                    (this.eValue = 0),
                ...
                (Z.prototype.addShapeToModifier = function (t) {
                  t.pathsData = [];
                }),
                (Z.prototype.calculateShapeEdges = function (t, e, i, s, a) {
                  var r = [];
                  e <= 1
                    ? r.push({ s: t, e: e })
                    : t >= 1
                  ...
                  for (n = 0; n < l; n += 1) {
                    ...
                    (o = r[n]).e * a < s ||
                      ...
                      (m = o.e * a >= s + i ? 1 : (o.e * a - s) / i),
                      h.push([p, m]));
                  }
                  return h.length || h.push([0, 0]), h;
                }),
                (Z.prototype.releasePathsData = function (t) {
                  var e,
                    i = t.length;
                  ...
                  if (i === e)
                    ...
                    for (a = 0; a < d; a += 1)
                      if ((c = this.shapes[a]).shape._mdf || this._mdf || t || 2 === this.m) {
                        if (((h = (s = c.shape.paths)._length), (m = 0), !c.shape._mdf && c.pathsData.length))
                          m = c.totalShapeLength;
                        else {
                          for (l = this.releasePathsData(c.pathsData), o = 0; o < h; o += 1)
                            (p = z.getSegmentsLength(s.shapes[o])), l.push(p), (m += p.totalLength);
                          (c.totalShapeLength = m), (c.pathsData = l);
                        }
                        (f += m), (c.shape._mdf = !0);
                      ...
                      if ((c = this.shapes[a]).shape._mdf) {
                        for (
                          (u = c.localShapeCollection).releaseShapes(),
                            2 === this.m && d > 1
                              ? ((y = this.calculateShapeEdges(e, i, c.totalShapeLength, k, f)),
                                (k += c.totalShapeLength))
                              : (y = [[v, x]]),
                            h = y.length,
                            o = 0;
                          o < h;
                          ...
                          (v = y[o][0]),
                            ...
                            (g.length = 0),
                            x <= 1
                              ? g.push({ s: c.totalShapeLength * v, e: c.totalShapeLength * x })
                              : v >= 1
                                ? g.push({ s: c.totalShapeLength * (v - 1), e: c.totalShapeLength * (x - 1) })
                                : (g.push({ s: c.totalShapeLength * v, e: c.totalShapeLength }),
                                  g.push({ s: 0, e: c.totalShapeLength * (x - 1) }));
                          var b = this.addShapes(c, g[0]);
                          if (g[0].s !== g[0].e) {
                            if (g.length > 1)
                              if (c.shape.paths.shapes[c.shape.paths._length - 1].c) {
                                var _ = b.pop();
                                this.addPaths(b, u), (b = this.addShapes(c, g[1], _));
                              } else this.addPaths(b, u), (b = this.addShapes(c, g[1]));
                            this.addPaths(b, u);
                          }
                        }
                        c.shape.paths = u;
                ...
                (Z.prototype.addShapes = function (t, e, i) {
                  var s,
                    ...
                    g = !0;
                  for (
                    i ? ((o = i._length), (p = i._length)) : ((i = vt.newElement()), (o = 0), (p = 0)),
                      u.push(i),
                      s = 0;
                    s < f;
                    s += 1
                  ) {
                    for (h = m[s].lengths, i.c = d[s].c, r = d[s].c ? h.length : h.length + 1, a = 1; a < r; a += 1)
                      if (c + (n = h[a - 1]).addedLength < e.s) (c += n.addedLength), (i.c = !1);
                        ...
                        e.s <= c && e.e >= c + n.addedLength
                          ? (this.addSegment(d[s].v[a - 1], d[s].o[a - 1], d[s].i[a], d[s].v[a], i, o, g), (g = !1))
                          : ((l = z.getNewSegment(
                              d[s].v[a - 1],
                              d[s].v[a],
                              d[s].o[a - 1],
                    ...
                    if (d[s].c && h.length) {
                      if (((n = h[a - 1]), c <= e.e)) {
                        ...
                        e.s <= c && e.e >= c + y
                          ? (this.addSegment(d[s].v[a - 1], d[s].o[a - 1], d[s].i[0], d[s].v[0], i, o, g), (g = !1))
                          : ((l = z.getNewSegment(
                              d[s].v[a - 1],
                              d[s].v[0],
                              d[s].o[a - 1],
                    ...
                    if (
                      ...
                      break;
                    s < f - 1 && ((i = vt.newElement()), (g = !0), u.push(i), (o = 0));
                  }
                  return u;
                }),
                K.registerModifier('tm', Z),
                R([U], Q),
                (Q.prototype.initModifierProperties = function (t, e) {
                  (this.getValue = this.processKeys),
                    (this.rd = q.getProp(t, e.r, 0, null, this)),
                    (this._isAnimated = !!this.rd.effectsSequence.length);
                }),
                (Q.prototype.processPath = function (t, e) {
                  var i,
                    s = vt.newElement();
                  s.c = t.c;
                  var a,
                  ...
                  for (i = 0; i < g; i += 1)
                    (a = t.v[i]),
                      ...
                      a[0] === n[0] && a[1] === n[1] && a[0] === r[0] && a[1] === r[1]
                        ...
                        : (s.setTripleAt(t.v[i][0], t.v[i][1], t.o[i][0], t.o[i][1], t.i[i][0], t.i[i][1], y),
                          (y += 1));
                  return s;
                }),
                ...
                K.registerModifier('rd', Q),
                R([U], $),
                ($.prototype.initModifierProperties = function (t, e) {
                  (this.getValue = this.processKeys),
                    (this.amount = q.getProp(t, e.a, 0, null, this)),
                ...
                ($.prototype.processPath = function (t, e) {
                  ...
                  for (d.c = t.c, r = 0; r < a; r += 1)
                    (n = t.v[r][0] + (s[0] - t.v[r][0]) * i),
                      ...
                      (m = t.i[r][1] + (s[1] - t.i[r][1]) * -i),
                      d.setTripleAt(n, o, h, l, p, m, r);
                  return d;
                }),
                ...
                K.registerModifier('pb', $),
                R([U], tt),
                (tt.prototype.initModifierProperties = function (t, e) {
                  (this.getValue = this.processKeys),
                    (this.c = q.getProp(t, e.c, 0, null, this)),
                    (this.o = q.getProp(t, e.o, 0, null, this)),
                    (this.tr = W.getTransformProperty(t, e.tr, this)),
                    (this.so = q.getProp(t, e.tr.so, 0, 0.01, this)),
                    (this.eo = q.getProp(t, e.tr.eo, 0, 0.01, this)),
                    (this.data = e),
                    this.dynamicProperties.length || this.getValue(!0),
                ...
                (tt.prototype.processShapes = function (t) {
                  ...
                  if (this._mdf || t) {
                    ...
                    for (r = 0, s = 0; s <= this._groups.length - 1; s += 1) {
                      if (
                        ((o = r < h), (this._groups[s]._render = o), this.changeGroupRender(this._groups[s].it, o), !o)
                      ) {
                    ...
                    if (d > 0) {
                      for (; k < c; )
                        this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, 1, !1), (k += 1);
                      f && (this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, f, !1), (k += f));
                    } else if (d < 0) {
                      for (; k > c; )
                        this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, 1, !0), (k -= 1);
                      f && (this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, -f, !0), (k -= f));
                    }
                    for (
                      ...
                      if (
                        ((x = (i = (e = this.elemsData[s].it)[e.length - 1].transform.mProps.v.props).length),
                ...
                K.registerModifier('rp', tt),
                (et.prototype.addShape = function (t) {
                  this._length === this._maxLength &&
                    ((this.shapes = this.shapes.concat(F(this._maxLength))), (this._maxLength *= 2)),
                    (this.shapes[this._length] = t),
                    (this._length += 1);
                }),
                (et.prototype.releaseShapes = function () {
                  var t;
                  for (t = 0; t < this._length; t += 1) vt.release(this.shapes[t]);
                  this._length = 0;
                }),
                  ...
                  return (
                    (o.prototype = {
                      ...
                      createImageData: function (e) {
                        var i = s(e, this.assetsPath, this.path),
                          r = w('image');
                        a ? this.testImageLoaded(r) : r.addEventListener('load', this._imageLoaded, !1),
                          r.addEventListener(
                            'error',
                            function () {
              ...
              function pt(t, e, i) {
                (this._isFirstFrame = !0),
                  ...
                  (this._renderType = e),
                  (this._elem = i),
                  (this._animatorsData = F(this._textData.a.length)),
                  (this._pathData = {}),
              ...
              function mt(t, e, i) {
                ...
                (this.a = {
                  ...
                  (this.s = ct.getTextSelectorProp(t, e.s, i)),
                  (this.s.t = e.s.t);
              }
              function dt(t, e, i, s, a, r) {
                (this.o = t),
                  (this.sw = e),
                  (this.sc = i),
                  (this.fc = s),
              ...
              (pt.prototype.searchProperties = function () {
                var t,
                  e,
                  i = this._textData.a.length,
                  s = q.getProp;
                for (t = 0; t < i; t += 1)
                  (e = this._textData.a[t]), (this._animatorsData[t] = new mt(this._elem, e, this));
                ...
                (pt.prototype.getMeasures = function (t, e) {
                  if (
                      ...
                      if (
                        ...
                        for (
                          n.tLength < Math.abs(o) && (o = -Math.abs(o) % n.tLength),
                            m = (c = u[(d = u.length - 1)].points).length - 1;
                          o < 0;

                        )
                          (o += c[m].partialLength), (m -= 1) < 0 && (m = (c = u[(d -= 1)].points).length - 1);
                      (f = (c = u[d].points)[m - 1]), (g = (h = c[m]).partialLength);
                    }
                    (r = w.length), (i = 0), (s = 0);
                    var I,
                      L,
                    ...
                    if (2 === t.j || 1 === t.j) {
                      ...
                      for (a = 0; a < r; a += 1)
                        if (w[a].n) {
                          for (nt && (nt += ot); lt < a; ) (w[lt].animatorJustifyOffset = nt), (lt += 1);
                          (nt = 0), (pt = !0);
                        } else {
                          for (L = 0; L < V; L += 1)
                            (I = _[L].a).t.propType &&
                              (pt && 2 === t.j && (ot += I.t.v * ht),
                              (R = _[L].s.getMult(w[a].anIndexes[L], A.a[L].s.totalChars)).length
                                ? (nt += I.t.v * R[0] * ht)
                                : (nt += I.t.v * R * ht));
                          pt = !1;
                        }
                    ...
                    for (a = 0; a < r; a += 1) {
                      if ((S.reset(), (W = 1), w[a].n))
                        (i = 0),
                          ...
                          (G = !1),
                          this._hasMaskedPath &&
                            ((m = it), (f = (c = u[(d = et)].points)[m - 1]), (g = (h = c[m]).partialLength), (l = 0)),
                          (at = ''),
                          (Z = ''),
                          (K = ''),
                          (Q = ''),
                        ...
                        if (this._hasMaskedPath) {
                          ...
                          $ !== w[a].ind && (w[$] && (o += w[$].extra), (o += w[a].an / 2), ($ = w[a].ind)),
                            (o += b[0] * w[a].an * 0.005);
                          var mt = 0;
                          for (L = 0; L < V; L += 1)
                            (I = _[L].a).p.propType &&
                          ...
                          for (p = !0; p; )
                            l + g >= o + mt || !c
                              ? ((v = (o + mt - l) / h.partialLength),
                                (j = f.point[0] + (h.point[0] - f.point[0]) * v),
                                (q = f.point[1] + (h.point[1] - f.point[1]) * v),
                                S.translate(-b[0] * w[a].an * 0.005, -b[1] * O * 0.01),
                                (p = !1))
                              : c &&
                                ((l += h.partialLength),
                                (m += 1) >= c.length &&
                                ...
                                c && ((f = h), (g = (h = c[m]).partialLength)));
                          (N = w[a].an / 2 - w[a].add), S.translate(-N, 0, 0);
                        } else
                          (N = w[a].an / 2 - w[a].add),
                            S.translate(-N, 0, 0),
                            S.translate(-b[0] * w[a].an * 0.005, -b[1] * O * 0.01, 0);
                        for (L = 0; L < V; L += 1)
                          (I = _[L].a).t.propType &&
                            ((R = _[L].s.getMult(w[a].anIndexes[L], A.a[L].s.totalChars)),
                            (0 === i && 0 === t.j) ||
                              (this._hasMaskedPath
                                ? R.length
                                  ? (o += I.t.v * R[0])
                        ...
                        for (
                          ...
                          (I = _[L].a).a.propType &&
                            ((R = _[L].s.getMult(w[a].anIndexes[L], A.a[L].s.totalChars)).length
                              ? S.translate(-I.a.v[0] * R[0], -I.a.v[1] * R[1], I.a.v[2] * R[2])
                              : S.translate(-I.a.v[0] * R, -I.a.v[1] * R, I.a.v[2] * R));
                        for (L = 0; L < V; L += 1)
                          (I = _[L].a).s.propType &&
                            ((R = _[L].s.getMult(w[a].anIndexes[L], A.a[L].s.totalChars)).length
                              ? S.scale(1 + (I.s.v[0] - 1) * R[0], 1 + (I.s.v[1] - 1) * R[1], 1)
                              : S.scale(1 + (I.s.v[0] - 1) * R, 1 + (I.s.v[1] - 1) * R, 1));
                        for (L = 0; L < V; L += 1) {
                          if (
                            ((I = _[L].a),
                            (R = _[L].s.getMult(w[a].anIndexes[L], A.a[L].s.totalChars)),
                            I.sk.propType &&
                              (R.length
                                ? S.skewFromAxis(-I.sk.v * R[0], I.sa.v * R[1])
                                : S.skewFromAxis(-I.sk.v * R, I.sa.v * R)),
                            I.r.propType && (R.length ? S.rotateZ(-I.r.v * R[2]) : S.rotateZ(-I.r.v * R)),
                            I.ry.propType && (R.length ? S.rotateY(I.ry.v * R[1]) : S.rotateY(I.ry.v * R)),
                            I.rx.propType && (R.length ? S.rotateX(I.rx.v * R[0]) : S.rotateX(I.rx.v * R)),
                            I.o.propType && (R.length ? (W += (I.o.v * R[0] - W) * R[0]) : (W += (I.o.v * R - W) * R)),
                            t.strokeWidthAnim && I.sw.propType && (R.length ? (Y += I.sw.v * R[0]) : (Y += I.sw.v * R)),
                            t.strokeColorAnim && I.sc.propType)
                          )
                            for (X = 0; X < 3; X += 1)
                              R.length ? (H[X] += (I.sc.v[X] - H[X]) * R[0]) : (H[X] += (I.sc.v[X] - H[X]) * R);
                          if (t.fillColorAnim && t.fc) {
                            if (I.fc.propType)
                              for (X = 0; X < 3; X += 1)
                                R.length ? (J[X] += (I.fc.v[X] - J[X]) * R[0]) : (J[X] += (I.fc.v[X] - J[X]) * R);
                            I.fh.propType && (J = R.length ? E(J, I.fh.v * R[0]) : E(J, I.fh.v * R)),
                              I.fs.propType && (J = R.length ? P(J, I.fs.v * R[0]) : P(J, I.fs.v * R)),
                              I.fb.propType && (J = R.length ? D(J, I.fb.v * R[0]) : D(J, I.fb.v * R));
                          }
                        }
                        for (L = 0; L < V; L += 1)
                          (I = _[L].a).p.propType &&
                            ...
                            this._hasMaskedPath
                              ? R.length
                                ? S.translate(0, I.p.v[1] * R[0], -I.p.v[2] * R[1])
                                : S.translate(0, I.p.v[1] * R, -I.p.v[2] * R)
                              : R.length
                                ? S.translate(I.p.v[0] * R[0], I.p.v[1] * R[1], -I.p.v[2] * R[2])
                                : S.translate(I.p.v[0] * R, I.p.v[1] * R, -I.p.v[2] * R));
                        if (
                          (t.strokeWidthAnim && (K = Y < 0 ? 0 : Y),
                          t.strokeColorAnim &&
                            (U =
                              'rgb(' +
                              Math.round(255 * H[0]) +
                          ...
                          if ((S.translate(0, -t.ls), S.translate(0, b[1] * O * 0.01 + s, 0), A.p.p)) {
                            x = (h.point[1] - f.point[1]) / (h.point[0] - f.point[0]);
                            var ft = (180 * Math.atan(x)) / Math.PI;
                            h.point[0] < f.point[0] && (ft += 180), S.rotate((-ft * Math.PI) / 180);
                          }
                          S.translate(j, q, 0),
                            (o -= b[0] * w[a].an * 0.005),
                            w[a + 1] && $ !== w[a + 1].ind && ((o += w[a].an / 2), (o += 0.001 * t.tr * t.finalSize));
                        } else {
                          switch ((S.translate(i, s, 0), t.ps && S.translate(t.ps[0], t.ps[1] + t.ascent, 0), t.j)) {
                            case 1:
                              S.translate(
                                w[a].animatorJustifyOffset + t.justifyOffset + (t.boxWidth - t.lineWidths[w[a].line]),
                                0,
                                0
                              );
                              break;
                          ...
                          S.translate(0, -t.ls),
                            S.translate(N, 0, 0),
                            S.translate(b[0] * w[a].an * 0.005, b[1] * O * 0.01, 0),
                            (i += w[a].l + 0.001 * t.tr * t.finalSize);
                        }
                        'html' === C
                          ? (at = S.toCSS())
                          : 'svg' === C
                      ...
                      F <= a
                        ? ((B = new dt(Q, K, U, Z, at, rt)),
                          this.renderedLetters.push(B),
                          (F += 1),
                          (this.lettersChangedFlag = !0))
                        : ((B = this.renderedLetters[a]),
                          (this.lettersChangedFlag = B.update(Q, K, U, Z, at, rt) || this.lettersChangedFlag));
                    }
                  }
                }),
                ...
                (pt.prototype.mHelper = new V()),
                (pt.prototype.defaultPropsArray = []),
                R([M], pt),
                (dt.prototype.update = function (t, e, i, s, a, r) {
                  (this._mdf.o = !1),
                    (this._mdf.sw = !1),
                    (this._mdf.sc = !1),
                    (this._mdf.fc = !1),
                ...
                (ft.prototype.defaultBoxWidth = [0, 0]),
                (ft.prototype.copyData = function (t, e) {
                ...
                (ft.prototype.buildFinalText = function (t) {
                  for (var e, i = j.getCombinedCharacterCodes(), s = [], a = 0, r = t.length; a < r; )
                    (e = t.charCodeAt(a)),
                      -1 !== i.indexOf(e)
                        ? (s[s.length - 1] += t.charAt(a))
                        : e >= 55296 && e <= 56319 && (e = t.charCodeAt(a + 1)) >= 56320 && e <= 57343
                          ? (s.push(t.substr(a, 2)), (a += 1))
                          : s.push(t.charAt(a)),
                      (a += 1);
                  return s;
                }),
                (ft.prototype.completeTextData = function (t) {
                  ...
                  if (t.sz)
                    for (var P, D, E = !0, S = t.sz[0], C = t.sz[1]; E; ) {
                      (P = 0), (y = 0), (i = (D = this.buildFinalText(t.t)).length), (A = (t.tr / 1e3) * t.finalSize);
                      var F = -1;
                      for (e = 0; e < i; e += 1)
                        (_ = D[e].charCodeAt(0)),
                          (s = !1),
                          ' ' === D[e]
                            ? (F = e)
                            : (13 !== _ && 3 !== _) ||
                              ((y = 0), (s = !0), (P += t.finalLineHeight || 1.2 * t.finalSize)),
                          h.chars
                            ? ((o = h.getCharData(D[e], x.fStyle, x.fFamily)), (k = s ? 0 : (o.w * t.finalSize) / 100))
                            : (k = h.measureText(D[e], t.f, t.finalSize)),
                          y + k > S && ' ' !== D[e]
                            ? (-1 === F ? (i += 1) : (e = F),
                  ...
                  for (e = 0; e < i; e += 1)
                    if (
                      ...
                      13 === (_ = (w = t.finalText[e]).charCodeAt(0)) || 3 === _
                        ? ((T = 0), g.push(y), (v = y > v ? y : v), (y = -2 * A), (a = ''), (s = !0), (u += 1))
                        : (a = w),
                      h.chars
                        ? ((o = h.getCharData(w, x.fStyle, h.getFontByName(t.f).fFamily)),
                          (k = s ? 0 : (o.w * t.finalSize) / 100))
                        : (k = h.measureText(a, t.f, t.finalSize)),
                      ' ' === w ? (T += k + A) : ((y += k + A + T), (T = 0)),
                      p.push({ l: k, an: k, add: f, n: s, anIndexes: [], val: a, line: u, animatorJustifyOffset: 0 }),
                      2 == d)
                    ) {
                      if (((f += k), '' === a || ' ' === a || e === i - 1)) {
                        for (('' !== a && ' ' !== a) || (f -= k); c <= e; )
                          (p[c].an = f), (p[c].ind = m), (p[c].extra = k), (c += 1);
                        (m += 1), (f = 0);
                      }
                    } else if (3 == d) {
                      if (((f += k), '' === a || e === i - 1)) {
                        for ('' === a && (f -= k); c <= e; ) (p[c].an = f), (p[c].ind = m), (p[c].extra = k), (c += 1);
                        (f = 0), (m += 1);
                      }
                  ...
                  for (r = 0; r < n; r += 1) {
                    for (
                      (M = B[r]).a.sc && (t.strokeColorAnim = !0),
                    ...
                    if (1 === M.s.rn)
                      for (e = 0; e < i; e += 1)
                        z != (I = p[e]).anIndexes[r] &&
                          ((z = I.anIndexes[r]), (O = R.splice(Math.floor(Math.random() * R.length), 1)[0])),
                          (I.anIndexes[r] = O);
                  }
              ...
              var ct = (function () {
                  ...
                  function s(t, e) {
                    (this._currentTextLength = -1),
                      ...
                      (this.finalE = 0),
                      this.initDynamicPropertyContainer(t),
                      (this.s = q.getProp(t, e.s || { k: 0 }, 0, 0, this)),
                      (this.e = 'e' in e ? q.getProp(t, e.e, 0, 0, this) : { v: 100 }),
                      (this.o = q.getProp(t, e.o || { k: 0 }, 0, 0, this)),
                      (this.xe = q.getProp(t, e.xe || { k: 0 }, 0, 0, this)),
                      (this.ne = q.getProp(t, e.ne || { k: 0 }, 0, 0, this)),
                      (this.a = q.getProp(t, e.a, 0, 0.01, this)),
                  ...
                  return (
                    (s.prototype = {
                      getMult: function (s) {
                        ...
                        var h = B.getBezierEasing(a, r, n, o).get,
                          l = 0,
                          p = this.finalS,
                          m = this.finalE,
                          d = this.data.sh;
                        if (2 === d)
                          l = h((l = m === p ? (s >= m ? 1 : 0) : t(0, e(0.5 / (m - p) + (s - p) / (m - p), 1))));
                        else if (3 === d)
                          l = h((l = m === p ? (s >= m ? 0 : 1) : 1 - t(0, e(0.5 / (m - p) + (s - p) / (m - p), 1))));
                        else if (4 === d)
                          m === p
                            ? (l = 0)
                            : (l = t(0, e(0.5 / (m - p) + (s - p) / (m - p), 1))) < 0.5
                              ? (l *= 2)
                              : (l = 1 - 2 * (l - 0.5)),
                            (l = h(l));
                        else if (5 === d) {
                          ...
                          6 === d
                            ? (m === p
                                ? (l = 0)
                                : ((s = e(t(0, s + 0.5 - p), m - p)),
                                  (l = (1 + Math.cos(Math.PI + (2 * Math.PI * s) / (m - p))) / 2)),
                              (l = h(l)))
                            : (s >= i(p) && (l = t(0, e(s - p < 0 ? e(m, 1) - (p - s) : m - s, 1))), (l = h(l)));
                        return l * this.a.v;
                      },
                      getValue: function (t) {
                        this.iterateDynamicProperties(),
                ...
                ut = function (t, e, i) {
                  ...
                  return {
                    ...
                    release: function (t) {
                      s === a && ((r = gt.double(r)), (a *= 2)), i && i(t), (r[s] = t), (s += 1);
                    },
                  };
                },
                gt = {
                  double: function (t) {
                    return t.concat(F(t.length));
                  },
                },
                yt = ut(8, function () {
                  return C('float32', 2);
                ...
                vt = (function () {
                  ...
                  return (
                    (t.clone = function (e) {
                      ...
                      for (s.setLength(a), s.c = e.c, i = 0; i < a; i += 1)
                        s.setTripleAt(e.v[i][0], e.v[i][1], e.o[i][0], e.o[i][1], e.i[i][0], e.i[i][1], i);
                      return s;
                    }),
                    t
                  );
                ...
                xt = (function () {
                  var t = {
                      newShapeCollection: function () {
                        return e ? s[(e -= 1)] : new et();
                      },
                      release: function (t) {
                        var a,
                          r = t._length;
                        for (a = 0; a < r; a += 1) vt.release(t.shapes[a]);
                        (t._length = 0), e === i && ((s = gt.double(s)), (i *= 2)), (s[e] = t), (e += 1);
                      },
                    },
                    e = 0,
                    i = 4,
                ...
                kt = ut(
                  ...
                  function (t) {
                    var e,
                      i = t.lengths.length;
                    for (e = 0; e < i; e += 1) bt.release(t.lengths[e]);
                    t.lengths.length = 0;
                  }
                ),
                bt = ut(8, function () {
                  return { addedLength: 0, percents: C('float32', p), lengths: C('float32', p) };
                }),
                _t = (function () {
                  function t(t) {
              ...
              function Dt(t, e, s) {
                ...
                (this.viewData = F(o)), (this.solidPath = '');
                var h,
                  l,
                  p,
                  m,
                ...
                for (a = 0; a < o; a += 1)
                  if (
                    ((('a' !== c[a].mode && 'n' !== c[a].mode) || c[a].inv || 100 !== c[a].o.k || c[a].o.x) &&
                      ((v = 'mask'), (x = 'mask')),
                    ('s' !== c[a].mode && 'i' !== c[a].mode) || 0 !== u
                      ? (p = null)
                      : ((p = w('rect')).setAttribute('fill', '#ffffff'),
                    ...
                    (this.viewData[a] = {
                      op: q.getProp(this.element, c[a].o, 0, 0.01, this.element),
                      prop: X.getShapeProp(this.element, c[a], 3),
                      elem: r,
                      lastPath: '',
                    }),
                      n.appendChild(r);
                    ...
                    if (
                      ((u += 1),
                      r.setAttribute('fill', 's' === c[a].mode ? '#000000' : '#ffffff'),
                      r.setAttribute('clip-rule', 'nonzero'),
                      0 !== c[a].x.k
                        ? ((v = 'mask'),
                          (x = 'mask'),
                          (f = q.getProp(this.element, c[a].x, 0, null, this.element)),
                          (k = b()),
                          (m = w('filter')).setAttribute('id', k),
                          (d = w('feMorphology')).setAttribute('operator', 'erode'),
                          d.setAttribute('in', 'SourceGraphic'),
                          d.setAttribute('radius', '0'),
                          m.appendChild(d),
                          n.appendChild(m),
                          r.setAttribute('stroke', 's' === c[a].mode ? '#000000' : '#ffffff'))
                        : ((d = null), (f = null)),
                      (this.storedData[a] = {
                        elem: r,
                        x: f,
                      ...
                      l = g.length;
                      var _ = w('g');
                      for (h = 0; h < l; h += 1) _.appendChild(g[h]);
                      var A = w('mask');
                      A.setAttribute('mask-type', 'alpha'),
                        A.setAttribute('id', y + '_' + u),
                        A.appendChild(r),
                        n.appendChild(A),
                        _.setAttribute('mask', 'url(' + i + '#' + y + '_' + u + ')'),
                        (g.length = 0),
                        g.push(_);
                    } else g.push(r);
                ...
                for (this.maskElement = w(v), o = g.length, a = 0; a < o; a += 1) this.maskElement.appendChild(g[a]);
                u > 0 &&
                  (this.maskElement.setAttribute('id', y),
                  this.element.maskedElement.setAttribute(x, 'url(' + i + '#' + y + ')'),
              ...
              function Vt(t, e, i) {
                this.initDynamicPropertyContainer(t),
                  ...
                  (this.o = q.getProp(t, e.o, 0, 0.01, this)),
                  (this.w = q.getProp(t, e.w, 0, null, this)),
                  (this.d = new it(t, e.d || {}, 'svg', this)),
                  (this.c = q.getProp(t, e.c, 1, 255, this)),
                  (this.style = i),
              ...
              (At.prototype.checkLayers = function (t) {
                ...
                (At.prototype.buildElementParenting = function (t, e, i) {
                  for (var s = this.elements, a = this.layers, r = 0, n = a.length; r < n; )
                    a[r].ind == e &&
                      (s[r] && !0 !== s[r]
                        ? (i.push(s[r]),
                          s[r].setAsParent(),
                          void 0 !== a[r].parent ? this.buildElementParenting(t, a[r].parent, i) : t.setHierarchy(i))
                ...
                (At.prototype.setupGlobalData = function (t, e) {
                  (this.globalData.fontManager = new j()),
                ...
                R([At], Pt),
                (Pt.prototype.createNull = function (t) {
                ...
                (Pt.prototype.createComp = function (t) {
                ...
                (Pt.prototype.configAnimation = function (t) {
                  ...
                  s.setAttribute('id', r),
                    s.appendChild(a),
                    this.layerElement.setAttribute('clip-path', 'url(' + i + '#' + r + ')'),
                    e.appendChild(s),
                    (this.layers = t.layers),
                    (this.elements = F(t.layers.length));
                }),
                      ...
                      this.storedData[e].x.v < 0
                        ? ('erode' !== this.storedData[e].lastOperator &&
                            ...
                            this.storedData[e].elem.setAttribute(
                              'filter',
                              'url(' + i + '#' + this.storedData[e].filterId + ')'
                            )),
                ...
                (Ct.prototype = {
                  initTransform: function () {
                    (this.finalTransform = {
                      mProp: this.data.ks ? W.getTransformProperty(this, this.data.ks, this) : { o: 0 },
                      _matMdf: !1,
                      _opMdf: !1,
                      mat: new V(),
                    }),
                ...
                R([M], Vt),
                R([M], Bt),
                (Rt.prototype.initGradientData = function (t, e, i) {
                  (this.o = q.getProp(t, e.o, 0, 0.01, this)),
                    (this.s = q.getProp(t, e.s, 1, null, this)),
                    (this.e = q.getProp(t, e.e, 1, null, this)),
                    (this.h = q.getProp(t, e.h || { k: 0 }, 0, 0.01, this)),
                    (this.a = q.getProp(t, e.a || { k: 0 }, 0, m, this)),
                    (this.g = new st(t, e.g, this)),
                    (this.style = i),
                    (this.stops = []),
                ...
                (Rt.prototype.setGradientData = function (t, e) {
                  var s = b(),
                  ...
                  t.setAttribute('gf' === e.ty ? 'fill' : 'stroke', 'url(' + i + '#' + s + ')'),
                    (this.gf = a),
                    (this.cst = h);
                }),
                (Rt.prototype.setGradientOpacity = function (t, e) {
                  if (this.g._hasOpacity && !this.g._collapsable) {
                    ...
                    for (a = 4 * t.g.p; a < r; a += 2)
                      (s = w('stop')).setAttribute('stop-color', 'rgb(255,255,255)'), p.appendChild(s), m.push(s);
                    o.setAttribute('gf' === t.ty ? 'fill' : 'stroke', 'url(' + i + '#' + h + ')'),
                      (this.of = p),
                      (this.ms = n),
                      (this.ost = m),
                      (this.maskId = l),
              ...
              var Gt = (function () {
                ...
                function s(i, s, a) {
                  ...
                  for (p = 0; p < g; p += 1) {
                    if (((h = s.sh._mdf || a), s.styles[p].lvl < y)) {
                      for (d = e.reset(), c = y - s.styles[p].lvl, u = s.transformers.length - 1; !h && c > 0; )
                        (h = s.transformers[u].mProps._mdf || h), (c -= 1), (u -= 1);
                      if (h)
                        for (c = y - s.styles[p].lvl, u = s.transformers.length - 1; c > 0; )
                          (f = s.transformers[u].mProps.v.props),
                            d.transform(
                              f[0],
                              f[1],
                              f[2],
                    ...
                    if (((n = (m = s.sh.paths)._length), h)) {
                      for (o = '', r = 0; r < n; r += 1)
                        (l = m.shapes[r]) && l._length && (o += at(l, l._length, l.c, d));
                      s.caches[p] = o;
                    } else o = s.caches[p];
                ...
                function a(t, e, i) {
                  var s = e.style;
                  (e.c._mdf || i) &&
                    s.pElem.setAttribute('fill', 'rgb(' + o(e.c.v[0]) + ',' + o(e.c.v[1]) + ',' + o(e.c.v[2]) + ')'),
                ...
                function n(t, e, i) {
                  ...
                  if (e.s._mdf || i) {
                    ...
                    h.setAttribute(f, p[0]),
                      ...
                      l && !e.g._collapsable && (e.of.setAttribute(f, p[0]), e.of.setAttribute(c, p[1]));
                  }
                  if (e.g._cmdf || i) {
                    s = e.cst;
                    var u = e.g.c;
                  ...
                  if (1 === t.t)
                    ...
                    var y = Math.atan2(m[1] - p[1], m[0] - p[0]),
                      v = e.h.v;
                    ...
                    h.setAttribute('fx', k),
                      h.setAttribute('fy', b),
                      l && !e.g._collapsable && (e.of.setAttribute('fx', k), e.of.setAttribute('fy', b));
                  }
                }
                function h(t, e, i) {
                  var s = e.style,
                  ...
                  a &&
                    ...
                    e.c &&
                      ...
                      s.pElem.setAttribute(
                        'stroke',
                        'rgb(' + o(e.c.v[0]) + ',' + o(e.c.v[1]) + ',' + o(e.c.v[2]) + ')'
                      ),
              ...
              function Kt(t, e, i) {
                ...
                (this.audio = this.globalData.audioController.createAudio(s)),
                  ...
                  (this.tm = t.tm ? q.getProp(this, t.tm, 0, e.frameRate, this) : { _placeholder: !0 });
              }
              function Ut(t, e, i) {
                (this.layers = t.layers),
                  (this.supports3d = !0),
                  (this.completeLayers = !1),
                  (this.pendingElements = []),
                  (this.elements = this.layers ? F(this.layers.length) : []),
                  this.initElement(t, e, i),
                  (this.tm = t.tm ? q.getProp(this, t.tm, 0, e.frameRate, this) : { _placeholder: !0 });
              }
              function Zt(t, e, i) {
              ...
              (Nt.prototype = {
                ...
                (qt.prototype = {
                  ...
                  createContainerElements: function () {
                      ...
                      if (3 == this.data.td || 1 == this.data.td) {
                        ...
                        r.setAttribute('id', this.layerId),
                          ...
                          ot.maskType ||
                            ...
                            (s = w('g')).appendChild(this.layerElement),
                            (a = s),
                            r.appendChild(s),
                            s.setAttribute('filter', 'url(' + i + '#' + t + ')'));
                      } else if (2 == this.data.td) {
                        var n = w('mask');
                        n.setAttribute('id', this.layerId), n.setAttribute('mask-type', 'alpha');
                        var o = w('g');
                        n.appendChild(o), (t = b()), (e = ht.createFilter(t));
                        var h = w('feComponentTransfer');
                    ...
                    if (
                      ...
                      if (
                        ...
                        var c = w('g');
                        c.setAttribute('clip-path', 'url(' + i + '#' + f + ')'),
                      ...
                      } else this.layerElement.setAttribute('clip-path', 'url(' + i + '#' + f + ')');
                    }
                  ...
                  createRenderableComponents: function () {
                    (this.maskManager = new Dt(this.data, this, this.globalData)),
                      (this.renderableEffectsManager = new se(this));
                  },
                  setMatte: function (t) {
                    this.matteElement && this.matteElement.setAttribute('mask', 'url(' + i + '#' + t + ')');
                  },
                }),
                (Wt.prototype = {
                ...
                (Ht.prototype.initElement = function (t, e, i) {
                  (this.lettersChangedFlag = !0),
                    this.initFrame(),
                    this.initBaseData(t, e, i),
                    (this.textProperty = new ft(this, t.t, this.dynamicProperties)),
                    (this.textAnimator = new pt(t.t, this.renderType, this)),
                    this.initTransform(t, e, i),
                    this.initHierarchy(),
                    this.initRenderable(),
                    this.initRendererElement(),
                ...
                (Ht.prototype.createPathShape = function (t, e) {
                  var i,
                    s,
                    a = e.length,
                    r = '';
                  for (i = 0; i < a; i += 1) (s = e[i].ks.k), (r += at(s, s.i.length, !0, t));
                  return r;
                }),
                ...
                (Ht.prototype.applyTextPropertiesToMatrix = function (t, e, i, s, a) {
                ...
                (Ht.prototype.buildColor = function (t) {
                  return (
                    'rgb(' + Math.round(255 * t[0]) + ',' + Math.round(255 * t[1]) + ',' + Math.round(255 * t[2]) + ')'
                  );
                }),
                (Ht.prototype.emptyProp = new dt()),
                ...
                (Yt.prototype.renderInnerContent = function () {
                  var t,
                    e = this.layers.length;
                  for (t = 0; t < e; t += 1)
                    (this.completeLayers || this.elements[t]) && this.elements[t].renderFrame();
                }),
                (Yt.prototype.setElements = function (t) {
                  this.elements = t;
                }),
                (Yt.prototype.getElements = function () {
                  return this.elements;
                }),
                (Yt.prototype.destroyElements = function () {
                  var t,
                    e = this.layers.length;
                  for (t = 0; t < e; t += 1) this.elements[t] && this.elements[t].destroy();
                }),
                ...
                R([Nt, Ct, qt, Et, St, wt], Jt),
                (Jt.prototype.createContent = function () {
                ...
                R([Jt], Xt),
                (Xt.prototype.createContent = function () {
                  var t = w('rect');
                ...
                (Kt.prototype.setRate = function (t) {
                  this.audio.rate(t);
                }),
                (Kt.prototype.volume = function (t) {
                  this.audio.volume(t);
                }),
                ...
                (Kt.prototype.initExpressions = function () {}),
                R([Pt, Yt, qt], Ut),
                R([Nt, Ct, qt, Et, St, wt, Ht], Zt),
                ...
                (Zt.prototype.buildNewText = function () {
                  ...
                  (this.renderedLetters = F(i ? i.l.length : 0)),
                    i.fc
                  ...
                  if (!d || h || i.sz) {
                    ...
                    for (t = 0; t < e; t += 1)
                      (h && d && 0 !== t) ||
                        ((n = x > t ? this.textSpans[t] : w(h ? 'path' : 'text')),
                        x <= t &&
                        ...
                        d &&
                          (o[t].n && ((f = -g), (c += i.yOffset), (c += u ? 1 : 0), (u = !1)),
                          this.applyTextPropertiesToMatrix(i, p, o[t].line, f, c),
                          (f += o[t].l || 0),
                          (f += g)),
                        h
                          ? ((l = (y =
                              ...
                              ? y.shapes[0].it
                              : []),
                            d ? (m += this.createPathShape(p, l)) : n.setAttribute('d', this.createPathShape(p, l)))
                    ...
                    for (e = _.length, c = i.ps ? i.ps[1] + i.ascent : 0, t = 0; t < e; t += 1)
                      ((n = this.textSpans[t] || w('tspan')).textContent = _[t]),
                        n.setAttribute('x', 0),
                        n.setAttribute('y', c),
                        (n.style.display = 'inherit'),
                        k.appendChild(n),
                ...
                R([Nt, Ct, qt, Wt, Et, St, wt], Qt),
                (Qt.prototype.initSecondaryElement = function () {}),
                (Qt.prototype.identityMatrix = new V()),
                (Qt.prototype.buildExpressionInterface = function () {}),
                ...
                (Qt.prototype.createStyleElement = function (t, e) {
                  ...
                  return (
                    ...
                    t.bm && (r.style['mix-blend-mode'] = L(t.bm)),
                ...
                (Qt.prototype.createGroupElement = function (t) {
                  ...
                  return (
                    ...
                    t.bm && (e.gr.style['mix-blend-mode'] = L(t.bm)),
                    e
                  );
                }),
                (Qt.prototype.createTransformElement = function (t, e) {
                  var i = W.getTransformProperty(this, t, this),
                    s = new Lt(i, i.o, e);
                ...
                (Qt.prototype.createShapeElement = function (t, e, i) {
                  ...
                  var a = new It(e, i, X.getShapeProp(this, t, s, this));
                ...
                (Qt.prototype.addToAnimatedContents = function (t, e) {
                  ...
                  this.animatedContents.push({ fn: Gt.createRenderFunction(t), element: e, data: t });
                }),
                ...
                (Qt.prototype.searchShapes = function (t, e, i, s, a, r, n) {
                  var o,
                    h,
                    l,
                    p,
                  ...
                  for (o = c; o >= 0; o -= 1) {
                    if (
                      ...
                      this.searchShapes(t[o].it, e[o].it, e[o].prevViewData, e[o].gr, a + 1, f, n),
                        t[o]._render && s.appendChild(e[o].gr);
                    } else
                      'tr' === t[o].ty
                        ? (d || (e[o] = this.createTransformElement(t[o], s)), (p = e[o].transform), f.push(p))
                        : 'sh' === t[o].ty || 'rc' === t[o].ty || 'el' === t[o].ty || 'sr' === t[o].ty
                          ? (d || (e[o] = this.createShapeElement(t[o], f, a)), this.setElementStyles(e[o]))
                          : 'tm' === t[o].ty || 'rd' === t[o].ty || 'ms' === t[o].ty || 'pb' === t[o].ty
                            ? (d
                                ? ((m = e[o]).closed = !1)
                                : ((m = K.getModifier(t[o].ty)).init(this, t[o]),
                                  (e[o] = m),
                ...
                ($t.prototype.initialize = function () {
                  ...
                  for (
                    1 === this.filterManager.effectElements[1].p.v
                      ...
                      : (a = 1 + (s = this.filterManager.effectElements[0].p.v - 1)),
                      (e = w('g')).setAttribute('fill', 'none'),
                      e.setAttribute('stroke-linecap', 'round'),
                      e.setAttribute('stroke-dashoffset', 1);
                    s < a;
                    s += 1
                  )
                    (t = w('path')), e.appendChild(t), this.paths.push({ p: t, m: s });
                  if (3 === this.filterManager.effectElements[10].p.v) {
                    ...
                    var h = w('g');
                    for (h.setAttribute('mask', 'url(' + i + '#' + o + ')'); r[0]; ) h.appendChild(r[0]);
                ...
                ($t.prototype.renderFrame = function (t) {
                  ...
                  if (
                    ...
                    this.pathMasker.setAttribute(
                      'stroke',
                      'rgb(' + o(255 * c[0]) + ',' + o(255 * c[1]) + ',' + o(255 * c[2]) + ')'
                    );
                  }
                }),
                (te.prototype.createFeFunc = function (t, e) {
                  var i = w(t);
                  return i.setAttribute('type', 'table'), e.appendChild(i), i;
                }),
                (te.prototype.getTableValue = function (t, e, i, s, a) {
                  for (
                    var r,
                      n,
                      o = 0,
              ...
              function se() {}
              (ie.prototype.findSymbol = function (t) {
                for (var e = 0, i = ee.length; e < i; ) {
                  if (ee[e] === t) return ee[e];
                  e += 1;
                }
                return null;
              }),
                (ie.prototype.replaceInParent = function (t, e) {
                ...
                (ie.prototype.setElementAsMask = function (t, e) {
                  if (!this.findSymbol(e)) {
                    var i = b(),
                      s = w('mask');
                    s.setAttribute('id', e.layerId), s.setAttribute('mask-type', 'alpha'), ee.push(e);
                ...
                (ie.prototype.renderFrame = function () {
                  this.initialized || this.initialize();
                });
              var ae = (function () {
                  var e = {},
                  ...
                  function h(t) {
                    for (var e = 0, s = t.target; e < a; )
                      i[e].animation === s && (i.splice(e, 1), (e -= 1), (a -= 1), s.isPaused || m()), (e += 1);
                  }
                  function l(t, e) {
                    if (!t) return null;
                    for (var s = 0; s < a; ) {
                  ...
                  function f(e) {
                    ...
                    (s = e), r && !o ? t.requestAnimationFrame(f) : (n = !0);
                  }
                  function c(e) {
                    (s = e), t.requestAnimationFrame(f);
                  }
                  function u() {
                    !o && r && n && (t.requestAnimationFrame(c), (n = !1));
                  }
                  return (
                ...
                re = function () {
                  (this._cbs = []),
                    ...
                    (this.imagePreloader = new nt()),
                    (this.audioController = rt()),
                    (this.markers = []);
                };
              function ne() {
                this.effectElements = [];
              ...
              R([S], re),
                (re.prototype.setParams = function (t) {
                  ...
                  switch ((t.animType ? (e = t.animType) : t.renderer && (e = t.renderer), e)) {
                    case 'canvas':
                      ...
                      break;
                    case 'svg':
                      this.renderer = new Pt(this, t.rendererSettings);
                      break;
                    default:
                ...
                (re.prototype.includeLayers = function (t) {
                  ...
                  (this.animationData.__complete = !1),
                    G.completeData(this.animationData, this.renderer.globalData.fontManager),
                ...
                (re.prototype.goToAndStop = function (t, e, i) {
                  if (!i || this.name === i) {
                    var s = Number(t);
                    if (isNaN(s)) {
                ...
                (re.prototype.goToAndPlay = function (t, e, i) {
                  if (!i || this.name === i) {
                    var s = Number(t);
                    if (isNaN(s)) {
                      var a = this.getMarkerData(t);
                ...
                (re.prototype.trigger = function (t) {
                  if (this._cbs && this._cbs[t])
                    switch (t) {
                      case 'enterFrame':
                        ...
                        break;
                      case 'loopComplete':
                        this.triggerEvent(t, new u(t, this.loop, this.playCount, this.frameMult));
                        break;
                      case 'complete':
                        this.triggerEvent(t, new c(t, this.frameMult));
                        break;
                      case 'segmentStart':
                        this.triggerEvent(t, new g(t, this.firstFrame, this.totalFrames));
                        break;
                      case 'destroy':
                        this.triggerEvent(t, new y(t, this));
                        break;
                      default:
                        this.triggerEvent(t);
                    }
                  'enterFrame' === t &&
                    this.onEnterFrame &&
                    this.onEnterFrame.call(this, new f(t, this.currentFrame, this.totalFrames, this.frameMult)),
                    'loopComplete' === t &&
                      this.onLoopComplete &&
                      this.onLoopComplete.call(this, new u(t, this.loop, this.playCount, this.frameMult)),
                    'complete' === t && this.onComplete && this.onComplete.call(this, new c(t, this.frameMult)),
                    'segmentStart' === t &&
                      this.onSegmentStart &&
                      this.onSegmentStart.call(this, new g(t, this.firstFrame, this.totalFrames)),
                    'destroy' === t && this.onDestroy && this.onDestroy.call(this, new y(t, this));
                }),
                (re.prototype.triggerRenderFrameError = function (t) {
                  var e = new v(t, this.currentFrame);
              ...
              var oe = {};
              function he() {
                !0 === pe ? ae.searchAnimations(me, pe, de) : ae.searchAnimations();
              }
              (oe.play = ae.play),
                (oe.pause = ae.pause),
                ...
                (oe.stop = ae.stop),
                (oe.searchAnimations = he),
                (oe.registerAnimation = ae.registerAnimation),
                (oe.loadAnimation = function (t) {
                  return !0 === pe && (t.animationData = JSON.parse(me)), ae.loadAnimation(t);
                }),
                ...
                (oe.setQuality = function (t) {
                  ...
                  else !isNaN(t) && t > 1 && (p = t);
                  d(!(p >= 50));
                }),
                (oe.inBrowser = function () {
                  return 'undefined' != typeof navigator;
                }),
                (oe.installPlugin = function (t, i) {
                  'expressions' === t && (e = i);
                }),
                (oe.freeze = ae.freeze),
              ...
              var ue = setInterval(function () {
                'complete' === document.readyState && (clearInterval(ue), he());
              }, 100);
              return oe;
            })(a);
    ...
    function (t, e, i) {
      ...
      var a = i(2),
        ...
        h = (function () {
          function t() {
            var e = this;
            (this.initializeOptions = function (i) {
              e.options || (e.options = i ? t.extend(t._defaults, i) : t._defaults);
            }),
              (this.showPageLoader = function (i) {
                if ((e.options || (e.options = i ? t.extend(t._defaults, i) : t._defaults), !e.options.selector)) {
                  if (!i.selector) return void console.warn('Selector for Page loader is not defined');
                  e.options.selector = i.selector;
                }
                var s = document.getElementById(e.options.selector);
                if (s) {
                  if ((document.body.classList.add('no-scroll'), e.isInited))
                    return (
                      -1 === t.prototype.counter && (e.element.firstElementChild.style.display = 'block'),
                      void (t.prototype.counter = t.prototype.counter + 1)
                    );
                  (e.element = t.createElement(s, e)), (e.isInited = !0), (t.prototype.counter = 0);
                } else console.info('Selector not present in DOM');
              }),
              (this.hidePageLoader = function () {
                void 0 !== t.prototype.counter &&
                  -1 !== t.prototype.counter &&
                  (0 === t.prototype.counter &&
                    ((e.element.firstElementChild.style.display = 'none'),
                    document.body.classList.remove('no-scroll'),
                    e.hideMask()),
                  --t.prototype.counter);
              }),
              (this.destroyPageLoader = function () {
                this.element &&
                  (this.element.firstElementChild.remove(),
                  (this.isInited = !1),
                  (t.prototype.counter = void 0),
                  (this.options = void 0),
                  (this.element = void 0),
                  document.body.classList.remove('no-scroll'),
                  this.hideMask());
              ...
              (this.hideMask = function () {
                var t = this.options && this.options.mask_id ? this.options.mask_id : 'body-container';
                document.getElementById(t) && document.getElementById(t).classList.remove('loader-mask');
              }),
              (this.showMask = function (e, i) {
                var s = this;
                this.options || (this.options = t._defaults),
                  (this.options.mask_id = e),
                  document.getElementById(this.options.mask_id) &&
                    document.getElementById(this.options.mask_id).classList.add('loader-mask'),
                  i &&
                    setTimeout(function () {
                      s.hideMask();
                    }, 5e3);
              ...
              (this.getInvocationCount = function () {
                return t.prototype.counter;
              }),
              (this.initialiseMiniLoader = function (e, i) {
                if (e) {
                  var s = document.getElementById(e);
                  if (s) {
                    if (!(s && s.firstElementChild && s.firstElementChild.classList.contains('page-loader--card'))) {
                      var a = new n.MiniLoader(s, i);
                      return t._miniLoaderObj.push(a), a;
                    }
                    console.info('Component Loader already initialised');
                  } else console.info('Selector not present in DOM');
                } else console.warn('Selector for Component loader is not defined');
              }),
              (this.destroyAllMiniLoader = function () {
                t._miniLoaderObj.forEach(function (t) {
                  t && t.destroy();
                });
              }),
              (this.loadAnimationFromJson = function (e, i) {
                var s = o.default.loadAnimation({
                ...
                return t._animObj.push(s), s;
              }),
              (this.destroyAnimationFromJson = function () {
                t._animObj.forEach(function (t) {
                  t && t.destroy();
                });
              });
          }
          return (
            (t.animData = a.SnakeAnimationJson),
            (t._defaults = {
              enable_loader: !1,
              enable_mask: !1,
              loader_message: [],
            ...
            (t.createElement = function (e, i) {
              if (i.options.enable_loader) {
                var s = Math.random();
                (e.innerHTML =
                  '<div class="page-loader overlay-loader">\n    <div class="AjaxLoader">\n        <div class="page-loader__mask"></div>\n        <div class="page-loader__section">\n            <div id="loader-svg-anim-ng' +
                  s +
                  '" class="page-loader__section__svg"></div>\n            <div class="page-loader__section__msg">\n                <p class="show-message-sm align-center">' +
                  (i.options.loader_message[0] || '') +
                  '</p>\n                <p class="show-message-lg align-center">' +
                  (i.options.loader_message[1] || '') +
                  '</p>\n                <p class="show-message-xlg align-center">' +
                  (i.options.loader_message[2] || '') +
                  '</p>\n                 <p class="show-message-xxlg align-center">' +
                  (i.options.loader_message[3] || '') +
                  '</p>\n                 <p class="show-message-xxxlg align-center">' +
                  (i.options.loader_message[4] || '') +
                  '</p>\n            </div>\n        </div>\n    </div>\n</div>' +
                  e.innerHTML),
                  i.options.enable_loader &&
                    (t.animData = 'BASE' === i.options.brand ? a.SnakeAnimationJson : r.OrbitalAnimationJson),
                  o.default.loadAnimation({
                    container: document.getElementById('loader-svg-anim-ng' + s),
                    renderer: 'svg',
                    loop: !0,
                    autoplay: !0,
                    animationData: t.animData,
                  });
              }
              return e;
            }),
            (t.extend = function (e, i) {
              var s,
                a = {};
              for (s in e) Object.prototype.hasOwnProperty.call(e, s) && (a[s] = t._defaults[s]);
              for (s in i) Object.prototype.hasOwnProperty.call(i, s) && (a[s] = i[s]);
              return a;
            }),
            t
          );
          ...
          layers: [
            {
              ...
              ks: {
                o: {
                  a: 1,
                  k: [
                    { i: { x: [0.667], y: [1] }, o: { x: [0.333], y: [0] }, t: 1, s: [0] },
                ...
                r: { a: 0, k: 0, ix: 10 },
                p: { a: 0, k: [951.75, 542.75, 0], ix: 2 },
                a: { a: 0, k: [0, 0, 0], ix: 1 },
                s: { a: 0, k: [97.761, 97.761, 100], ix: 6 },
              },
              ao: 0,
              shapes: [
                {
                  ...
                  it: [
                    ...
                    {
                      ty: 'fl',
                      c: { a: 0, k: [0.019607843137, 0.63137254902, 0.619607843137, 1], ix: 4 },
                      o: { a: 0, k: 100, ix: 5 },
                      r: 1,
                      bm: 0,
                      nm: 'Fill 1',
                    ...
                    {
                      ty: 'tr',
                      p: { a: 0, k: [-293.16, 140.974], ix: 2 },
                      a: { a: 0, k: [0, 0], ix: 1 },
                      s: { a: 0, k: [106.733, 106.733], ix: 3 },
                      r: { a: 0, k: 0, ix: 6 },
                      o: { a: 0, k: 100, ix: 7 },
                      sk: { a: 0, k: 0, ix: 4 },
                      sa: { a: 0, k: 0, ix: 5 },
            ...
            },
            {
              ...
              ks: {
                o: { a: 0, k: 100, ix: 11 },
                r: { a: 0, k: 180, ix: 10 },
                p: { a: 0, k: [914.626, 554.806, 0], ix: 2 },
                a: { a: 0, k: [17.246, 47.425, 0], ix: 1 },
                  ...
                  it: [
                    ...
                    },
                    {
                      ...
                      s: {
                        a: 1,
                        k: [
                          { i: { x: [0.2], y: [1] }, o: { x: [0.4], y: [0] }, t: 9, s: [0] },
                    ...
                    {
                      ty: 'st',
                      c: { a: 0, k: [0.019607843137, 0.63137254902, 0.619607843137, 1], ix: 3 },
                      o: { a: 0, k: 100, ix: 4 },
                      w: { a: 0, k: 30, ix: 5 },
                      lc: 1,
                      lj: 1,
                  ...
                  it: [
                    ...
                    },
                    {
                      ...
                      s: {
                        a: 1,
                        k: [
                          { i: { x: [0.2], y: [1] }, o: { x: [0.4], y: [0] }, t: 7, s: [0] },
                          { t: 57.0000023216576, s: [100] },
                        ],
                        ix: 1,
                      },
                      e: { a: 0, k: 0, ix: 2 },
                  ...
                  it: [
                    ...
                    },
                    {
                      ...
                      s: {
                        a: 1,
                        k: [
                          { i: { x: [0.2], y: [1] }, o: { x: [0.4], y: [0] }, t: 3, s: [0] },
                          { t: 53.0000021587343, s: [100] },
                        ],
                        ix: 1,
                      },
                      e: { a: 0, k: 0, ix: 2 },
                  ...
                  it: [
                    ...
                    },
                    {
                      ...
                      s: {
                        a: 1,
                        k: [
                          { i: { x: [0.2], y: [1] }, o: { x: [0.4], y: [0] }, t: 51, s: [0] },
                          { t: 101.000004113814, s: [100] },
                        ],
                        ix: 1,
                      },
                      e: { a: 0, k: 100, ix: 2 },
                  ...
                  it: [
                    ...
                    },
                    {
                      ...
                      s: {
                        a: 1,
                        k: [
                          { i: { x: [0.2], y: [1] }, o: { x: [0.4], y: [0] }, t: 54, s: [0] },
                  ...
                  it: [
                    ...
                    },
                    {
                      ...
                      s: {
                        a: 1,
                        k: [
                          { i: { x: [0.2], y: [1] }, o: { x: [0.4], y: [0] }, t: 56, s: [0] },
                  ...
                  it: [
                    ...
                    },
                    {
                      ...
                      s: {
                        a: 1,
                        k: [
                          { i: { x: [0.2], y: [1] }, o: { x: [0.4], y: [0] }, t: 58, s: [0] },
                          { t: 108.00000439893, s: [100] },
                        ],
                        ix: 1,
                      },
                      e: { a: 0, k: 100, ix: 2 },
                  ...
                  it: [
                    ...
                    },
                    {
                      ...
                      s: {
                        a: 1,
                        k: [
                          { i: { x: [0.2], y: [1] }, o: { x: [0.4], y: [0] }, t: 60, s: [0] },
          ...
          layers: [
            {
              ...
              ks: {
                ...
                p: { a: 0, k: [79.999, 80.001, 0], ix: 2, l: 2 },
              ...
              shapes: [
                {
                  ...
                  it: [
                    ...
                    {
                      ty: 'fl',
                      c: { a: 0, k: [0.949019607843, 0.529411764706, 0.478431372549, 1], ix: 4 },
                      o: { a: 0, k: 100, ix: 5 },
                      r: 1,
                      bm: 0,
                      nm: 'Fill 1',
            ...
            },
            {
              ...
              ks: {
                o: { a: 0, k: 100, ix: 11 },
                r: { a: 0, k: 86.71, ix: 10 },
                p: { a: 0, k: [0.319, -0.124, 0], ix: 2, l: 2 },
                a: { a: 0, k: [0, 0, 0], ix: 1, l: 2 },
                s: {
                  a: 1,
                  k: [
              ...
              shapes: [
                {
                  ...
                  it: [
                    ...
                    {
                      ty: 'fl',
                      c: { a: 0, k: [1, 0.76862745098, 0.129411764706, 1], ix: 4 },
                      o: { a: 0, k: 100, ix: 5 },
                      r: 1,
                      bm: 0,
                      nm: 'Fill 1',
            ...
            },
            {
              ...
              ks: {
                ...
                r: {
                  a: 1,
                  k: [
                    { i: { x: [0], y: [1] }, o: { x: [0.333], y: [0] }, t: 370, s: [0] },
                    { t: 490, s: [315] },
                  ],
                  ix: 10,
                },
            ...
            },
            {
              ...
              ks: {
                o: { a: 0, k: 100, ix: 11 },
                r: { a: 0, k: 198.02, ix: 10 },
                p: { a: 0, k: [0.124, -0.191, 0], ix: 2, l: 2 },
                a: { a: 0, k: [0, 0, 0], ix: 1, l: 2 },
                s: {
                  a: 1,
                  k: [
              ...
              shapes: [
                {
                  ...
                  it: [
                    ...
                    {
                      ty: 'fl',
                      c: { a: 0, k: [0.211764705882, 0.741176470588, 0.690196078431, 1], ix: 4 },
                      o: { a: 0, k: 100, ix: 5 },
                      r: 1,
                      bm: 0,
                      nm: 'Fill 1',
            ...
            },
            {
              ...
              ks: {
                ...
                r: {
                  a: 1,
                  k: [
                    { i: { x: [0], y: [1] }, o: { x: [0.333], y: [0] }, t: 380, s: [-67.5] },
                    { t: 500, s: [215] },
                  ],
                  ix: 10,
                },
            ...
            },
            {
              ...
              ks: {
                o: { a: 0, k: 100, ix: 11 },
                r: { a: 0, k: 301.262, ix: 10 },
                p: { a: 0, k: [0.298, -0.377, 0], ix: 2, l: 2 },
                a: { a: 0, k: [0, 0, 0], ix: 1, l: 2 },
                s: {
                  a: 1,
                  k: [
              ...
              shapes: [
                {
                  ...
                  it: [
                    ...
                    {
                      ty: 'fl',
                      c: { a: 0, k: [0.788235294118, 0.650980392157, 0.780392156863, 1], ix: 4 },
                      o: { a: 0, k: 100, ix: 5 },
                      r: 1,
                      bm: 0,
                      nm: 'Fill 1',
            ...
            },
            {
              ...
              ks: {
                ...
                r: {
                  a: 1,
                  k: [
                    { i: { x: [0], y: [1] }, o: { x: [0.333], y: [0] }, t: 390, s: [225] },
                    { t: 510, s: [67.5] },
                  ],
                  ix: 10,
                },
            ...
            },
            {
              ...
              ks: {
                ...
                r: {
                  a: 1,
                  k: [
                    { i: { x: [0], y: [1] }, o: { x: [0.333], y: [0] }, t: 240, s: [0] },
                    { t: 360, s: [90] },
                  ],
                  ix: 10,
                },
            ...
            },
            {
              ...
              ks: {
                ...
                r: {
                  a: 1,
                  k: [
                    { i: { x: [0], y: [1] }, o: { x: [0.333], y: [0] }, t: 260, s: [-67.5] },
                    { t: 380, s: [215] },
                  ],
                  ix: 10,
                },
            ...
            },
            {
              ...
              ks: {
                ...
                r: {
                  a: 1,
                  k: [
                    { i: { x: [0], y: [1] }, o: { x: [0.333], y: [0] }, t: 270, s: [225] },
                    { t: 390, s: [67.5] },
                  ],
                  ix: 10,
                },
            ...
            },
            {
              ...
              ks: {
                ...
                r: {
                  a: 1,
                  k: [
                    { i: { x: [0], y: [1] }, o: { x: [0.333], y: [0] }, t: 120, s: [0] },
                    { t: 240, s: [90] },
                  ],
                  ix: 10,
                },
            ...
            },
            {
              ...
              ks: {
                ...
                r: {
                  a: 1,
                  k: [
                    { i: { x: [0], y: [1] }, o: { x: [0.333], y: [0] }, t: 130, s: [0] },
                    { t: 250, s: [315] },
                  ],
                  ix: 10,
                },
            ...
            },
            {
              ...
              ks: {
                ...
                r: {
                  a: 1,
                  k: [
                    { i: { x: [0], y: [1] }, o: { x: [0.333], y: [0] }, t: 140, s: [-67.5] },
                    { t: 260, s: [215] },
                  ],
                  ix: 10,
                },
            ...
            },
            {
              ...
              ks: {
                ...
                r: {
                  a: 1,
                  k: [
                    { i: { x: [0], y: [1] }, o: { x: [0.333], y: [0] }, t: 150, s: [225] },
                    { t: 270, s: [67.5] },
                  ],
                  ix: 10,
                },
            ...
            },
            {
              ...
              ks: {
                ...
                r: {
                  a: 1,
                  k: [
                    { i: { x: [0], y: [1] }, o: { x: [0.333], y: [0] }, t: 10, s: [0] },
                    { t: 130, s: [315] },
                  ],
                  ix: 10,
                },
            ...
            },
            {
              ...
              ks: {
                ...
                r: {
                  a: 1,
                  k: [
                    { i: { x: [0], y: [1] }, o: { x: [0.333], y: [0] }, t: 20, s: [-67.5] },
                    { t: 140, s: [215] },
                  ],
                  ix: 10,
                },
            ...
            },
            {
              ...
              ks: {
                ...
                r: {
                  a: 1,
                  k: [
                    { i: { x: [0], y: [1] }, o: { x: [0.333], y: [0] }, t: 30, s: [225] },
                    { t: 150, s: [67.5] },
                  ],
                  ix: 10,
                },
    ...
    function (t, e, i) {
      ...
      var a = i(1),
        ...
        n = function (t) {
          var e = this;
          (this.pageLoader = t),
            (this.showPageLoader = function (t) {
              e.pageLoader.showPageLoader(t);
            }),
            (this.hidePageLoader = function () {
              e.pageLoader.hidePageLoader();
            }),
            (this.initialiseMiniLoader = function (t, i) {
              return e.pageLoader.initialiseMiniLoader(t, i);
            }),
            (this.loadAnimationFromJson = function (t, i) {
              return e.pageLoader.loadAnimationFromJson(t, i);
            }),
            (this.destroyAnimationFromJson = function () {
              e.pageLoader.destroyAnimationFromJson();
            }),
            (this.destroyPageLoader = function () {
              e.pageLoader.destroyPageLoader();
            }),
            (this.hideMask = function () {
              e.pageLoader.hideMask();
            }),
            (this.showMask = function (t, i) {
              e.pageLoader.showMask(t, i);
            }),
            (this.initializeOptions = function (t) {
              e.pageLoader.initializeOptions(t);
            });
        };
      (e.Loader = n), (window[a.PageLoader._name] = new n(new a.PageLoader())), (window.lottie = r.default);
    },
    function (t, e, i) {
      'use strict';
      var s =
      ...
      var a = i(1),
        ...
        h = function (t, e) {
          var i = this;
          (this.animData = r.SnakeAnimationJson),
            (this.show = function (t, e) {
              if (!i.element) {
                if (!t) return;
                i.element = t;
              }
              if ((i.options || (i.options = e ? a.PageLoader.extend(i._defaults, e) : i._defaults), i.isInited))
                i.element.firstElementChild.style.display = 'block';
              else {
                var s = Math.random();
                (i.element.innerHTML =
                  ' <div class="page-loader page-loader--card">\n        <div id="mini-loader-svg-anim' +
                  s +
                  '" class="page-loader__section__svg"></div>\n       </div>' +
                  i.element.innerHTML),
                  i.options.enable_loader &&
                    (i.animData = 'BASE' === i.options.brand ? r.SnakeAnimationJson : n.OrbitalAnimationJson),
                  o.default.loadAnimation({
                    container: document.getElementById('mini-loader-svg-anim' + s),
                    renderer: 'svg',
                    loop: !0,
                    autoplay: !0,
                    animationData: i.animData,
                  }),
                  (i.isInited = !0);
              }
            }),
            (this.hide = function () {
              i.element && (i.element.firstElementChild.style.display = 'none');
            }),
            (this.destroy = function () {
              i.element && (i.element.firstElementChild.remove(), (i.element = void 0), (i.isInited = !1));
            }),
            (this._defaults = a.PageLoader._defaults),
            this.show(t, e);
        };
      e.MiniLoader = h;
    },

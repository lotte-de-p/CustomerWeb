(self["webpackChunkcustomer_web_billing_invoice_mfe"] = self["webpackChunkcustomer_web_billing_invoice_mfe"] || []).push([["node_modules_ngx-mask_fesm2022_ngx-mask_mjs-_a6a60"],{
    ...
    return (0,_Users_lotte_Documents_Telenet_customer_web_monorepo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (typeof controlValue === 'string' || typeof controlValue === 'number' || controlValue === null || controlValue === undefined) {
        ...
        if (typeof inputValue === 'number' || _this._maskValue.startsWith("separator" /* MaskExpression.SEPARATOR */)) {
          ...
          if (Array.isArray(_this._maskService.decimalMarker) && _this.decimalMarker === "." /* MaskExpression.DOT */) {
            _this._maskService.decimalMarker = "," /* MaskExpression.COMMA */;
          }
...
//# sourceMappingURL=node_modules_ngx-mask_fesm2022_ngx-mask_mjs-_a6a60.js.map
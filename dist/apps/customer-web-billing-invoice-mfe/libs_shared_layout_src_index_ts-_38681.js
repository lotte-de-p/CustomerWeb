(self["webpackChunkcustomer_web_billing_invoice_mfe"] = self["webpackChunkcustomer_web_billing_invoice_mfe"] || []).push([["libs_shared_layout_src_index_ts-_38681"],{
...
class RegexConstants {
  static #_ = this.BASE_SIM_CARD = /^\d{13}$/;
  static #_2 = this.BASE_SALES_ORDER = /^\d{1,16}$/;
  static #_3 = this.FOREIGN_EID_NUMBER = /^[\d]{9}$/;
  static #_4 = this.PHONE_NUMBER = /^[0-9/.+-]{8,15}$/;
  static #_5 = this.FIXED_PHONE_NUMBER = /^[0-9]{8,9}$/;
  static #_6 = this.ADDRESS_NUMBER = /^[A-Za-z0-9]{0,6}$/;
  static #_7 = this.TEXT_FIELD_GENERAL = /^([a-zA-Z0-9\s-']+)$/;
  static #_8 = this.TEXT_FIELD_ONLY_ALPHABETS = /^([a-zA-Z\s]+)$/;
  static #_9 = this.NATIONAL_PHONE_NUMBER = /^((0|0032|\+32)\d{8})$/;
  static #_10 = this.NATIONAL_MOBILE_NUMBER = /^((0|0032|32|\+32)4\d{8})$/;
  static #_11 = this.INTERNATIONAL_PHONE_NUMBER = /^((00|\+)(?!32)\d{7,15})$/;
  static #_12 = this.BELGIAN_EID_NUMBER = /^[a-zA-Z0-9]{3}-[\d]{7}-[\d]{2}$/;
  static #_13 = this.FOREIGN_EID_NUMBER_REGEX = /^[a-zA-Z0-9.-]{1,20}$/;
  static #_14 = this.NATIONAL_REGISTRY_NUMBER = /^[\d]{2}.[\d]{2}.[\d]{2}-[\d]{3}.[\d]{2}$$/;
  static #_15 = this.INTERNATIONAL_NUMBER = /^(\+|00|0)(?:[0-9] ?){6,14}[0-9]$/;
  static #_16 = this.BASE_AND_FIXED_NUMBER = /^(((\+32)\d{8})|((00)\d{8})|((0)\d{8}))$/;
  static #_17 = this.COMPANY = /^([a-zA-Z0-9àâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇ\s.-’']+)$/;
  static #_18 = this.MULTI_LINGUAL = /^([a-zA-Z0-9àâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇÆæ\s-]+)$/;
  static #_19 = this.TELENET_PHONE_NUMBER = /^(((0|0032|\+32)4\d{8})|((00|\+)(?!32)\d{7,12}))$/;
  static #_20 = this.TELENET_MOBILE_NUMBER = /^((|0|0032|32|\+32)4\d{8})$/;
  static #_21 = this.INTERNATIONAL_AND_FIXED_NUMBER = /^(((00)\d{8,13})|((0)\d{8,9})|((0)\d{8}))$/;
  static #_22 = this.EMAIL = /^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,25})$/i;
  static #_23 = this.BASE_PHONE_NUMBER = /^(((0|0032|\+32|032|32)4\d{8})|((00|\+)(?!32)4\d{8})|(4\d{8}))$/;
  static #_24 = this.FORMATTED_BASE_PHONE_NUMBER = /^((([0-9]{4})[ ][0-9]{2})(([ ]?[0-9]){2})(([ ]?[0-9]){2}))$/;
  static #_25 = this.BASE_EMAIL = /^[_a-z0-9!#$%&'*+-/=?^_`{|}~-]+(\.[_a-z0-9!#$%&'*+-/=?^_`{|}~-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,25})$/i;
  static #_26 = this.DELIVERY_ORDER_PHONE_NUMBER = /^(((0032|032|\+32|32)\d{8})|((0032|032|\+32|32)4\d{8})|((\+)(?!32)\d{7,13})|((0|00)(?!32)([1-9])\d{7})|((0|00)4\d{8})|(4\d{7,8})|(([1-9])\d{7}))$/;
  static #_27 = this.ZERO_PREFIX_CHECK_REGEX = /(^[1-9][0-9]{7})|(^[1-9][0-9]{8})$/;
  static #_28 = this.DARWIN_EMAIL = /^[-A-Za-z0-9~!#$%^&*_=+}|/{'`?][-A-Za-z0-9~!#$%^&*_=+.}|/{'`?]*[-A-Za-z0-9~!#$%^&*_=+}|/{'`?]@(([-A-Za-z0-9]+[.]?[-A-Za-z0-9]+\.(aero|arpa|biz|com|coop|edu|gov|info|int|mil|local|museum|name|net|org|pro|travel|mobi|global|[a-z][a-z]))|(\[([0-9]{1,3}\.){3}[0-9]{1,3}]))$/i;
  static #_29 = this.NETWORK_NAME = /([\^`,"'])/;
  static #_30 = this.SPECIAL_CHAR_REGEX = /(?=.*[\x21-\x2F\x3A-\x40\x5B-\x60\x7B-\x7E])/;
  static #_31 = this.LOWER_CASE_REGEX = /(?=.*[a-z])/;
  static #_32 = this.UPPER_CASE_REGEX = /(?=.*[A-Z])/;
  static #_33 = this.NUMBER_REGEX = /(?=.*[0-9])/;
  static #_34 = this.NO_START_END_SPACE_REGEX = /^\s|\s$/;
  static #_35 = this.NO_START_SPACE_REGEX = /^\s/;
  static #_36 = this.MAC_ADDRESS = /^[0-9a-f]{1,2}([.:-])[0-9a-f]{1,2}(?:\1[0-9a-f]{1,2}){4}$/i;
  static #_37 = this.NO_NONE_WORD_REGEX = /\b(none)\b/g;
  static #_38 = this.NUMBER_ONLY_REGEX = '^[0-9]*$';
  static #_39 = this.PRICE = /^\d+(?:[.,]\d{2})?$/;
  static #_40 = this.INTERNATIONAL_IBAN = '^([A-Z]{2}[ ]?[0-9]{2})(?=(?:[ -]?[A-Z0-9]){9,30}$)((?:[ -]?[A-Z0-9]{3,5}){2,7})([ -]?[A-Z0-9]{1,3})?$';
  static #_41 = this.NO_START_END_SPACE = /^\S[\w\d\s\x21-\x2F\x3A-\x40\x5B-\x60\x7B-\x7E]*\S$/;
  static #_42 = this.NUMBER_RANGE_REGEX = /^(\d+\s?-\s?\d+)$/;
  static #_43 = this.SIM_CARD_REGEX = /^(\d{13}|\d{19})$/;
  static #_44 = this.HEXADECIMAL = '^[a-fA-F0-9]*$';
  static #_45 = this.ALPHA_NUMERIC_REGEX = /(?=.*[a-zA-Z0-9])/;
}
...
class LayoutLibModule {
  static #_ = this.ɵfac = function LayoutLibModule_Factory(t) {
...
class SummaryContentRowComponent {
  constructor() {
    this.priceType = _model_product_overview_data_model__WEBPACK_IMPORTED_MODULE_1__.OverviewPriceType;
    this.strikeTroughConfiguration = _summary_content_row_interface__WEBPACK_IMPORTED_MODULE_0__.StrikeTroughSummaryContentRow;
  }
  ngOnInit() {
  ...
  static #_ = this.ɵfac = function SummaryContentRowComponent_Factory(t) {
...
class SummaryHeaderComponent {
  constructor() {
    this.linkClicked = new _angular_core__WEBPACK_IMPORTED_MODULE_0__.EventEmitter();
  }
  static #_ = this.ɵfac = function SummaryHeaderComponent_Factory(t) {
...
//# sourceMappingURL=libs_shared_layout_src_index_ts-_38681.js.map
...
const imagesRootPath = '/content/dam/www-telenet-touch/nl/common/components/dtv-details';
...
describe('ImageSrcInterceptorDirective ', () => {
  ...
  beforeEach(() => {
    ...
    imageSrcInterceptorDirective.imagesRootPath = '/content/dam/www-telenet-touch/nl/common/components/dtv-details';
  });
  ...
  describe('ngOnChanges on a image served remotely', () => {
    it('should set src correctly with only one image folder', () => {
      configService.addRemoteHostConfig('tg-entertainment-dtv-box-overview', {
        remoteHost,
      });

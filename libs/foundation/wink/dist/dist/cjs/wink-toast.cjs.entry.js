...
const Toast = class {
    constructor(hostRef) {
        ...
        this.appearance = toast_types.TOAST_TYPES.actionable;
        this.text = '';
    ...
    iconsNamesMap = new Map([
        [toast_types.TOAST_TYPES.negative, 'cross-circle-filled'],
        [toast_types.TOAST_TYPES.positive, 'check-shape-filled'],
    ]);
    ...
    closeToastAfterTimeout() {
        if (this.appearance !== toast_types.TOAST_TYPES.actionable && this.duration && this.duration > 0) {
            if (this.timer) {
    ...
    render() {
        return (index.h(index.Host, { key: '4353ed175ce789298a19e7c9037ea92719db8d47', theme: this.theme, "aria-hidden": this.isOpen ? 'false' : 'true', role: "alert" }, (this.appearance === toast_types.TOAST_TYPES.positive || this.appearance === toast_types.TOAST_TYPES.negative) && (index.h("wink-icon", { class: `toast-icon toast-icon-${this.appearance}`, size: icon_types.ICON_SIZES.md, icon: this.iconsNamesMap.get(this.appearance) })), this.text && index.h("p", { class: "toast-text" }, this.text), this.appearance === toast_types.TOAST_TYPES.actionable && this.href && (index.h("wink-link", { appearance: "default", icon: "", size: "inherit", "is-disabled": "false", class: "toast-link", target: this.target, href: this.href }, this.linkText)), index.h("wink-button", { key: 'dae3eea4b47c3b59e37af642c36fbe3179a132a6', element: "button", type: "button", appearance: "tertiary", size: "sm", width: "none", status: "none", icon: "cross", "icon-position": "center", exportparts: "icon, icon-cross", class: "hydrated toast-close", "icon-button-aria-label": "close toast", onClick: this.closeToast.bind(this) })));
    }
...
exports.wink_toast = Toast;

//# sourceMappingURL=wink-toast.cjs.entry.js.map
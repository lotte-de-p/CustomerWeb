...
const Sheet = class {
    ...
    renderFooter() {
        if (!this.hasStickyFooter)
            return;
        if (this.multipage) {
            return (index.h("div", { class: "sheet-footer" }, index.h("div", { class: `sheet-footer-sub ${this.firstPage ? 'sheet-footer-visible' : ''}` }, index.h("slot", { name: "footer" })), index.h("div", { class: `sheet-footer-sub ${!this.firstPage ? 'sheet-footer-visible' : ''}` }, index.h("slot", { name: "footer-second" }))));
        }
        return (index.h("div", { class: "sheet-footer" }, index.h("slot", { name: "footer" })));
    }
    render() {
        return (index.h("dialog", { key: '6c391240655b93400dd6736dc93cd169a12338b8', onClick: this.handleButtonClick, class: `sheet  ${this.hasStickyFooter ? 'sheet-margin-bottom' : ''} ${this.dashboard ? 'sheet-darker' : ''}`, "aria-live": "assertive" }, !this.firstPage && (index.h("wink-button", { appearance: "tertiary", size: "md", icon: "chevron-left", "icon-position": "center", class: "sheet-icon sheet-icon-back", "icon-button-aria-label": "Terug", onClick: this.goBack.bind(this) })), index.h("wink-button", { key: '93349cd37b62fd955255b5a758ba796182d851ce', appearance: "tertiary", size: "md", icon: "cross", "icon-position": "center", class: "sheet-icon sheet-icon-close", "icon-button-aria-label": "Sluiten", onClick: this.closeModal.bind(this) }), index.h("div", { key: 'a99178e56a7a76ee6371955b59481db8c5a1654d', class: "sheet-content" }, this.multipage ? (index.h("div", { class: "sheet-content-scroll" }, index.h("div", { class: `sheet-content-page sheet-content-page-first ${this.firstPage ? 'sheet-content-page-visible' : ''}` }, index.h("slot", { name: "page-first" })), index.h("div", { class: `sheet-content-page sheet-content-page-second ${!this.firstPage ? 'sheet-content-page-visible' : ''} ` }, index.h("slot", { name: "page-second" })), index.h("slot", null))) : (index.h("div", { class: "sheet-content-scroll" }, index.h("slot", null))), this.renderFooter())));
    }
...
exports.wink_sheet = Sheet;

//# sourceMappingURL=wink-sheet.cjs.entry.js.map
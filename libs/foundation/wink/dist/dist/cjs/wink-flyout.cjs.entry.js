...
const Flyout = class {
    constructor(hostRef) {
        ...
        this.flyoutBackLinkClicked = index.createEvent(this, "flyoutBackLinkClicked", 7);
    ...
    shouldFetchFocusableElements() {
        return (!this.focusableElements.length &&
            mediaQueryDetector.MediaQueryDetector.isFromMdHeader &&
            this.isFlyoutOpen &&
    ...
    handleFlyoutMouseLeave() {
        if (mediaQueryDetector.MediaQueryDetector.isUntilMdHeader) {
            return;
        }
        this.resetFlyout();
    ...
    render() {
        return (index.h(index.Host, { key: 'b3f8de09ea87e0737c3e2afc3e1187a048a80e1a', id: `flyout-${this.flyoutId}`, tabindex: "-1", "aria-label": this.flyoutId === this.activeId ? this.backLabel : ' ', onMouseLeave: this.handleFlyoutMouseLeave.bind(this), open: this.isFlyoutOpen }, index.h("div", { key: '05db9b329e56b761af5d89c94c2b8f4232f3da69', class: "container" }, index.h("div", { key: '029ad3b6f9e9209d502a89316276604c35f56e6b', class: "content" }, index.h("wink-link", { key: '06a63c15351212b1bd808ad3f3e1cc36930d19f3', onClick: this.closeFlyout.bind(this), appearance: "menu-back", icon: "arrow-left", size: "caption-bold", "icon-position": "left", "icon-appearance": "default", "is-disabled": "false", href: "#" }, index.h("wink-icon", { key: '4fb7df087966f6cb30f105f69c021c777d55c997', slot: "link-icon", appearance: "default", icon: "arrow-left", size: "md", exportparts: "icon, icon-arrow-left" }), this.backLabel), Array.from({ length: 4 }).map((_, index$1) => (index.h("slot", { name: `col-${index$1 + 1}` })))))));
    }
};
Flyout.style = {
...
exports.wink_flyout = Flyout;

//# sourceMappingURL=wink-flyout.cjs.entry.js.map
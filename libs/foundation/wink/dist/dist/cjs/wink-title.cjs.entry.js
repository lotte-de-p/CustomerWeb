...
const Title = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ad89fd8cc705021f289f820bba893b5fba3b7e30', class: this.spacingY !== 'default' ? `spacing-${this.spacingY}` : '' }, index.h(this._HtmlTag, { key: '9b43bafd3c9d4b96c56473032137277edf5ccee8', class: { [this.htmlTag]: this.noSeo } }, this.text)));
    }
};
Title.style = {
...
exports.wink_title = Title;

//# sourceMappingURL=wink-title.cjs.entry.js.map
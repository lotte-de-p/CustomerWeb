...
const DropdownMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: '88fbb34e0b20c23d779fc73f705761149dcb19c0', class: `dropdown-menu--align-list--${this.listPosition}`, "is-expanded": this.isExpanded, onMouseDown: this.toggleDropdown, exportparts: "icon, icon-chevron-down-small" }, index.h("button", { key: '72d134a0d53203c6003a8da891c7bb85a5f1e753', class: "dropdown-menu--heading", tabindex: this.dropdownTabIndex }, index.h("slot", { key: '427559f9fceb6bd78f61e84c3d06cacafd52985c', name: "dropdown-menu--avatar" }), this.heading, index.h("div", { key: '477b64011bfef337fb58cecc1c1402e3a3b5ab6e', class: "dropdown-menu--chevron" }, index.h("wink-icon", { key: '5dd905ae775fdfc695d61871a06525a90c753a0b', size: icon_types.ICON_SIZES.sm, icon: "chevron-down-small" }))), index.h("ul", { key: 'a61a0687e6c2c7e7707a3a4cd6a1abdeb378b35c', class: "dropdown-menu--list" }, index.h("slot", { key: '65527a46e8fac48e64133f1367b91f02997cebb3' }))));
    }
};
DropdownMenu.style = {
...
exports.wink_dropdown_menu = DropdownMenu;

//# sourceMappingURL=wink-dropdown-menu.cjs.entry.js.map
...
const Logo = class {
    ...
    getSrcDesktop() {
        return logos[this.appearance]['desktop'] && index.getAssetPath(logos[this.appearance]['desktop']);
    }
    getSrcMobile() {
        return logos[this.appearance]['mobile'] && index.getAssetPath(logos[this.appearance]['mobile']);
    }
    altText() {
        return (this.alt !== 'Inspect element to check' && this.alt) || logos[this.appearance]['alt'];
    }
    renderLogoImage = (srcDesktop, srcMobile, alt) => {
        return (index.h("picture", null, srcMobile && index.h("source", { srcSet: srcMobile, media: breakpoints_types.BREAKPOINTS.mobile }), index.h("img", { src: srcDesktop, alt: alt })));
    };
    render() {
        return (index.h(index.Host, { key: 'af3037b2e099d2cae8367abf1e6f37fce1a3ee39' }, this.href.length > 0 ? (index.h("a", { href: this.href, target: this.target }, this.renderLogoImage(this.getSrcDesktop(), this.getSrcMobile(), this.altText()))) : (this.renderLogoImage(this.getSrcDesktop(), this.getSrcMobile(), this.altText()))));
    }
};
Logo.style = {
...
exports.wink_logo = Logo;

//# sourceMappingURL=wink-logo.cjs.entry.js.map
...
const NOTIFICATION_TYPES = {
    information: statuses_types.STATUS_VARIANTS.information,
    success: statuses_types.STATUS_VARIANTS.success,
    error: statuses_types.STATUS_VARIANTS.error,
    warning: statuses_types.STATUS_VARIANTS.warning,
};
...
const Notification = class {
    ...
    render() {
        return (this.isNotificationVisible && (index.h(index.Host, { key: 'f440c5eaf0642729ff78e250908e5c0492e253df', exportparts: `icon, icon-cross-small, icon-${this.iconsNamesMap.get(this.appearance)}` }, index.h("div", { key: '68c6b2c237e7918b26ed0c7a8464119fa5b1083a', class: `notification ${this.appearance} ${this.hasCloseIcon ? 'has-close-icon' : ''}` }, index.h("wink-icon", { key: '9647c838b41ac5ac6b469b7139cd5f540fb85e92', size: icon_types.ICON_SIZES.md, icon: this.iconsNamesMap.get(this.appearance) }), this.hasCloseIcon && (index.h("wink-icon", { class: "close-icon", appearance: "default", icon: "cross-small", size: icon_types.ICON_SIZES.md, onClick: this.closeNotification })), index.h("div", { key: '5da60762854c2bf8575e91eace9591b1fb6b7378', class: "notification-text" }, index.h("slot", { key: '315745107efac4e38114bab292cfb68f993ec7cf', name: "heading" }), index.h("slot", { key: '5f1850a6ec9cdbd8b471c815c3bc3cd447f3d94a', name: "content" }))))));
    }
};
Notification.style = {
...
exports.wink_notification = Notification;

//# sourceMappingURL=wink-notification.cjs.entry.js.map
...
import { LINK_APPEARANCES_DEFAULT, LINK_APPEARANCES_SNOWFLAKES, LINK_ICON_POSITIONS, LINK_SIZES, } from "./models/link.types";
...
export default {
    ...
    argTypes: {
        appearance: {
            ...
            description: 'The appearance property in the link component specifies its visual style, offering options like "default", "subtle", or "area" for consistent presentation and interaction within different contexts.',
        },
        size: {
            control: inlineRadio,
            options: Object.values(LINK_SIZES),
            description: 'The size property in the link component offers options like "inherit" or "bodyRegular" for controlling its text size, ensuring consistent typography and readability.',
        },
        icon: {
            control: 'select',
        ...
        iconPosition: {
            ...
            description: 'The iconPosition property determines the placement of the icon within the link component, allowing options such as "left" or "right".',
        },
        iconAppearance: {
            control: 'inline-radio',
            options: Object.values(ICON_TYPES_BASIS),
            description: 'The iconAppearance property in the link component allows selection from options like "default", "primary", or "secondary", influencing the style of the displayed icon for enhanced visual differentiation and coherence.',
        },
        isDisabled: {
            control: 'boolean',
            description: 'The isDisabled property in the link component, when set to true, disables interaction with the link, providing visual feedback and preventing user engagement.',
            table: {
        ...
        href: {
            control: 'text',
            description: 'The href property specifies the hyperlink reference for the link component when it is rendered as an anchor tag, allowing navigation to a specific URL when clicked.',
        ...
        slot: {
            description: 'The slot property serves as a placeholder allowing users to add custom content within the link component.',
        },
    },
    args: {

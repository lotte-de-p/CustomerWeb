...
export default {
    ...
    argTypes: {
        appearance: {
            ...
            description: 'The appearance property specifies the type or style of the notification, offering options like "success", "error", "warning", or "info" to convey different levels of importance or feedback to the user.',
            table: {
        ...
        hasCloseIcon: {
            control: 'boolean',
            description: 'The hasCloseIcon property toggles the visibility of the close icon within the notification, allowing users to dismiss the notification when enabled.',
            table: {
                category: STORY_CATEGORIES.cp,
            },
        },
        heading: {
            control: 'text',
            description: 'The heading property serves as a placeholder allowing users to add custom content within the notification component.',
            table: {
        ...
        content: {
            control: 'text',
            description: 'The content property serves as a placeholder allowing users to add custom content within the notification component.',
            table: {
                category: STORY_CATEGORIES.sp,
            },
        },

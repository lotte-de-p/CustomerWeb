...
import { d as defineCustomElement$5 } from './form-label.js';
...
const RangeSlider = /*@__PURE__*/ proxyCustomElement(class RangeSlider extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.sliderId = '';
...
export { WinkRangeSlider, defineCustomElement };

//# sourceMappingURL=wink-range-slider.js.map
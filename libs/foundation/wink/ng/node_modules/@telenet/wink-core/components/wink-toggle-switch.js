...
const ToggleSwitch = /*@__PURE__*/ proxyCustomElement(class ToggleSwitch extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.label = '';
...
export { WinkToggleSwitch, defineCustomElement };

//# sourceMappingURL=wink-toggle-switch.js.map
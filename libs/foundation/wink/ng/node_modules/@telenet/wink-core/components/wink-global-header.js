...
const GlobalHeader = /*@__PURE__*/ proxyCustomElement(class GlobalHeader extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
export { WinkGlobalHeader, defineCustomElement };

//# sourceMappingURL=wink-global-header.js.map
...
const Paragraph = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f74cebdf05b2f6e4135eb2e9d6f60461612d2e0e', class: `font--${this.appearance}-${this.size}` }, index.h("slot", { key: 'e9bb9bcb6965caaad10e97d80c48647bab6b7746' })));
    }
};
Paragraph.style = {
...
exports.wink_paragraph = Paragraph;

//# sourceMappingURL=wink-paragraph.cjs.entry.js.map
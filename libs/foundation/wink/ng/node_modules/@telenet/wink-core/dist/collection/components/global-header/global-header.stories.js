...
const generateSlot = (args, slotName, htmlContent) => args[slotName] ? html `${unsafeHTML(htmlContent)}` : null;
export default {
    ...
    render: (args) => html ` <wink-global-header>
      ${generateSlot(args, 'customerOrientation', `<wink-customer-orientation slot="customer-orientation"></wink-customer-orientation>`)}
      ${generateSlot(args, 'intentBar', `<wink-intent-bar slot="intent-bar"></wink-intent-bar>`)}
      ${generateSlot(args, 'customerZone', `<div slot="customer-zone">
      ...
      ${generateSlot(args, 'language', `<div slot="language">
      ...
      ${generateSlot(args, 'brand', `<div slot="brand">
          <wink-logo
      ...
      ${generateSlot(args, 'mainNavigation', `<div slot="main-navigation"><wink-main-navigation menu-items=${JSON.stringify(mainNavigationItems)} /></div>`)}
      ${generateSlot(args, 'search', `<div slot="search">
            <wink-input
              appearance="search"
              icon-left="search"
      ...
      ${generateSlot(args, 'callToAction', `<div slot="call-to-action">
            <wink-button
              text="Shopping cart"
              element="button"
              type="button"
      ...
      ${generateSlot(args, 'flyout', `
        ...
        `)}
      ${generateSlot(args, 'mobileCustomerOrientation', `<wink-customer-orientation slot="mobile-customer-orientation"></wink-customer-orientation>`)}
      ${generateSlot(args, 'mobileIntentBar', `<wink-intent-bar slot="mobile-intent-bar"></wink-intent-bar>`)}
      ${generateSlot(args, 'mobileCustomerZone', `<div slot="mobile-customer-zone">
            <wink-icon
            appearance="default"
            icon="user"
            size="md"
      ...
      ${generateSlot(args, 'mobileLanguage', `<div slot="mobile-language">
            <wink-dropdown-menu heading="NL" list-position="left" item-selected="NL">
              <wink-link appearance="dropdown-menu-link">NL</wink-link>
              <wink-link appearance="dropdown-menu-link">FR</wink-link>
              <wink-link appearance="dropdown-menu-link">EN</wink-link>
      ...
      ${generateSlot(args, 'mobileBrand', `<div slot="mobile-brand">
            <wink-logo
              appearance="telenet-yellow"
              href="https://www.telenet.be"
              alt="Inspect element to check"
      ...
      ${generateSlot(args, 'mobileMainNavigation', `<wink-main-navigation slot="mobile-main-navigation" menu-items=${JSON.stringify(mainNavigationItems)} />`)}
      ${generateSlot(args, 'mobileSearch', `<div slot="mobile-search">
            <wink-icon
            appearance="default"
            icon="search"
            size="md"
      ...
      ${generateSlot(args, 'mobileFlyout', `
        ...
        `)}
      ${generateSlot(args, 'mobileCallToAction', `<div slot="mobile-call-to-action">
            <wink-button
              text="Button primary"
              element="button"
              type="button"
...
//# sourceMappingURL=global-header.stories.js.map

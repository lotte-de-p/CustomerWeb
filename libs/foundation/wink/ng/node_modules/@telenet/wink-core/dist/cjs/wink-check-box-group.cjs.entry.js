...
const CheckBoxGroup = class {
    ...
    render() {
        return (index.h("fieldset", { key: 'd7f5fa5db666b4c44c65794b26d89558fc95e00c' }, index.h("legend", { key: 'c123bc97caf59f4e07715fd3fb5567bbdbf56096', class: "check-box-group__wrapper" }, index.h("wink-form-label", { key: 'e321c64e5cf4cde27ebbe86779999826a3619c32', label: this.label, helper: this.helper, "show-optional": !this.isRequired, "optional-text": this.optionalText })), index.h("div", { key: 'ca479c96280af57731b88bc4aa0b2fbfee0e829a', class: `check-box-group--${this.direction}` }, index.h("slot", { key: '245b88689fd91bfe99bb6570a763207b30fe2438' })), this.error && index.h("wink-validation-message", { message: this.error, type: "error" })));
    }
};
CheckBoxGroup.style = {
...
exports.wink_check_box_group = CheckBoxGroup;

//# sourceMappingURL=wink-check-box-group.cjs.entry.js.map
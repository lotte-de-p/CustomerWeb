...
export default {
    ...
    argTypes: {
        itemSelected: {
            description: "The itemSelected property specifies the currently selected or highlighted item in the menu, enabling visual differentiation or interaction with the user's selection.",
            table: { defaultValue: { summary: 'account' } },
        },
        isExpanded: {
            description: 'The isExpanded property, when set to true, indicates that the dropdown menu component is in an expanded state, displaying its contents to the user.',
            table: { defaultValue: { summary: false } },
        },
        heading: {
            description: 'The heading property specifies the title or label displayed for the menu, providing context or instruction to users regarding its content or purpose.',
            type: { name: 'string', required: true },
        },
        listPosition: {
            control: 'select',
            description: 'The listPosition property allows aligning the items within the menu either to the left or to the right along the cross-axis, ensuring proper layout and presentation.',

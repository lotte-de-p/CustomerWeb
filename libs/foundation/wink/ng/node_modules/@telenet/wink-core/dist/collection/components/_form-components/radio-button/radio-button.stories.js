...
export default {
    ...
    argTypes: {
        label: {
            ...
            description: 'The label property specifies the label text displayed alongside the radio button, providing context or instructions for the user.',
        },
        helper: {
            control: 'text',
            table: { category: STORY_CATEGORIES.cpBasic },
        ...
        name: {
            control: 'text',
            table: { category: STORY_CATEGORIES.cpBasic },
            description: 'The name property assigns a name to the radio-button, which is submitted with the form data when the form is submitted.',
        ...
        radioButtonId: {
            control: 'text',
            table: { category: STORY_CATEGORIES.cpBasic },
            description: 'The radioButtonId property assigns a unique identifier to the radio-button, facilitating accessibility and functionality.',
        },
        amount: {
        ...
        direction: {
            ...
            description: 'The direction property specifies the direction for rendering the radio buttons inside the radio-group.',
            if: { arg: 'amount', exists: true },
        },
        groupLabel: {
            control: 'text',
            table: { category: STORY_CATEGORIES.cpGroup },
            description: 'The groupLabel property specifies the label text displayed above the radio-group, providing context or instructions for the user.',
            if: { arg: 'amount', exists: true },
        },
        groupHelper: {
            control: 'text',
            table: { category: STORY_CATEGORIES.cpGroup },
            description: 'The groupHelper property provides additional assistance or information related to the radio-group in the form of helper text displayed below the label, offering guidance or clarification to the user.',
            if: { arg: 'amount', exists: true },
        },
        errorText: {
            control: 'text',
        ...
        isRequired: {
            control: 'boolean',
            table: { category: STORY_CATEGORIES.cpGroup },
            description: 'The isRequired property, when set to true, marks the radio-group as mandatory, requiring users to provide a value before submitting the form.',
            if: { arg: 'amount', exists: true },
        },
    },
    args: {
    ...
    render: (args) => html ` <wink-radio-button

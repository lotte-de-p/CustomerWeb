...
const fontName = 'base-icons-font';
const iconsDir = 'libs/foundation/wink/core/src/assets/base/icons';
...
function processIcons() {
  ...
  const outputIconNamesFile = `${iconsDirShared}/data/icons-name-base.data.ts`;

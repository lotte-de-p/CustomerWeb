...
describe('wink-select', () => {
  it('should create an instance of Select class component', () => {
  ...
  it('should render the element wink-select', async () => {
    ...
    <wink-select>
      <!---->
      <label htmlfor="">
         <wink-form-label rendition="default"  show-optional=""></wink-form-label>
       </label>
       <div class="select-wrapper">
         <select id=""></select>
         <wink-icon appearance="transparent"  icon-color="default"  icon="chevron-down"></wink-icon>
       </div>
    </wink-select>
  `);
  });

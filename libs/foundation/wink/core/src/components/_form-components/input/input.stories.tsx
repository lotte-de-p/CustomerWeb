...
import { getValuesAsArrayFromObject, cleanScopedWinkElements } from '../../../utils/utils';
...
export default {
  ...
  argTypes: {
    inputId: {
      ...
      description:
        'The inputId property assigns a  custom identifier to the input field, facilitating accessibility and functionality. If there is no custom input-id defined the component will generate one.',
    },
    name: {
      control: 'text',
      table: { category: STORY_CATEGORIES.cpBasic },
  ...
  render: (args) =>
    html` ${args.tooltip &&
      ...
      <wink-input
        ...
        label-link-text="${args.labelLinkText || nothing}"
        label-href="${args.labelHref || nothing}"
        is-autofocused="${args.isAutofocused || nothing}"
        tooltip="${args.tooltip}"></wink-input>`,
} as Meta;

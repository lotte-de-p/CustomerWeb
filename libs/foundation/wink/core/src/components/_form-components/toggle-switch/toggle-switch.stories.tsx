...
export default {
  ...
  parameters: {
    badges: [BADGES.ready],
    html: {
      transform: (code: string) => cleanScopedWinkElements(code, ['wink-toggle-switch']),
    },
  },
  argTypes: {
    alignment: {
    ...
    checked: {
      control: 'boolean',
      description: 'The checked property, when set the radio programmatically, marks the toggle-switch as checked.',
    },
    disabled: {
      control: 'boolean',

...
export default {
  ...
  argTypes: {
    listTitle: {
      description:
        'The listTitle property specifies the title or label displayed for the menu, providing context or instruction to users regarding its content or purpose.',
      control: { type: 'text' },
    },
    hasBoldLinks: {
    ...
    links: {
      description:
        'The links property gives the links to be displayed in the list. Each link should have a text and a href property.',
      control: { type: 'array' },
    },
  },
  args: {
  ...
  render: (args: any) => {
    const links = args.links.map(
      (link: { href: string; text: string }) =>
        html`<wink-navigation-list-item href="${link.href}">${link.text}</wink-navigation-list-item>`
    );
    return html`

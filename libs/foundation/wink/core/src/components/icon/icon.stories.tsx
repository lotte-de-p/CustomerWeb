...
import { ICON_COLORS, ICON_SIZES, ICON_TYPES } from './models/icon.types';
...
export default {
  ...
  argTypes: {
    ...
    iconColor: {
      ...
      description: 'The color property defines the color of the icon.',
      table: {
        defaultValue: { summary: ICON_COLORS.default },
      },
      if: { arg: 'appearance', eq: ICON_TYPES.default },
    },
    ...categoriesArgTypes,
  },
  args: {
  ...
  render: (args: any) =>
    html` <wink-icon
      icon="${args[args.category]}"
      appearance="${args.appearance}"
      size="${args.size}"
      icon-color="${args.iconColor}"></wink-icon>`,
} as Meta;

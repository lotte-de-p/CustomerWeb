export declare enum SalesDataType {
...
export declare enum SalesDataProductType {
    TYPE_PRODUCT = "Product",
    TYPE_MOBILE = "Mobile",
    TYPE_BUNDLE = "BUNDLE",
    TYPE_INTERNET = "INTERNET",
...
export declare enum SalesDataOptionType {
    TYPE_OPTION = "Option",
    TYPE_OPTION_DWN = "OPTION"
}
export declare enum SalesDataOptinType {
    TYPE_OPTIN = "Optin",
    TYPE_DATA_ONLY_MOBILE_LINE = "DATA ONLY MOBILE LINE",
    TYPE_FIXED_LINE = "FIXED LINE",
    TYPE_MOBILE_LINE = "MOBILE LINE"
}
//# sourceMappingURL=sales-data.type.d.ts.map
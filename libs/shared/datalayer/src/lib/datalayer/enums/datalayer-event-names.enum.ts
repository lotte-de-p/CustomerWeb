export enum DatalayerEventNames {
  ...
  NO_APPOINTMENT_PLANNED = 'no appointment planned',
  EVENT_NAME_SELF_SERVICE_FLOW_STARTED = 'self-service flow started',
  EVENT_NAME_SELF_SERVICE_FLOW_ENDED = 'self-service flow ended',
}

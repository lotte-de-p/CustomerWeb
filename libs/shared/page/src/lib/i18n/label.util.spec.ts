...
describe('LabelUtil', () => {
  ...
  describe('getLabelKeyWithTypeButton', () => {
    it('should return label key for button type', () => {
  ...
  describe('normalizeKey', () => {
    it('should return normalized key', () => {
      const actual = LabelUtil.normalizeKey('abc_56test_45');
      expect(actual).toBe('abc-56test-45');
    });
  });
});

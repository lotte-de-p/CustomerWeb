...
export default defineConfig({
  ...
  reporter: 'junit',
  reporterOptions: {
    mochaFile: '../../../../coverage/cypress/sales/etf/feat-etf/TEST-[hash].xml',
    rootSuiteTitle: 'Cypress Tests',
    testCaseSwitchClassnameAndName: 'true',
  },
  videosFolder: '../../../../dist/cypress/sales/etf/feat-etf/videos',
  screenshotsFolder: '../../../../dist/cypress/sales/etf/feat-etf/screenshots',
  fixturesFolder: '../../../../coverage/cypress/sales/etf/feat-etf/fixtures',
});

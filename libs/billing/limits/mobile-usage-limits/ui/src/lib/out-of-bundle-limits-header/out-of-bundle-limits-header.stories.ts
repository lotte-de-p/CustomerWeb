...
import { OutOfBundleLimitsHeaderComponent } from './out-of-bundle-limits-header.component';
import { importProvidersFrom } from '@angular/core';
import { TgTranslateTestingModule } from '@telenet/ng-lib-page';

export default {
  title: 'MobileUsageLimits/dumb/ui/outofbundlelimits/Out Of Bundle Limits Header',
  component: OutOfBundleLimitsHeaderComponent,
  decorators: [
    moduleMetadata({
      imports: [
        CommonModule,
...
export const Primary = {
  render: (args: OutOfBundleLimitsHeaderComponent) => ({
    props: args,
  }),
  args: {
    isMember: false,
